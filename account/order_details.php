                                ...
                                <div class="row">
                                    <div id="content" >
                                        ...
                                        <table class="table table-bordered table-hover" style="background-color: white;">
                                            ...
                                            $total_amount = $fetch_order['total_amount'] ? $fetch_order['total_amount'] : 0 ; 
                                            $shipping_charges = $fetch_order['shipping_charges'] ? $fetch_order['shipping_charges'] : 0 ;
                                            
                                            $subtotal = $total_amount - $shipping_charges;                                                                
                                            ...
                                            $delivery_add =$fetch_order['delivery_add'];
                                            $pickup_add = $fetch_order['pickup_add'];
                                            ?>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-left" style="width: 50%;"> 
                                                        ...
                                                        <b>Transaction No: <?php echo $fetch_order['razorpay_order_id'];?></b> <br />
                                                    </td>
                                                </tr>
                                            </tbody>
                                    </table>
                                        ...
                                        <table class="table table-bordered table-hover" style="background-color: white;">
                                            <tbody>
                                                <tr>
                                                    <td class="text-left" style="width: 50%;">  
                                                        ...
                                                        <? echo get_shippingaddress($delivery_add) ; ?>
                                                    </td>
                                                    
                                                    <td class="text-left" style="width: 50%;"> 
                                                        <b style="color:gray">Pickup Address</b>
                                                        <? echo get_shippingaddress($pickup_add) ; ?>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <b style="color:#666666"><a class="btn btn-danger" href="../bill.php?oid=<?php echo $order_id;?>">Invoice</a></b>
...
break;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>   </td>
                                                            <td><h3>Total</h3></td>
                                                            <td class="text-right"><h3><strong><?php echo $fetch_order['amount'];?></strong></h3></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
