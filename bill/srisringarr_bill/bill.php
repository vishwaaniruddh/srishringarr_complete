...
$pdf->SetFont('Arial','B',8);
$pdf->Cell(94,5,'& ALL KINDS OF ACCESSORIES.','0',1,'L',1); //end of line
$pdf->Ln(5);
...
$pdf->Ln(2);
$pdf->SetFont('Arial','B',9);
$pdf->Cell(190,10,'Pickup Address: '.get_shippingaddress_pdf($pickupa_add,1),'0',0,'L');

$pdf->Ln(5);
$pdf->SetFont('Arial','B',9);
$pdf->Cell(190,10,''.get_shippingaddress_pdf($pickupa_add,2),'0',0,'L');
$pdf->Ln(5);

$pdf->SetFont('Arial','B',9);
$pdf->Cell(190,10,' '.get_shippingaddress_pdf($pickupa_add,3),'0',0,'L');
$pdf->Ln(5);
...
$pdf->Ln(2);
$pdf->SetFont('Arial','B',9);
$pdf->Cell(190,10,'Delivery Address: '.get_shippingaddress_pdf($delivery_add,1),'0',0,'L');
$pdf->Ln(5);


// $pdf->Ln(2);
$pdf->SetFont('Arial','B',9);
$pdf->Cell(190,10,' '.get_shippingaddress_pdf($delivery_add,2),'0',0,'L');
$pdf->Ln(5);

$pdf->SetFont('Arial','B',9);
$pdf->Cell(190,10,''.get_shippingaddress_pdf($delivery_add,3),'0',0,'L');
$pdf->Ln(5);
...
$pdf->Cell(19,10,'ITEM CODE','1',0,'C');
$pdf->Cell(18,10,'RENT PRICE','1',0,'C');
$pdf->Cell(9,10,'QTY','1',0,'C'); 

$pdf->Cell(16,10,'DEPOSIT','1',0,'C');
$pdf->Cell(22,10,'DEPOSIT DATE','1',0,'C');
$pdf->Cell(14,10,'DISCOUNT','1',0,'C');

$pdf->Cell(18,10,'PICKUP','1',0,'C');
$pdf->Cell(18,10,'RETURN','1',0,'C');
...
$pro_sql = mysqli_query($con,"select * from order_details where order_id = '".$order_id."'");
$i = 1; 
while($pro_sql_result = mysqli_fetch_assoc($pro_sql)){
    ...
    $pickup_date = $pro_sql_result['rent_dt'];
    $return_dt = $pro_sql_result['return_dt'];
    $deposite_date = $pro_sql_result['deposite_date'];
...
$pdf->Cell(19,6,$product_name,'1',0,'C');
$pdf->Cell(18,6,'Rs. '.$pro_amount,'1',0,'C');
$pdf->Cell(9,6,$pro_qty,'1',0,'C'); 


$pdf->Cell(16,6,'Rs. '.$deposit_amt ,'1',0,'C');

$pdf->Cell(22,6, $deposite_date ,'1',0,'C');
$pdf->Cell(14,6,'--','1',0,'C');


$pdf->Cell(18,6,$pickup_date,'1',0,'C');


$pdf->Cell(18,6,$return_dt,'1',0,'C');




if($pro_type==1){
    $pdf->Cell(12,6,'3%','1',0,'C');    
}
else{
    if($pro_amount<1060){
