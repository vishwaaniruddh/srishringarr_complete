    ...
    while($mob_ban_result = mysqli_fetch_assoc($mob_ban)){
        ...
        $mobbanimage = $mob_ban_result['img'];
         ?>
    			    ...
    			    <img src="<?php echo $mobbanpath.$mobbanimage;?>" style="height:100%;object-fit:contain; " alt="Sri Shringarr">
  ...
  <ul class="slides">
    ...
    while($web_ban_result = mysqli_fetch_assoc($web_ban)){
        ...
        $webbanimage = $web_ban_result['img'];
         ?>
            			<li style="position:relative; ">
    			    <img src="<?php echo $webbanpath.$webbanimage;?>" style="height:100%;object-fit:contain; " alt="Sri Shringarr">
                        <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15" style="position:absolute;top:10%;">
    				    </div>
    			</li>
...
function displayImages(data, type) {
    ...
    switch (type) {
        case 'all':
            description = 'Explore and rent from our matchless inventory';
            break;
        case 'Apparel':
            description = 'Unveil Your Style - Adorn yourself for the momentous events rent from our elegant collection.';
            break;
        case 'Jewel':
            description = 'See What Glitters - Explore our exquisite collection of timeless elegance. Rent the matching jewellery for your dress.';
            break;
        default:
            description = 'Explore and rent from our matchless inventory';
    }

    // Append the description above the grid
    ...
    if (Array.isArray(data)) {
        $.each(data, function(_, item) {
            ...
            console.log(imageUrl);
             imageUrl = imageUrl.replace('yosshitaneha.com', 'srishringarr.com/yn');
            ...
            figcaptionElement.append(headingElement,paragraphElement, anchorElement);
...
<div class="popup-overlay" id="popup">
  <div class="popup-content">
    ...
    <p>We would love to hear from you OR If you have specific requirement. please fill out the form below:</p>
    <form id="nl_form">
