                                                        ...
                                                        $link .=  '<tbody>
                                                                    <tr>
                                                                        <td style="color:#636363;border:1px solid #e5e5e5;padding:12px;text-align:left;vertical-align:middle;font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;word-wrap:break-word">
                                                        				    <img src="http://yosshitaneha.com/uploads'. get_image($product_id,$type).'" width="30%">	'.$name.'		</td>
...
$link .= '<tfoot>
 ...
 <tr>
															...
															<a href="http://yosshitaneha.com/bill/Yosshita_neha_bill/yoss_bill.php?oid='.$order.'" >Click here to View/download Bill</a>

<h3>Enjoy Unlimited Unique Fashion Products !<h3>
<p>Visit <b><a href="http://yosshitaneha.com/">Yosshitaneha</a></b></p>
...
<td colspan="2" valign="middle" id="m_3716871841364271743credit" style="border-radius:6px;border:0;color:#8a8a8a;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:12px;line-height:150%;text-align:center;padding:24px 0">
    ...
    if(mail($to, "Thanks You For Shopping At Yosshitaneha", $link, $headers,'-f sales@yosshitaneha.com -F "Yosshitaneha Fashion Studio"')){
        ...
        mail('rajanipoddar@gmail.com', "Thanks You For Shopping At Yosshitaneha", $link, $headers,'-f sales@yosshitaneha.com -F "Yosshitaneha Fashion Studio"');
        ...
        // mail('developer.ruchi@gmail.com', "Thanks You For Shopping At Yosshitaneha", $link, $headers,'-f sales@yosshitaneha.com -F "Yosshitaneha Fashion Studio"');
    }
    ...
    if($is_customisable==1) {
        ...
        $headers .= "From: sales@yosshitaneha.com" . $eol;
...
<?php include("requiredfields.php");?><!--header--> 
<div class="top_bg">
    <div class="container">
...
<? $sql=mysqli_query($conn,"select * from Order_ent where transaction_id='".$txnid."'");
...
?>
    ...
    <td class="woocommerce-table__product-name product-name">
        <img src="http://yosshitaneha.com/uploads<? echo get_image($product_id,$type); ?>">
        <? echo $name;?> <strong class="product-quantity">×&nbsp;<? echo $qty; ?></strong>   </td>
...
<!-- Google Code for Sri Shringarr Conversion Page -->
<script type="text/javascript">
/* <![CDATA[ */
var google_conversion_id = 878873570;
var google_conversion_language = "en";
var google_conversion_format = "3";
var google_conversion_color = "ffffff";
var google_conversion_label = "8Q73CKjxu3QQ4peKowM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/878873570/?label=8Q73CKjxu3QQ4peKowM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
