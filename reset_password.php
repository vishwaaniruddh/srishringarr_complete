...
if($sql_result>0)
{
   ...
   $check_sql=mysqli_query($con,"select * from forget_password where userid='".$userid."' and site='SS'");
   $check_sql_result=mysqli_fetch_assoc($check_sql);
   
   if($check_sql_result){
     $sql_password="update forget_password set password='".$string ."' where userid='".$userid."' and site='SS' ";       
   }
   else{
     $sql_password="insert into forget_password(userid,email,password,site) values('".$userid."','".$email."','".$string."','SS')";
   }
