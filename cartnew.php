                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="border-0 align-middle">
                                        <input class="form-control total-amount" type="text" name="amount" id="amount" value="<? echo $currency_symbol . ' ' . currencyAmount($currency,$get_cart_sql_result['product_amt']); ?>" border="none" readonly="">
            ...
            <?php if($subtotal>0){ ?>
                ...
                //  if(get_shipping_address($userid)){ 
                 ?>
                    ...
                    <? 
                    // echo get_shipping_address($userid);
                    ?></p>-->
                        
                    <!--    <a class="btn btn-primary" href="https://srishringarr.com/account/edit-account.php">Change</a>-->
                    <!--</div>-->
                ...
                <?php $user_state=state_id_userid($_COOKIE['ss_userid']);
                    if($user_state){ ?>
                        <div class="gst_tax">
                            <? $gst= igst($userid);
                            if($user_state!=3){ ?>
