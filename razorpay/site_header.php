...
<head>
    ...
    <meta charset="UTF-8">
    <!-- added meta as per asked by manoj sir for facebook verifcation-->
...
?>
    ...
    <link rel="preload" href="../static/fonts/font-awesome-4.7.0/css/font-awesome.min.css?ver=<? echo $file_version ; ?>&&display=swap" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
        <link rel="stylesheet" href="../static/fonts/font-awesome-4.7.0/css/font-awesome.min.css?&display=swap">
    </noscript>
    <link rel="preload" href="../static/css/style.css?ver=<? echo $file_version ; ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
        <link rel="stylesheet" href="../static/css/style.css">
    </noscript>
    <link rel="preload" href="../static/css/vendor/animate/animate.css?ver=<? echo $file_version ; ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
        <link rel="stylesheet" href="../static/css/vendor/animate/animate.css">
    </noscript>
    
    <link rel="preload" href="../static/css/util.css?ver=<? echo $file_version ; ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
        <link rel="stylesheet" href="../static/css/util.css">
    </noscript>
    <link rel="preload" href="../static/css/main.css?ver=<? echo $file_version ; ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
        <link rel="stylesheet" href="../static/css/main.css">
    </noscript>
    <link rel="preload" href="../static/css/site.css?ver=<? echo $file_version ; ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
    ...
    <link rel="preload" href="../thirdparty/css/bootstrap.min.css?ver=<? echo $file_version ; ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
...
::-webkit-scrollbar-thumb:hover {
  background: #b30000; 
    ...
    <link rel="stylesheet" type="text/css" href="../css/style.css?ver=<? echo $file_version ; ?>">
...
<body class="bg-light">
    ...
    <div class="container-fluid custom_fluid" id="web" style="box-shadow: 0px 6px 14px -10px;">
        ...
        <div class="cust_logo">
            <a href="../">
                <img class="lazyload" src="https://srishringarr.com/static/images/site/logo/main_logo.png" alt="Avatar">
            </a>
        </div>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            while ($rowjew = mysqli_fetch_array($qryjew)) {  ?>
                                <li><a class="dropdown-item" href="../<? echo $rowjew['url']; ?>"><?php echo ucfirst(strtolower($rowjew[2])); ?></a></li>
                            <?php } ?>
