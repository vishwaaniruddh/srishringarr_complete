...
echo "working minutes:".$working_minute."<br>";
...
$perday_sal = number_format($perday_sal,2);

echo $perday_sal."<br>";

echo "working min: ".$working_minute."<br>";

$permin_sal = number_format($perday_sal/$working_minute,2); 
...
foreach($list as $listk=>$listv){
    ...
    // echo $weekoffday;
    // echo "select * from new_attendance where emp_id='".$empid."' and cast(attendance_date_in as date) ='".$listv."'"."<br>";
    
    $sql = mysqli_query($db,"select * from new_attendance where emp_id='".$empid."' and cast(attendance_date_in as date) ='".$listv."'");
    if($sql_result = mysqli_fetch_assoc($sql)){
        ...
        if($listv==$tuesday_check){
            echo  '$tuesday_check ' . $tuesday_check.'1' ; 
            $monday_skip_count++;
            // echo 'IN skip';
        }
            $not_working++;
...
echo 'Additional monday working day : '.$count."<br>";
...
// echo '<br>';
// echo '$official_leave = ' . $official_leave ; 
if($count){
 $additional_min = $count * $working_min;
 $total_working_min = $total_working_min + $additional_min;
}
...
<div class="row">
    <div class="col-sm-6"><div class="box" style="border-top: none;box-shadow: none;"><div class="box-body cnt" style="padding: 20px;border: 1px solid gray;"><b>Total Working Days:</b> <u><?php if($count){echo $working+$count;} else{ echo $working;} ?></u></div></div></div>
    <div class="col-sm-6"><div class="box" style="border-top: none;box-shadow: none;"><div class="box-body cnt" style="padding: 20px; border: 1px solid gray;"><b>Total Leaves:</b> <u><?php if($count){echo $not_working-$count;}else{ echo $not_working;}  ?></u></div></div></div>
</div>
<br>
<hr>
<br>
