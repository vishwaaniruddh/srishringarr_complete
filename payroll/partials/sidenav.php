	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
			...
			<?php if ( $_SESSION['Login_Type'] == 'admin' ) { ?>
				...
				<!--	</a>-->
				<!--</li>-->
				<!--<li class="<?php echo $page_name == "bulk_upload_attendance" ? 'active' : ''; ?>">-->
				<!--	<a href="<?php echo BASE_URL; ?>bulk_upload_attendance/">-->
				<!--		<i class="fa fa-calendar"></i> <span>Bulk Attendance Upload</span>-->
				<!--	</a>-->
				<!--</li>-->
				
				<li class="<?php echo $page_name == "demo" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>demo/">
						<i class="fa fa-calendar"></i> <span>Bulk Attendance Upload</span>
					</a>
				</li>
				
				<li class="<?php echo $page_name == "reports" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>reports/">
						<i class="fa fa-calendar"></i> <span>Reports</span>
					</a>
				</li>
				
				<li class="<?php echo $page_name == "manual_attendance" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>manual_attendance/">
						<i class="fa fa-calendar"></i> <span>Manual Attendance Insert</span>
					</a>
				</li>
				<li class="<?php echo $page_name == "weekoff_master" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>weekoff_master/">
						<i class="fa fa-calendar"></i> <span>WeekOff Master</span>
					</a>
				</li>
				...
				<li class="<?php echo $page_name == "add_employees" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>add_employees/">
						<i class="fa fa-list"></i> <span>Add Employee</span>
					</a>
				</li>
				<li class="<?php echo $page_name == "add_salary" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>add_salary/">
						<i class="fa fa-money"></i> <span>Add Salary</span>
					</a>
				</li>
			<?php } else { ?>
				<li class="<?php echo $page_name == "salaries" ? 'active' : ''; ?>">
