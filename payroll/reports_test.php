...
// error_reporting(E_ALL);
    ...
    return $skip ; 
        		           ...
        		           function week_off_min($month,$year,$empid){
        		            ...
        		            $salary = 0 ;
        		            $emp_sql = mysqli_query($db,"SELECT a.empid,a.baseyear,concat(b.salutation, ' ', b.firstname, ' ', b.lastname) as name,b.perday_hours FROM salary a 
        			    ...
        			    <div class="box">
        			        <div class="box-body">
        			            <table class="table">
            			            ...
            			            <?
            			            $i=1;
            			            $emp_sql = mysqli_query($db,"SELECT a.empid,a.baseyear,concat(b.salutation, ' ', b.firstname, ' ', b.lastname) as name FROM salary a 
            			            INNER JOIN employee b ON a.empid=b.ssn order by firstname");
            			            while($emp_sql_result = mysqli_fetch_assoc($emp_sql)){ 
                			            $empid = $emp_sql_result['empid'];
            			            ...
            			            ?>
                			            <tr>
                			                ...
                			                <td><a class="btn btn-success" href="view_emp_records_test.php?empid=<? echo $empid; ?>" target="_blank">View</a></td>
                			            </tr>    
            			            <? $i++; } ?>
