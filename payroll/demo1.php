...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  crossorigin="anonymous"></script>
    ...
    //             "data": null,
    //             "className": "dt-center",
    //             "defaultContent": ' <button class="btn btn-success btn-xs" data-toggle="modal" data-target="#EditModal"><i class="fa fa-edit"></i></button> '
    //         }
		    ],
	} );
} );
        ...
        function createManageBtn() {
            return '<button id="manageBtn" type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#EditModal">Edit</button>';
        }
 ...
 table  = $('#example').DataTable();
    ...
    $('body').on('click', '#manageBtn', function(){
		...
		<?php if ( $_SESSION['Login_Type'] == 'admin' ) { ?>
			<div class="modal fade in" id="EditModal" tabindex="-1">
						...
						<form method="post" role="form" data-toggle="validator" id="holiday-form">
							<div class="modal-body">
								<div class="form-group">
									<label for="holiday_title">Name</label>
									<input type="text" class="form-control" id="username" name="username" readonly />
								</div>
								
								<div class="form-group">
					                
										<label for="pdate">Emp. DOB (MM/DD/YYYY)</label>
										<input type="text" class="form-control datepicker" name="pdate" id="pdate" placeholder="(MM/DD/YYYY)" required />
					            ...
					            <div class="row">
					            	<div class="col-sm-6">
							            <div class="form-group">
											<div class="input-group clockpicker" data-placement="bottom" data-align="top" data-autoclose="true">
											    <label for="attendance_date_in">In Time </label>
												<input type="text" class="form-control" id="attendance_date_in" name="attendance_date_in" value="00:00">
									...
									<div class="col-sm-6">
							            <div class="form-group">
											<div class="input-group clockpicker" data-placement="bottom" data-align="top" data-autoclose="true">
											    <label for="attendance_date_out">Out Time </label>
												<input type="text" class="form-control" id="attendance_date_out" name="attendance_date_out" value="00:00">
												<div class="input-group-append">
													<span class="input-group-text"><i class="mdi mdi-clock"></i></span>
												</div>
											</div>
							...
							<div class="modal-footer">
								<input type="hidden" name="att_id" id="att_id" value="<?php ?>" />
