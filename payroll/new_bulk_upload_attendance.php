        			    ...
        			    <div class="box">
        			        <div class="box-body">
                                <div>
                                    ...
                                    <a class="btn btn-success" href="https://srishringarr.com/payroll/excelformat/payroll_excel_format.xlsx" download>ATTENDANCE UPLOAD FORMAT</a>
                                </div>
                                        ...
                                        if(isset($id) && $id!='' ){
                                          ...
                                          //  echo $_out_time."<br>";
                                            ...
                                            if($start_time !='' && $end_time !='') {
                                                ...
                                                $sql = "insert into attendance(ID,pdate,Intime,Outtime,created_at) 
