					...
					<div class="modal-content">
						...
						<form method="post" role="form" data-toggle="validator" id="holiday-form">
							<div class="modal-body">
								...
								<div class="form-group">
					                <label for="holiday_date">Holiday Date (YYYY-MM-DD)</label>
					                <div class="input-group date">
					                  	<div class="input-group-addon">
					                    	<i class="fa fa-calendar"></i>
					                  	</div>
					                  	<input type="text" class="form-control datepicker " id="holiday_date" name="holiday_date" autocomplete="off" required />
					                </div>
					            </div>
					            <div class="row">
					            	<div class="col-sm-6">
