...
<div class="flexslider" id="mobile_ban">
  <ul class="slides">
    <?php while($mob_file = readdir($mob_opendir))
		    { 
    			if($mob_file != '.' && $mob_file != '..')
    			{ ?>
    			<li style="position:relative; ">
    			    <img src="<?php echo $mob_directory.$mob_file;?>" style="height:100%;object-fit:contain; ">
                        <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15" style="position:absolute;top:40%;">
  ...
  <ul class="slides">
    <?php while($file = readdir($opendir))
		    { 
    			...
    			{ ?>
    			<li style="position:relative; ">
    			    <img src="<?php echo $directory.$file;?>" style="height:100%;object-fit:contain; ">
...
<li class="col-xs-6 col-md-4 col-lg-3" style="padding-left:0px;padding-right:0px;">
    <div class="hovereffect">
        ...
        <span>Bangles</span>
            ...
            <img class="img-responsive" src="asset/compressed/Bangles.jpg" alt="">
...
<li class="col-xs-6 col-md-4 col-lg-3" style="padding-left:0px;padding-right:0px;">
    ...
    <a href="list.php?id=53&type=1">
        <span>Borla</span>
            <img class="img-responsive" src="asset/compressed/Borla.jpg" alt="">
            <div class="overlay"></div>
        </a>
    </div>
</li>
<li class="col-xs-6 col-md-4 col-lg-3" style="padding-left:0px;padding-right:0px;">
    <div class="hovereffect">
        ...
        <span>Earring</span>
            <img class="img-responsive" src="asset/compressed/ear.jpg" alt="">
            <div class="overlay"></div>
        </a>
    </div>
</li>
<li class="col-xs-6 col-md-4 col-lg-3" style="padding-left:0px;padding-right:0px;">
    <div class="hovereffect">
        ...
        <span>Hath Phool</span>
            <img class="img-responsive" src="asset/compressed/Hathphool.jpg" alt="">
            <div class="overlay"></div>
            </a>
    </div>
</li>
<li class="col-xs-6 col-md-4 col-lg-3" style="padding-left:0px;padding-right:0px;">
    <div class="hovereffect">
        ...
        <span>Lehenga Choli</span>
            <img class="img-responsive" src="asset/compressed/Lehenga_Choli.jpg" alt="">
            <div class="overlay"></div>
        </a>
    </div>
</li>
<li class="col-xs-6 col-md-4 col-lg-3" style="padding-left:0px;padding-right:0px;">
    <div class="hovereffect">
        ...
        <span>Kundan Set</span>
            <img class="img-responsive" src="asset/compressed/Necklace_Set_Kundan.jpg" alt="">
            <div class="overlay"></div>
        </a>
    </div>
</li>
<li class="col-xs-6 col-md-4 col-lg-3" style="padding-left:0px;padding-right:0px;">
    <div class="hovereffect">
        ...
        <span>Mang Tikkas</span>
            <img class="img-responsive" src="asset/compressed/Tikkas.jpg" alt="">
            <div class="overlay"></div>
        </a>
    </div>
</li>
<li class="col-xs-6 col-md-4 col-lg-3" style="padding-left:0px;padding-right:0px;">
    <div class="hovereffect">
        ...
        <span>Trail Gown</span>
            <img class="img-responsive" src="asset/compressed/Trail_Gown.jpg" alt="">
            <div class="overlay"></div>
        </a>
    </div>
</li>
