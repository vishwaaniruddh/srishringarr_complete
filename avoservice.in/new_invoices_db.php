...
pmeters="&Page="+b+'&perpg='+ppg+'&fromdt='+fromdt+'&todt='+todt+'&cid='+cid+'&branch_avo='+branch_avo+'&invno='+invno+'&crnno='+crnno+'&del_date='+del_date+'&sub_date='+sub_date+'&atmid='+atmid+'&address='+address+'&invtyp='+invtyp+'&sostats='+sostats;
			      //   alert(pmeters);
			  }
			  else
			  {
