...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
	...
	//	  var calltype=document.getElementById('calltype').value;//alert(calltype);	 
			...
			/*	
			 ...
			 // alert(br);
			//alert("gg"); 
			var url = 'search_del_type_sum.php'; 
		//  }
 	//alert(br);
		    var pmeters="";
			//alert(url);
			...
			if(a!="Loading"){ 
   pmeters = 'fromdt='+fromdt+'&todt='+todt+'&Page='+b+'&perpg='+ppg;
			//alert(pmeters);
			}
			else
			{
				 pmeters='todt='+todt+'&fromdt='+fromdt+'&perpg='+ppg;
			}
			//alert(pmeters);
...
<h2 class="h2color">Delegation Type Summary </h2>

<div >
<button id="myButtonControlID" onClick="tableToExcel('call_summary', 'CLOSED SERVICE CALL TAT ANALYSIS')">Export</button>
	<br />
