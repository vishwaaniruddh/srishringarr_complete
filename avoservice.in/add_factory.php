...
<h2>Add Factory</h2>
<div id="header">
<form action="process_factory.php" method="post" name="engform" enctype="multipart/form-data" id="engform">
<table>


<tr>
<td height="35">Fatory Name: </td>
...
<td><input type="number" min="1111111" max="9999999999" name="mobile" id="mobile" onkeyup="if(parseInt(this.value)>9999999999){ this.value =''; return false; }" /></td>
</tr>
