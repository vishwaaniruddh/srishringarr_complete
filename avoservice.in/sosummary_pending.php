...
<div >
 <!--<button id="myButtonControlID" onClick="tableToExcel('custtable', 'Table Export Example')">Export Table data into Excel</button>-->
	<br />
<form action="gen_pendingso.php" method="POST" target="_new">
<table cellpadding="" cellspacing="0" >
 ...
 <th><select name="cid" id="cid"  ><option value="">Select Client</option><?php
    ...
    <tr>
     ...
     <th width="75"><input type="text" name="todt" id="todt" onkeypress="return runScript(event)"  readonly="readonly" onclick="displayDatePicker('todt');" placeholder="Upto Date" value="<?php echo date(d/m/Y); ?>" required="required"/></th>
