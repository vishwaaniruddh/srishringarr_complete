...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
 	...
 	//alert(br);
			...
			if(a!="Loading"){ 
			 pmeters = 'atmid='+id+'&cid='+cid+'&area='+area+'&bank='+bank+'&br='+br+'&Page='+b+"&calltype="+calltype+'&perpg='+ppg+"&docket="+docket+'&fromdt='+fromdt+'&todt='+todt+'&eng='+eng+'&sitetp='+sitetp+'&state='+state;
			// alert(pmeters);
			}
			else
			{
