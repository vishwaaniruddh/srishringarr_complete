...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
		  ...
		  if (!HttPRequest) {
			...
			var url = 'search_branch_calls.php'; 
	
		    var pmeters="";
			//alert(url);
					if(a!="Loading"){ 
  
      pmeters = 'Page='+b+'&perpg='+ppg+'&todt='+todt;
			//alert(pmeters);
			}
			else
			{
				
				 pmeters='perpg='+ppg+'&todt='+todt;
			}
			//alert(pmeters);
...
<h2 class="h2color">Calls Status Summary</h2>
...
<table cellpadding="" cellspacing="0" >
 ...
 // echo $date; ?>
   		...
   		<input type="text" name="todt" id="todt" readonly="readonly" value="<?php echo $date ?>">
