...
$qr=mysql_query("select caller_email,call_status from alert where alert_id='".$id."'");
...
//include_once('class_files/filter.php');
	...
	$tab=mysql_query("select feedback,engineer,feed_date from eng_feedback where alert_id='".$id."'  order by feed_date DESC");
