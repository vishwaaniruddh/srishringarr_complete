...
<title>AVO-<?php echo $_SESSION['user']; ?></title>
...
<table cellpadding="20px">
   <?php 
   $username=mysqli_query($con1,"select * from `login` where `username`='".$_SESSION['user']."'");
   $username1=mysqli_fetch_row($username);
   ?>
	<tr height="50px">
    	<td>User Name : <b style="color:#F00;">*</b></td>
        <td><input type="text" name="username" id="username" value="<?php echo ucfirst($username1[1]); ?>" readonly="readonly"/></td>
    </tr>
	<tr height="50px">
