...
<?php include("menubar.php");?>
		 ...
		 <h2 class="h2color" align="center" st>Expense Claim Analysis</h2>
<div>
...
<?php $selbr= mysqli_query($con1,"select distinct(branch_id) from daily_expenses order by id ASC");  
