...
<tr>
<td><?php echo $row1[1]; ?></td><td><?php echo $row[8]; ?></td>
...
$qryasst=mysqli_query($con1,"Select * from site_assets where atmid= (select track_id from atm where atm_id='$ref' and cust_id='".$row[0]."')");
...
<input type="checkbox" name="assetsme[]" id="assetsme<?php echo $cnt; ?>" onClick="javascript:astselect('assetsme<?php echo $cnt ?>');" value="<?php echo $asstres[3]." (".$qryassidres[0].")"."-".$asstres[6]."*".$asstres[5]; ?>" />
