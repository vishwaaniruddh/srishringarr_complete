...
$contents='';
 $contents.="Sr. No.\t Vertical-Client Name\t Invoice No\t Inv Date\t Branch\t Site/Sol/ATM ID\t End User\t City\t Address\t Product\t Model\t Qty\t Warranty\t Rate\t";
...
$contents.="\n".$cnt."\t";
 ...
 $contents.=$row['po_product']."\t";
 $contents.=get_spec($row['po_model'])."\t";
 $contents.=$row['po_qty']."\t";
 $contents.=$row['po_warr']."\t";
 $contents.=$row['po_rate']."\t";
 
 
//$prod=$row['po_product']." - ".get_spec($row['po_model'])." || Warr :".$row['po_warr']." || Qty :".$row['po_qty']." || Rate:".$row['po_rate'];
