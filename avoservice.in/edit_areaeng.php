...
$qry2=mysqli_query($con1,"select state_id from state where branch_id='".$erow[2]."' ");
while($row2=mysqli_fetch_row($qry2)) {
$qry=mysqli_query($con1,"select city_id,city from cities where state_id='".$row2[0]."' and status=1 ORDER BY city ASC");
