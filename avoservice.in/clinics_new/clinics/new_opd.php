...
$sq=mysqli_query($con,"select max(opd_id) from opd");
...
//echo $newname;
	  ...
	  mysqli_query($con,"insert into patient_photo(patient_id,photo_date,photo,opd_id)values('$id',STR_TO_DATE('".$date."','%d/%m/%Y'),'$newname','$max[0]')");
	}
