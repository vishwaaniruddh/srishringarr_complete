...
<div id="" class="login-popup">
          ...
          <form method="post" class="signin" action="update_patient.php" onSubmit="return validate(this)" name="form">
                ...
                <td> <input id="fname" name="fname" type="text" value="<?php echo $row[6]; ?>" > </td>
                 ...
                 <tr> 
            	<td><label class="fname"> ESI NO: </label></td>
                <td> <input id="esino" name="esino" type="text" value="<?php echo $row[39]; ?>" > </td>
                </tr>
                <tr>
...
?>
                ...
                <option value="<?php if(isset($row3[0])) {echo $row3[0];} ?>"><?php if(isset($row3[1])) {echo $row3[1];} ?></option> 
				<?php while($row11=mysqlifetch_row($result))
                {  ?>
                ...
                <tr>
                <td>Referral Date : </td><td><input id="refd" name="refd" type="text" onClick="displayDatePicker('refd');" value="<?php if(isset($row[42]) and $row[42]!='0000-00-00') echo date('d/m/Y',strtotime($row[42])); ?>" ></td>
                 <!--$row[42];-->
                </tr>
                 <tr>
                
                <tr>
                <td>Diagnosis</td><td><textarea id="diag" name="diag" rows="3" cols="25"></textarea></td>
                 <!--$row[43];-->
                </tr>
                
                <tr>
                <td>Ref.No</td><td><input id="refno" name="refno" type="text" value="<?php echo $row[43];?>"></td>
                <!--$row[42];-->
                </tr>
                
                <tr>
                <td>Relation with IP</td><td><input id="rel" name="rel" type="text" value="<?php echo $row[44]; ?>"></td>
                <!--$row[43];-->
                </tr>
