...
<div id="" class="login-popup">
          ...
          <form method="post" class="signin" action="update_doc.php" onSubmit="return docvalidate(this)" name="docform">
                ...
                <p style="color:#ac0404; font-weight:bold; font-size:16px;" align="center">Edit Doctor</p>
               ...
               <tr><td>
                ...
                <textarea name="add" cols="26" rows="3" style="resize:none;border:1px #ac0404 solid;"><?php echo $row[4]; ?></textarea>
             </td></tr>
              <tr><td>
...
<option value="Zimbabwe">Zimbabwe</option>
             ...
             <tr><td>
                ...
                <textarea name="rem" cols="26" rows="3" style="resize:none;border:1px #ac0404 solid;"><?php echo $row[10]; ?></textarea>
             </td></tr>
                <tr><td >
                
                <button class="submit formbutton" type="submit">Submit</button>
                      </td><td> 
                <button class="submit formbutton" type="button" onClick="javascript:location.href = 'view_doctor.php';">Cancel</button>
                       </td></tr></table>
                </fieldset>
          </form>
</div>