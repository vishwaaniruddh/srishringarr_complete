...
<button class="submit formbutton" type="submit">Submit</button>
                ...
                <option value="<?php echo $row[2]; ?>"><?php echo $row[6]; ?></option>
             ...
             <?php } ?>
               ...
               <div id="rep"><select name="" style="width:350;" onchange="finding1();">
			   ...
			   <option value="">Select</option>
                ...
                <textarea name="sym" id="sym" cols="41" rows="3" style="resize:none;"></textarea>
