...
$sqd=mysqli_query($con,"select * from opdbills where ad_id='$id'");
...
<p align="center"> Run By : Sai Naman Hospital <BR>G.E. ROAD, SIRSA GATE, BHILAI 3 - 490 021 (C.G.)<BR>PHONE: 9109915628 </p>
</TD></TR></TABLE></DIV>
                ...
                <td><label><?php if(isset($rowd[10])){ if($rowd[10]==""){ echo  $row[d]; }else { echo $rowd[10]; }}?></label></td>
                </tr>
                ...
                <td><label><?php echo $row[7]; ?></label></td>
                </tr>

                <tr>
                <td><label class="datead">Date of Referral :</label></td>
                <td><label><?php if(isset($row[15]) and $row[15]!='0000-00-00') echo date('d/m/Y',strtotime($row[15])); ?></label></td>
                </tr>               
           <!--     				
				<tr>
                <td><label class="datead">Date of Appointment :</label></td>
                <td><label><?php if(isset($row[0]) and $row[0]!='0000-00-00') echo date('d/m/Y',strtotime($row[0])); ?></label></td>
                </tr>               								
			-->	
				<tr>
                <td><label class="inv">Department:</label></td>
                <td><label><?php if(isset($rowd[7])){ if($rowd[7]==""){ echo  $row[d]; }else { echo $rowd[7]; }}?></label></td>
                </tr>
				
				<tr>
                <td><label class="inv">Consultant:</label></td>
                <td><label><?php if(isset($rowd[8])){ if($rowd[8]==""){ echo  $row[d]; }else { echo $rowd[8]; }}?></label></td>
                </tr>
				
                <tr>
                <td><label class="inv">Diagnosis:</label></td>
                <td><?php if(isset($rowd[1])){ if($rowd[1]==""){ echo  $row[1]; }else { echo $rowd[1]; }}?></td>
                </tr>                				
		...
		<th width="84">Remarks (X)</th>
                ...
                <?php 
             $sqn=mysqli_query($con,"select * from opdbill_details where ad_id='$id' and type=1");
		         $cnt=0;
		...
		$sq=mysqli_query($con,"select * from procedures where id='$ron[1]'");
			...
			echo $ro[1]; ?>                                
               ...
               <tr>
                ...
                <td><<?php if(isset($rowd[2])){ if($rowd[2]==""){ echo  $row[d]; }else { echo $rowd[2]; }}?></td>
                <td width="153">Amount Claimed (I): </td>
                <td width="224"><?php if(isset($rowd[3])){ if($rowd[3]==""){ echo  $row[d]; }else { echo $rowd[3]; }}?></td>
                </tr>
               ...
               <?php 
	 $sq2=mysqli_query($con,"select * from opdbill_details where ad_id='$id' and type=2");
		         $cnt1=0;
		...
		<tr>
                ...
                <td><?php if(isset($rowd[4])){ if($rowd[4]==""){ echo  $row[d]; }else { echo $rowd[4]; }}?></td>
		...
		<th width="84">Remarks (X)</th>
                ...
                <?php 
				$sq3=mysqli_query($con,"select * from opdbill_details where ad_id='$id' and type=3");
		         $cnt=0;
		...
		<tr>
                ...
                <td><?php if(isset($rowd[5])){ if($rowd[5]==""){ echo  $row[d]; }else { echo $rowd[5]; }}?></td>
		...
		<th width="84">Remarks (X)</th>
				 ...
				 <?php 
		         $sq4=mysqli_query($con,"select * from opdbill_details where ad_id='$id' and type=4");
		         $cnt=0;
		...
		<tr>
                ...
                <td><?php if(isset($rowd[9])){ if($rowd[9]==""){ echo  $row[d]; }else { echo $rowd[9]; }}?></td>
                ...
                <?php 
                  ...
                  $_total = $first + $second + $third + $fourth;
                ?>
                ...
                <td>Remarks : </td>
                <td><?php if(isset($row[6])){echo $rowd[6];} ?></td>
                </tr>
