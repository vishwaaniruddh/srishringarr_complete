...
$sqlmax="select max(billno) from opdbills";
...
<div  class="login-popup">
          ...
          <form method="post" class="signin" action="process_opdesi.php" >		  
                ...
                <td><input id="bill" name="bill" type="text" value="<?php echo $rowmax[0]+1; ?>" readonly style="background-color:#DCDCDC;"></td>
                </tr>
		...
		<tr>
            ...
            <!--    <tr>
                ...
                <td><input id="dateapp" name="dateapp" type="text" value="<?php if(isset($row[0]) and $row[0]!='0000-00-00') echo date('d/m/Y',strtotime($row[0])); ?>" readonly style="background-color:#DCDCDC;"></td>
                </tr>               								
				-->
				<tr>
                ...
                <td><textarea name="diag" id="diag" rows="3" cols="22" style="resize:none;background-color:#DCDCDC" ><?php echo $row[9]; ?></textarea></td>
                </tr>                				
		...
		<th width="84">Remarks (X)</th>
               ...
               <tr>
                ...
                <td width="224"><input type="text" name="amtc" id="amtc" onfocus="getSum1();"> </td>
                </tr>
