...
<p align="center"> Run By : Sai Naman Hospital <BR>G.E. ROAD, SIRSA GATE, BHILAI - 490 012 (C.G.)<BR>PHONE: 0788- 4051001 , 4051002 </p>
</TD></TR></TABLE></DIV>
<br>
                 <input type="hidden" name="myvar" value="0" id="theValue" />                
                <strong>GDH/ESIC/IPD/2014/01/<?php echo $cc; ?> </strong><p align="right"><strong>Dated: <?php echo date('d/m/Y'); ?></strong></p> 
        ...
        $result1 = mysqli_query($con,$sql1);
                ...
                ?>
                <tr>             	
				<td style="height:60px" ><?php echo $i; ?></td>
                <td style="height:60px" ><label><?php if(isset($row[1])) {echo $row[1]; }?></label></td>                                                                                               
                <td style="height:60px" ><label><?php if(isset($row1[39])) {echo $row1[39];} ?></label></td>                
                <td style="height:60px" ><?php if(isset($row1[40])) {echo $row1[40];} ?></td>                               				                 
		            <td style="height:60px" ><?php if(isset($row1[6])) {echo $row1[6];} ?></td> 
                
                
                <td style="height:60px" ><?php  echo $row[3]."-".$row[4]; ?></td>
		            <td style="height:60px" ><?php echo $row[5]."-".$row[6]; ?></td>                
                <td style="height:60px" ><?php $rt=$rowd[4]+$rowd[5]+$rowd[6]+$rowd[10]; 
				          $sum=$sum+$rt; 
						  echo $rt; ?></td>                                
                </tr>
               <?php }  ?>
      ...
      <tr>
        <td valign="top"><p align="center"><strong>(RS. <?php echo int_to_words($sum); ?> ONLY)</strong></p></td>
                  ...
                  <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td colspan="8" valign="top"><p><strong>For Gindodi Devi Memorial Charitable&nbsp;</strong></p></td>
                    </tr>
                    <tr>
                      <td colspan="8" valign="top"><p><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Hospital &amp;    Research Centre,</strong></p></td>
                    </tr>
                    <tr>
                      <td valign="top"></td>
                      <td valign="top"></td>
