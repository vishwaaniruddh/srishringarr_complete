 ...
 //alert("hi");
		  ...
		  if(document.getElementById('idd').value=="" && document.getElementById('fname22').value=="")
		  {
			...
			var url = 'get_dia.php?fname='+s;
			  ...
			  var s=document.getElementById('fname22').value;
			var url = 'get_dia.php?fname='+s+'&id='+id;
		  }
...
<div id="view_patient1">
    ...
    <a href="home.php"> <button class="submit formbutton" type="button" onClick="javascript:location.href = 'home.php';">Go Back</button></a>&nbsp;&nbsp;&nbsp;    <a href="home.php"> <button class="submit formbutton" type="button" onClick="javascript:location.href = 'logout.php';">Log Out</button></a>
          ...
          <p style="color:#ac0404; font-weight:bold; font-size:16px;" align="center">View Diagnosis</p>
          <table>
          <tr>
    <td><input type="text" style="width:90px;" name="idd" id="idd" value="" placeholder="search ID " onkeyup="searchById('Listing','1');" /></td>
