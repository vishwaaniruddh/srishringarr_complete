		 ...
		 /* if(document.getElementById('idd').value=="" && document.getElementById('fname22').value=="")
		  {
			...
			var url = 'surgery_report.php';
		 // }
 	
		
			//alert(url);
			var pmeters = 'mode='+Mode+'&Page='+Page+'&adate='+adate;
...
<div id="view_patient1">
          ...
          <p style="color:#ac0404; font-weight:bold; font-size:16px;" align="center">Today's Admissions </p>
 ...
 <table class="results">
    <tr>
    <td><input type="text" style="border:none; width:95px; height:21px;" name="adate" id="adate" onBlur="searchById('Listing','1');" placeholder="Date" onClick="displayDatePicker('adate');"/></td>
    </tr>
    </table>
 <div id="search"></div>
