...
include 'config.php';
//$id=$_GET['patient_id'];
$result = mysqli_query($con,"select * from new_patient");
...
include 'config.php';
//$id=$_GET['patient_id'];
$result = mysqli_query($con,"SELECT app_date,app_time FROM new_app WHERE app_date >= CURRENT_DATE order by app_date;");
//$row = mysqli_fetch_row($result);
?>
...
include 'config.php';
//$id=$_GET['patient_id'];
$result = mysqli_query($con,"select * from new_app");
