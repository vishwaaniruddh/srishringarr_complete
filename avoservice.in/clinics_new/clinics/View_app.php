 ...
 //alert("hi");
		  ...
		  if(document.getElementById('idd').value=="" && document.getElementById('fname22').value=="")
		  {
			...
			var url = 'get_app.php?fname='+s;
			  ...
			  var s=document.getElementById('fname22').value;
			var url = 'get_app.php?fname='+s+'&id='+id;
		  }
...
?>
          ...
          <tr>
    <td width="144">ID:
      <input type="text" style="width:90px;" name="idd" id="idd" placeholder="Search by ID" onkeyup="searchById('Listing','1');" /></td>
    <td width="225">Patient Name:
      <input type="text" style="width:115px;" name="fname22" id="fname22" placeholder="search by name" onkeyup="searchById('Listing','1');" /></td>
