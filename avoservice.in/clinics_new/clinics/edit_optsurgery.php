...
$id=$_GET['id'];
$sql2="select * from  surgery_wait where w_id='$id'";
...
$sql="select * from  patient where no='$row2[1]'";
...
<!--                <tr>
    ...
    -->            
                ...
                <tr>
                <td>Contact No. :</td>
                <td> <input id="cn" name="cn" type="text" value="<?php echo $row[23]; ?>" readonly style="background-color:#DCDCDC;">
                </td>
                </tr>
               <input type="hidden" name="app_id" value="<?php echo $row2[5]; ?> " />
                <tr>
                <?php 
$sql3="select * from appoint where app_id='$row2[5]'";
...
?>
                ...
                <td>
                <input type="text" name="appfor" id="appfor"  value="<?php echo "Surgery"; ?>"/>
                                </td>
                </tr>
...
?>
                ...
                {  ?>
                <option value="<?php echo $row1[0]; ?>" <?php if($row3[14]==$row1[0]) { echo "selected"; }?>><?php echo $row1[1]; ?></option>
				<?php } ?>
                </select>
                </td>
                </tr>
               ...
               <tr><td>  <label class="type">
                ...
                Consultation: <input type="radio"  name="type" style=" width:40px;" value="Consultation" <?php if ($row[9]=="Consultation") { echo "checked='checked'";} ?>/>
                 
                Follow Up: <input type="radio"  name="type" style=" width:40px;" value="Follow" <?php if ($row[9]=="Consultation") { echo "checked='checked'";} ?>/>
               </td></tr>
