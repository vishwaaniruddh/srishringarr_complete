...
include('config.php');
$id=$_GET['id'];
$result = mysql_query("select * from patient where no='$id'");
...
$result2 = mysql_query("select doc_id,name from doctor where doc_id='$fid'");
$row2=mysql_fetch_row($result2);*/
?>
   
         <tr><td width="118" height="30" style="color:#ac0404; font-size:14px; font-weight:bold;">Reference By</td><td> <?php echo $row1[1]; ?></td></tr>
