...
$id=$_GET['id'];
$sql="select * from diag where dia_id='$id'";
...
<div id="" class="login-popup">
          ...
          <form method="post" class="signin" action="update_diag.php" name="diagform" onSubmit="return diagvalidate(this)" >
                ...
                <button class="submit formbutton" type="button" onClick="javascript:location.href = 'view_diag.php';">Cancel</button>
