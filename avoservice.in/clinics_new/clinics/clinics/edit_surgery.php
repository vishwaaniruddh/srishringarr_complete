...
$pid=$row[1];
$sql2="select * from new_patient where patient_id='$pid'";
$result2 = mysql_query($sql2);
$row2 = mysql_fetch_row($result2);

$aid=$row[3];

$sql3="select * from new_doc where doc_id='$aid'";
...
<div id="" class="login-popup">
            ...
            <form method="post" class="signin" action="update_surgery.php"  name="surgeryform">
                ...
                <td width="317"> <input id="name" name="name" type="text" autocomplete="on"  value="<?php echo $row2[1]; ?>" readonly></td>
                </tr>
                
<?php 
include('config.php');
$result1 = mysql_query("select doc_id,name from new_doc where specialist='Anaesthetist'");
...
?>                                          
               ...
               <td width="317">
                ...
                <td><textarea name="pro" id="pro" cols="35" rows="3" style="resize:none;"><?php echo $row[10]; ?></textarea></td>
                </tr>
                </table><br />
