...
<div id="" class="login-popup">
          ...
          <form method="post" class="signin" action="update_app.php" onSubmit="return appvalidate(this)" name="appform">
            	...
            	<label class="name">
                <span> Name: </span>
                <input id="name" name="name" type="text" value="<?php echo $row1[1]; ?>" style="background-color:#DCDCDC;" readonly="readonly">
                </label>
                                            
                <label class="cn">
                <span>Contact No.:</span>
                <input id="cn" name="cn" type="text" value="<?php echo $row1[5]; ?>" style="background-color:#DCDCDC;" readonly="readonly">
                </label>
                 
                <label class="age">
                <span>Age:</span>
                <input id="age" name="age" type="text" value="<?php echo $row1[3]; ?>" style="background-color:#DCDCDC;" readonly="readonly">
                </label>
                
                
                <label class="appfor">
                <span>Appointment For:</span>
                <input type="text" name="appfor" id="appfor" value="<?php echo $row[2]; ?>"/>
                </label>
                
               <?php 
include('config.php');
$result = mysql_query("select doc_id,name from new_doc ");
?>
                ...
                <label class="type">
                <span>Type:</span>
                Consultation: <input type="radio"  name="type" id="type" style=" width:40px;" value="Consultation" <?php if ($row[7]=="Consultation") { echo "checked='checked'";} ?>/> 
                Follow Up: <input type="radio"  name="type" id="type" style=" width:40px;" value="Follow" <?php if ($row[7]=="Follow") { echo "checked='checked'";} ?>/>
                </label>
