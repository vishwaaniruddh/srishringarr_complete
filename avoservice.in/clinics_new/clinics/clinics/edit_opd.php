...
<div id="" class="login-popup">
          ...
          <form method="post" class="signin" action="update_opd.php" onSubmit="return opdvalidate(this)" name="opdform" enctype="multipart/form-data">
                ...
                <?php $pho=mysql_query("select * from patient_photo where opd_id='$id' and patient_id='$pid'");
               ...
               <img src="<?php echo $pho1[3]; ?>" width="62" height="62"/> <input type="Text" name="old[]" value="<?php echo $pho1[3]; ?>" /><input type="file" name="image[]" id="image[]" style="background:none; border:none;">
                ...
                Name: </label></td>
                <td><input id="name" name="name" type="text" value="<?php echo $row1[6]; ?>" readonly style="background-color:#DCDCDC;"/>
                </td>
                
               <td> <label class="age">
                Age: </label></td><td>
                <input id="age" name="age" type="text" value="<?php echo $row1[26]; ?>" readonly style="background-color:#DCDCDC;"/>
                </td></tr>
                                
               <tr><td> <label class="cn">
               Contact No.: </label></td><td>
                <input id="cn" name="cn" type="text" value="<?php echo $row1[23]; ?>" readonly style="background-color:#DCDCDC;"/>
               </td>
...
?>                
                ...
                <tr>
                <td width="89">
                Consultation: </td><td width="109"><input type="radio" name="type" id="con" style="width:15px;"  onclick="confun();"/><input type="text" style="width:50px;display:none;" id="cons" value="<?php echo $row5[0];?>" readonly="readonly"/>
                </td>
                <td width="121">Plaster Application: </td><td width="60"><input type="text" style="width:50px;" name="pa" id="pa" value="<?php echo $row[14]; ?>"/></td>
                </tr>
                
                <tr><td>Follow-up: </td><td><input type="radio" name="type" id="fol" style="width:15px;" onclick="confun();"/><input type="text" style="width:50px;display:none;" id="foll" value="<?php echo $row5[1];?>" readonly="readonly"/></td>
                <td>Plaster Removal: </td><td><input type="text" style="width:50px;" name="pr" id="pr" value="<?php echo $row[15]; ?>"/></td>
                </tr>
                
                <tr>
                <td>X-Ray: </td><td><input type="checkbox"  style="width:15px;" id="xr" onclick="ab();"/><input type="text" style="width:50px;display:none;" id="xray" name="xray" value="<?php echo $row5[2];?>" readonly="readonly"/></td>
                <td>Reduction: </td><td><input type="text" style="width:50px;" name="red" id="red" value="<?php echo $row[16]; ?>"/></td>
                </tr>
                
                <tr>
                <td>Dressing: </td><td><input type="checkbox"  name="dres" id="dres" style="width:15px;" onclick="dresfun();"/><input type="text" style="width:50px;display:none;" id="drestxt" name="drestxt" value="<?php echo $row5[3];?>" readonly="readonly"/></td>
                <td>Operation: </td><td><input type="text" style="width:50px;" name="op" id="op" value="<?php echo $row[17]; ?>"/></td>
                </tr>
                
                <tr>
                <td>Strapping: </td><td><input type="checkbox" name="str" id="str" style="width:15px;" onclick="strfun();"/><input type="text" name="strtxt" id="strtxt" style="width:50px;display:none;" value="<?php echo $row5[4];?>" readonly="readonly"/></td>
                <td>Suturing: </td><td><input type="text" style="width:50px;" name="sut" id="sut" value="<?php echo $row[18]; ?>"/></td>
                </tr>
                
                <tr>
                <td>ECG: </td><td><input type="checkbox" name="ecg" id="ecg" style="width:15px;" onclick="ecgfun();"/><input type="text" style="width:50px;display:none;" name="ecgtxt" id="ecgtxt" value="<?php echo $row5[5];?>" readonly="readonly"/></td>
                <td>Certificate: </td><td><input type="text" style="width:50px;" name="cer" id="cer" value="<?php echo $row[19]; ?>"/></td>
                </tr>
                
                <tr>
                <td>Injection: </td><td><input type="text" style="width:50px;" name="inj" id="inj" value="<?php echo $row[13]; ?>"/></td>
                <td>Other: </td><td><input type="text" style="width:50px;" name="oth" id="oth" value="<?php echo $row[20]; ?>"/></td>
                </tr>
                
                <tr>
                <td>Paid: </td><td><input type="text" style="width:70px;" name="tot" id="tot" readonly="readonly" value="<?php echo $row[21]; ?>"/></td>
                </tr>
                </table>
...
include('config.php');
$result3 = mysql_query("select * from medicines ");
?>
                ...
                <option value="0">Select</option>
                <?php  $result3 = mysql_query("select * from medicines ");
				    while($row=mysql_fetch_row($result3)){ ?>
