...
<div id="" class="login-popup">
          ...
          <form method="post" class="signin" action="update_disharge.php" onSubmit="return appvalidate(this)" name="appform">
                ...
                <td ><input id="pid" name="pid" type="text"  value="<?php echo $row1[1]; ?>"readonly>&nbsp;<input id="name" name="name" type="text" value="<?php echo $row2[1]; ?>" readonly></td>
                ...
                <td><input id="pd" name="pd" type="text" value="<?php echo $row[3]; ?>"></td>
				</tr>
                
                <tr>
                <td><label class="inv">Investigations:</label></td>
                <td><textarea name="inv" rows="3" cols="22" style="resize:none;"><?php echo $row[4]; ?></textarea></td>
                </tr>
                ...
                <td><textarea name="proc" rows="3" cols="22" style="resize:none;"><?php echo $row[7]; ?></textarea></td>
                </tr>
                ...
                <td><textarea name="add_proc" rows="3" cols="22" style="resize:none;"><?php echo $row[13]; ?></textarea></td>
                </tr>
                
                <tr>
                <td><label class="treatment">Treatment on Discharge:</label></td>
                <td><textarea name="treat" rows="3" cols="22" style="resize:none;"><?php echo $row[14]; ?></textarea></td>
                </tr>
                
                <tr>
                <td><label class="advice">Advice:</label></td>
                <td><textarea name="advice" rows="2" cols="22" style="resize:none;"><?php echo $row[15]; ?></textarea></td>
                </tr>
