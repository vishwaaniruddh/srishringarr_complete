...
<div id="" class="login-popup">
         ...
         <form method="post" class="signin" action="new_app1.php" onSubmit="return appvalidate(this)" name="appform">
                <fieldset class="textbox">
                <p style="color:#ac0404; font-weight:bold; font-size:16px;" align="center">Patient Detail</p>
                ...
                <input id="cn" name="cn" type="text" >
                  ...
                  <label class="cn">
                <span>Address:</span>
                <textarea name="add" rows="3" cols="36" style="resize:none;border:1px #ac0404 solid;"></textarea>
                </label>
                 
                 
               <label class="ref"><span>Doctor Reference:</span>
                <select name="ref" style="background:#fff;border:1px solid #ac0404;width:300px;height:27px;">
                <?php
				...
				<?php } ?>
                <option value="No Reference" selected>No Reference</option>
                </select>
                
                </label>
                <p style="color:#ac0404; font-weight:bold; font-size:16px;" align="center"> New Appointment Detail</p>
