 ...
 //alert("hi");
		  ...
		  if(document.getElementById('idd').value=="" && document.getElementById('fname22').value=="")
		  {
			...
			var url = 'get_wlist.php?fname='+s;
			  ...
			  var s=document.getElementById('fname22').value;
			var url = 'get_wlist.php?fname='+s+'&id='+id;
		  }
...
{ //alert("HH");
	if (confirm("Are you sure you want to delete this entry?"))
	{
		...
		document.location="delete_wait.php?id="+id+"&aid=sa";
	}
}
...
?>
          ...
          <p style="color:#ac0404; font-weight:bold; font-size:16px;" align="center">Surgery Appointments</p>
          <table>
          <tr>
    <td><input type="text" style="width:90px;" name="idd" id="idd" value=""  onkeyup="searchById('Listing','1');" /></td>
