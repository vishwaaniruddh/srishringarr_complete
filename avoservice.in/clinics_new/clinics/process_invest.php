...
$sq=mysqli_query($con,"SELECT max(`pre_id`) FROM `pre-investigation`");
...
//echo $newname;
	  ...
	  mysqli_query($con,"INSERT INTO  pre_invest_report(patient_id,photo,pre_id)values('$id','$newname','$max[0]')");
	}
