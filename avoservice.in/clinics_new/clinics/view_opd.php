 ...
 //alert("hi");
		  ...
		  if(document.getElementById('idd').value=="" && document.getElementById('fname22').value=="")
		  {
			...
			var url = 'get_opdID.php?fname='+s;
			  ...
			  var s=document.getElementById('fname22').value;
			var url = 'get_opdID.php?fname='+s+'&id='+id;
		  }
			...
			HttPRequest.onreadystatechange = function(e)  //funtion(e)
			{
...
?>
          ...
          <p style="color:#ac0404; font-weight:bold; font-size:16px;" align="center">OPD  Records</p>
          <table>
          <tr>
    <td><input type="text" style="width:80px;" name="idd" id="idd" value=""  placeholder="search id "  onkeyup="searchById('Listing','1');" /></td>
    <td><input type="text" style="width:115px;" name="fname22" id="fname22"  placeholder="search name" onkeyup="searchById('Listing','1');"/></td>
