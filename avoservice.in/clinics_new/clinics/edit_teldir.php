...
<div id="" class="login-popup">
          ...
          <form method="post" class="signin" action="update_teldir.php" onSubmit="return validate(this)" name="form">
               <fieldset class="textbox">
            	...
            	<label class="name">
                <span> Name: </span>
                <input id="name" name="name" type="text" value="<?php if(isset($row[0])) {echo $row[0]; }?>" >
                </label>
                
                <label class="address">
                <span> Address: </span>
                <textarea name="add" cols="35" rows="3" style="resize:none;"><?php if(isset($row[1])) {echo $row[1];} ?></textarea>
                </label>

				<label class="city">
                <span>City:</span>
                <input id="city" name="city" type="text" value="<?php if(isset($row[2])) {echo $row[2]; }?>">
                </label>
                                            
                <label class="cn">
                <span>Contact No.:</span>
                <input id="cn" name="cn" type="number"  value="<?php if(isset($row[3])) {echo $row[3]; }?>">
                </label>
                 
                <label class="pin">
                <span>Pincode:</span>
                <input id="pin" name="pin" type="text" value="<?php if(isset($row[4])) {echo $row[4];} ?>">
                </label>
                ...
                <option value="<?php if(isset($row[5])) {echo $row[5]; }?>"><?php if(isset($row[5])) {echo $row[5];} ?></option>
