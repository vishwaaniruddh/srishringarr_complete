...
<form name="frm" method="post" action="new_maps_route.php" target="_new">
...
<tr class="<?php if($count%2==0){ echo "res1"; } else{ echo "res2"; }  ?>">
    <td> <input type="checkbox" name="checkbox[]" id="checkbox11" value="<? echo $row2[25]; ?>"  onclick="terms_changed(this)" ></td>
