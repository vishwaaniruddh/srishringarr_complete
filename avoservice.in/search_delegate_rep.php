...
$rt_delqry=mysqli_query($con1,"select * from `alert_redelegation` where `alert_id`='".$row[0]."' order by id DESC limit 1");
$lstl_del=mysqli_fetch_array($rt_delqry);
