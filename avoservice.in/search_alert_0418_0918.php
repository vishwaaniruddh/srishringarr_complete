...
if($_POST['bravo']=='all')
	{
 	if(isset($_POST['branch_avo']) && $_POST['branch_avo']!='')
  	{ $stt=$_POST['branch_avo'];
   	$sql.="Select * from alerts_14082019 where branch_id ='".$stt."' ";
  	} 
  	else
   	$sql.="Select * from alerts_14082019 where 1 and branch_id <>''";
}else{
 	if(isset($_POST['branch_avo']) && $_POST['branch_avo']!='')
  	{ $stt=$_POST['branch_avo'];
   	$sql.="Select * from alerts_14082019 where branch_id ='".$stt."' ";
	...
	$sql.="Select * from alerts_14082019 where branch_id='".$br1."' ";
	}
...
$fetchengid=mysqli_query($con1,"Select e.engg_name,e.phone_no1,e.engg_id from area_engg e,alert_delegation_14082019 d where e.engg_id=d.engineer and alert_id='".$row[0]."'");
...
?>
<a href="javascript:void(0);" onclick="newwin('masteralert_14082019.php?id=<?php echo $row[0] ?>','display',700,700)" class="update">
