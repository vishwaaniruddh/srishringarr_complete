...
<table width="" border="1" cellpadding="0" cellspacing="0" style="margin-top:5px;" class=""  id="" >
<tr>
...
<?php
 ...
 $sql.="Select distinct(branch_id) from alert where 1 ";
...
$str="SELECT count(*),call_status FROM `alert` where branch_id LIKE '".$row[0]."' ";
	...
	$str.=" and alert_type = 'service'";
		...
		$str.=" and call_status = 'Done'  group by branch_id";
...
//============= while loop for open call =========================
				...
				$str.=" and  (call_status = 'Pending' or call_status='1')  group by branch_id";
