...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
 	...
 	//alert(br);
			...
			if(a!="Loading"){ 
  // pmeters = 'calltype='+calltype+'&Page='+b+'&perpg='+ppg+'&timetype='+timetype+'&citytype='+citytype+'&fromdt='+fromdt+'&todt='+todt;
   pmeters = 'calltype='+calltype+'&Page='+b+'&perpg='+ppg+'&tattype='+tattype+'&fromdt='+fromdt+'&todt='+todt;
			//alert(pmeters);
			}
			else
			{
...
<center>
<h2 class="h2color">Supply Closed TAT Analysis</h2></center>
...
<table cellpadding="" cellspacing="0" >
  <tr>
        ...
        <th width="77" colspan="">    		    
              ...
              <option value="bill">SO -> Billing</option>
              <option value="dely">SO -> Delivery</option>
              <option value="inst">SO -> Install</option>
            </select>
        </th>
