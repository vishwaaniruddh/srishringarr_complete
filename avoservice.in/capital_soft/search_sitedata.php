...
$strPage = $_REQUEST['Page'];
 ...
 $sql="Select * from Amc where active='Y' and CID=96";
...
$qry2=mysqli_query($concs,"select name  from avo_branch where id='$row[8]'");
...
?></font></div></td></tr></table><form name="frm" method="post" action="export_sitedata.php" target="_new">
