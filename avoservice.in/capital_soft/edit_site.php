...
$sql="select cid,po,bankname,branch,atmid,city,pincode,address, amc_ex_date,area from Amc where amcid='".$tpid."'";

$qry=mysqli_query($concs,$sql);
...
<td width="221">
<?php
$qry2=mysqli_query($concs,"select cust_name from customer where cust_id='".$qryrow[0]."'");
...
<td><input type="text" readonly="readonly" name="atmid" value="<?php echo $qryrow[4]; ?>" /></td>
</tr>
...
<?php
$brqry=mysqli_query($concs,"select  name, id  from avo_branch order by name ASC") ;
