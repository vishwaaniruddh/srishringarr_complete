...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
		 ...
		 var branch_avo=document.getElementById('branch_avo').value; //alert(branch_avo);
			 ...
			 // alert(br);
			//alert("gg"); 
			var url = 'search_pmtoservice_duration.php'; 
		//  }
 	//alert(br);
		    var pmeters="";
			//alert(url);
			...
			if(a!="Loading"){ 
			 pmeters='Page='+b+'&perpg='+ppg+'&fromdt='+fromdt+'&todt='+todt+'&branch_avo='+branch_avo+'&engg='+engg;
			 //alert(pmeters);
			}
			else
			{
				 pmeters = '&Page='+b+'&perpg='+ppg+'&branch_avo='+branch_avo;
			}
			//alert(pmeters);
...
<h2 class="h2color">After PM next Service Call Duration</h2>

<div >
 <button id="myButtonControlID" onClick="tableToExcel('custtable', 'Table Export Example')">Export to Excel</button>
	<br />
...
<th width="75"><input type="text" name="fromdt" id="fromdt" onkeypress="return runScript(event)" readonly="readonly" onclick="displayDatePicker('fromdt');" placeholder="PM Done From"/></th>
     
     <th width="75"><input type="text" name="todt" id="todt" onkeypress="return runScript(event)"  readonly="readonly" onclick="displayDatePicker('todt');" placeholder="PM Done till"/></th>
