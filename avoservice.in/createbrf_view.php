       ...
       <script type="text/javascript" src="javascript.js"></script>
        <script>
            ...
            function a(strPage,perpg){
              ...
              var brfid=document.getElementById("brfid").value;
...
perp=document.getElementById(perpg).value;
         ...
         document.getElementById("show").innerHTML ="<center><img src=loader.gif></center>";
            ...
            type:'POST',    
   url:'createbrf_viewprocess.php',
  data:'brfid='+brfid+'&Page='+Page+'&perpg='+perp,
...
<?php include("menubar.php");?>
		      ...
		      <h2 class="h2color" align="center" st>View BRF form</h2>
<div>
<input type="hidden" name="brfid" id="brfid" value="<?php echo $_GET['brf_id'];?>">
	<div><input type="button" onclick="tableToExcel('show', 'W3C Example Table')" value="Export to Excel" style="float: right;">
