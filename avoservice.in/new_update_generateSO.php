...
<?php
	...
	$qryfirst="SELECT Remarks_update , date, update_by FROM `SO_Update` WHERE so_id='".$getdata."' order by Remarks_update desc ";
...
?>
<div id="header">
<form action="process_update_generateSO.php" method="post" name="form">
<table>
<tr>
...
<textarea rows="4" cols="28" id="reason" name="reason" value="<?php echo $fetchqry[0]; ?>"><?php echo $fetchqry[0]; ?></textarea>
<td><input type="hidden" name="po_id" value="<?php echo $getdata;?>" />
