...
$site_id = trim($_REQUEST['siteid']); // Site Id 
...
$error = '';
if($site_id !=''){
$atmqry=mysqli_query($con1,"select track_id from atm where atm_id like '".$site_id."' and active='Y'");
...
$nm=mysqli_query($con1,"select track_id from atm where atm_id like '".$pon[0]."' and so_id='".$pon[1]."' and active='Y'");
...
$site_type="site";
  ...
  $invnm=mysqli_query($con1,"select track_id from atm where atm_id like '".$pon[0]."' and so_id='".$pon[1]."' and active='N'");
