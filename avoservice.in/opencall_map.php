...
$sqlme .="and  alert_id in ($q1)";

// echo $sqlme; //die;
$table=mysqli_query($con1,$sqlme);

$engr=mysqli_query($con1,"select engg_name,latitude, longitude from area_engg where engg_id='".$engg_id."'");
    ...
    .then((response) => {
      ...
      for (let i = 0; i < route.legs.length; i++) {
       ...
       // alert("ATM id:" +atmid[i]);
        ...
        summaryPanel.innerHTML +=
          "<b>Route Segment: " + routeSegment + "</b><br> From: ";
