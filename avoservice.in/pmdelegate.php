...
<div id="header">
<form action="procpmdelegation.php" method="post" name="form" onsubmit="return validate(this)";>
<table border="1">
<?php
...
//echo "select a.createdby,a.cust_id,a.atm_id,a.bank_name,a.address,a.state1,a.problem,a.entry_date,a.alert_type,a.assetstatus,c.cust_name,a.state from pmalert a,customer c where a.alert_id='".$req."' and a.cust_id=c.cust_id";
$alert=mysqli_query($con1,"select a.createdby,a.cust_id,a.atm_id,a.bank_name,a.address,a.state1,a.problem,a.entry_date,a.alert_type,a.assetstatus,c.cust_name,a.state from pmalert a,customer c where a.alert_id='".$req."' and a.cust_id=c.cust_id");
