...
//echo $_SESSION['designation'];
 $cust=$_GET['cust'];
  $atmid=$_GET['atmid'];
  //echo "Select * from atm where atm_id='".$atmid."'";
$qryatm=mysqli_query($con1,"Select * from atm where atm_id='".$atmid."'");
...
<title>New Installation Alert</title>
...
xmlhttp.open("GET","get_datame.php?cust="+cust+"&po="+po+"&ref="+ref,true);
...
<h2>Pending Installation Alert</h2>
...
<input type="hidden" name="cust" id="cust" value="<?php echo $cust; ?>" readonly >
<input type="text" name="custname" id="custname" value="<?php echo $_GET['cname']; ?>" readonly >
</td>
...
<input type="text" name="po" id="po" value="<?php echo $resatm[11]; ?>" readonly >
...
<td colspan="3"><input type="checkbox" name="em" id="em" checked/><input type="text" name="cemail" id="cemail"/></td>
</tr>
<tr>
