...
<h2>ADD Email IDs</h2>
<div id="header">
<form action="process_add_brmail.php" method="post" name="engform" enctype="multipart/form-data" id="engform">
<table>
...
{
?>
<option value="<?php echo $clntro[0]; ?>"><?php echo $clntro[1]; ?></option>
<?php
}
?>
</td>
...
<tr>
<td height="35" valign="top"> IDs: </td>
