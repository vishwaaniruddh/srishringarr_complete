...
$sql.="Select * from alert where branch_id <>'' and close_date >= '2021-05-24 00:00:01' and close_date <= '2022-10-18 00:00:01' ";
...
{
$sql.=" and (snap_file ='' or snap_file ='NULL')";
}
else {
$sql.=" and (snap_file !='' or snap_file !='NULL')";
...
?>
 ...
 <td>
    <?php if($row[40]=='' && $row[41]=='' && $row[42]=='') { echo "No Snaps found";}
    else { echo "Available"; }?>
 ...
 <td>
   <?php 
      if($row[41] !='' && $row[41] !='Done' ) { ?>
     
     <button input type="button" class="btn btn-primary" style="color:blue ;"> <a href="<?php echo $row[41]; ?>" target="_blank" <image src="<?php echo $row[41]; ?>.jpg" alt="Inst" width="300" height="300" />Install Snap</a> </button> <br>
     <? if($row[40] !='') { ?>
     <button input type="button"> <a href="<?php echo $row[42]; ?>" target="_blank" <image src="<?php echo $row[42]; ?>.jpg" alt="buyback" width="300" height="300" />Buyback snap</a> </button> 
     <?  } else { echo "Snap-2 NA"; } 
     
      if($row[42] !='') { ?>
     <br>
     <button input type="button"> <a href="<?php echo $row[40]; ?>" target="_blank" <image src="<?php echo $row[40]; ?>.jpg" alt="buyback" width="300" height="300" />Snap-3</a> </button>  
    <? } else { echo "BB Snap NA"; } 
     
     
     } elseif ($row[41] =='Done' ) {  echo "Go to New Menu ";  }
     
     elseif ($row[41] =='')  { echo "No Snaps"; } ?>
