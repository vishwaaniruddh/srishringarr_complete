...
class NewCustomer
{
    ...
    public function Execute()
    {
        ...
        $qry = mysqli_query($conc,"INSERT INTO satyavan_accounts.customer ( `cust_name`, `email_id`, `phone_no1`, `phone_no2`, `conpername`, `contactno`, `address`, `city`, `state`, `pincode`) VALUES ('" . $this->cust . "', '" . $this->email . "', '" . $this->ph1 . "', '" . $this->ph2 . "', '" . $this->conper . "', '" . $this->percon . "', '" . $this->add . "', '" . $this->city . "', '" . $this->state . "', '" . $this->pin . "')");
