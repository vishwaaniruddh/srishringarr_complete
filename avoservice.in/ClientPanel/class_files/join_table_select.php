...
{
    public function select_from_join($server_name, $db_username, $db_password, $db_name, $array_final_column, $table_string_1, $join_type, $table_string_2, $on_column_1, $on_column_2, $filter_column, $filter_value, $array_table_heading, $return_y_n)
    {
        ...
        $i = rand();
        //create 2temp tables
        //mysqli_query($conc,"create table temp1(col1 varchar(300),col2 varchar(300),col3 varchar(300))");
        //$row=mysqli_fetch_row($table_string_1);
        //echo $row;
        //while($row){
        //        for($i=0;$i<mysqli_num_rows($table_string_1);i++){
        //
        //            }
        //
        //    }
        //mysqli_query($conc,"insert into temp1 values($row[i])");
        $temp = "temp_" . $i;
        //echo "<br>".$temp;
        ...
        $join_select_query = mysqli_query($conc,"create view $temp as (select distinct $final_column_string from $table_string_1 x $join_type $table_string_2 y on x.$on_column_1=y.$on_column_2 where $filter_column='$filter_value')");
...
//    function name_table($table,$h,$r){
    //        $named_table =mysqli_query($conc,"select * from atm_details ");
