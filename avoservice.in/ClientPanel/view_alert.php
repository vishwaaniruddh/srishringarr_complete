...
document.getElementById("search").innerHTML ="<center><img src='../loader.gif'></center>";
 	...
 	//alert(br);
			...
			if(a!="Loading"){ 
			 pmeters = 'atmid='+id+'&cid='+cid+'&area='+area+'&bank='+bank+'&Page='+b+"&calltype="+calltype+'&perpg='+ppg+'&fromdt='+fromdt+'&todt='+todt+'&state='+state+'&complaintno='+complaintno+"&openall="+openall;
			 //alert(pmeters);
			}
			else
			{
