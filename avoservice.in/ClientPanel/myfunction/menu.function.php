...
//echo $br1;
    ...
    //echo $qry;
    ?>
 <a href="transfercall.php">Tranferred Call <font color="#FF0000"><sup><?php echo mysqli_num_rows(mysqli_query($qry)); ?></sup></font></a></li>
 <?php
}
function Admin()
{
...
//echo $qry;
    ?>
<li> <a href="transfercall.php">Tranferred Call <font color="#FF0000"><sup><?php echo mysqli_num_rows(mysqli_query($qry)); ?></sup></font></a></li>
  <!-- <li><a href="#">Engineer</a>
  <ul>
  <li><a href="eng_alert.php">View Alerts</a></li>
<li><a href="newarea_eng.php">Add New Engineer </a></li>
...
<!-- <li><a href="service_test.php">Service Call </a></li> -->
 <!--<li><a href="newalert1.php">New Installation</a></li>-->
 <?php
if ($_SESSION['logid'] == 2130 || $_SESSION['logid'] == 2908) {
// if($_SESSION['logid']==1681 or $_SESSION['logid']==2130){
        ?>

 <li><a href="newtempsite.php">Temp Call Log</a></li>
 <?php }?>
 </ul>
 </li>
