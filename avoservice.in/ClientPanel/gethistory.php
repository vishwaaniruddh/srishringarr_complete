...
if ($type == 'amc') {
    $qry = "select b.atmid,a.address,a.state1,a.entry_date,a.problem,a.call_status,a.alert_id,a.status, a.alert_type from alert a,Amc b where a.atm_id='$id' and a.entry_date>'$ly' and a.atm_id=b.amcid order by alert_id DESC limit 6";


}
if ($type == 'site') {
    $qry = "select b.atm_id,a.address,a.state1,a.entry_date,a.problem,a.call_status,a.alert_id,a.status,a.alert_type from alert a,atm b where a.atm_id='$id' and a.entry_date>'$ly' and a.atm_id=b.track_id order by alert_id DESC limit 6";
