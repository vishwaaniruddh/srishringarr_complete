...
// echo $_SESSION['branch'].",".$_SESSION['user'].",".$_SESSION['designation'];
...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
	...
	var cid=document.getElementById('cid').value;//alert(cid);
			 ...
			 // alert(br);
			//alert("gg"); 
			var url = 'search_inst_report.php'; 
		//  }
 	//alert(br);
		    var pmeters="";
			//alert(url);
...
<h2 class="h2color">Inst Reports-Hard copy</h2>
...
<option value="<?php echo $name[0]; ?>"><?php echo $name[1]; ?></option>
    ...
    <th width="77" colspan=""><select name="calltype" id="calltype" onchange="searchById('Listing','1','');"> 
      <option value="0">IR Pending</option>
