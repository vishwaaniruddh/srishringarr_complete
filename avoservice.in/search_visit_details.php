...
<tr>
    <td><button class="button button1"><a href="test_distance3.php?id=<?php echo $engg_id?>&date=<?php echo $date; ?>" target="_blank">View Map with Site Location</a></button></td><td></td>
   
    &nbsp;
  <? $date1 = str_replace('/', '-', $date);
  $cdate=date("Y-m-d", strtotime($date1)); ?>  
    <td><button class="button button2"> <a href="travellingmap.php?eid=<?php echo $engg_id?>&date=<?php echo $cdate; ?>" target="_blank"> View Map with GPS Records</a></button></td>
</tr>
</body>
</html>
