...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
		 ...
		 //var branch_avo=document.getElementById('branch_avo').value; //alert(branch_avo);
			 ...
			 // alert(br);
			//alert("gg"); 
			var url = 'search_res_tat_summary.php'; 
 	...
 	//alert(br);
			...
			if(a!="Loading"){ 
			 pmeters='Page='+b+'&perpg='+ppg+'&fromdt='+fromdt+'&todt='+todt;//+'&branch_avo='+branch_avo;
...
<h2 class="h2color">Response Time Slot Summary</h2>
