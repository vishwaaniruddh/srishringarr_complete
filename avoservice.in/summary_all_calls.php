...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
		  ...
		  var openall=document.getElementById('openall').value; //alert(openall);
			 ...
			 // alert(br);
			//alert("gg"); 
			var url = 'search_summary_allcalls.php'; 
		//  }
 	//alert(br);
		    var pmeters="";
			//alert(url);
			...
			if(a!="Loading"){ 
   pmeters = 'calltype='+calltype+'&br='+br+'&Page='+b+'&perpg='+ppg+'&fromdt='+fromdt+'&todt='+todt+'&openall='+openall;
			//alert(pmeters);
			}
			else
			{
				 pmeters='calltype='+calltype+'&perpg='+ppg+'&openall='+openall;
			}
			//alert(pmeters);
...
<h2 class="h2color">CALL SUMMARY OF SERVICE AND INSTALLATION CALL</h2>
...
<table cellpadding="" cellspacing="0" >
  <tr>
   				...
   				<!--<th width="77" colspan="">
      					...
      					<option value="Done">Close call</option>
        ...
        <!--State Name-->
    	<!--<th>
        	<select name="state" id="state"  ><option value="">state</option>
					<?php
   ...
   <input type="hidden" name="calltype" id="calltype"  value="<?php echo "Done,1"; ?>"/>
  <!-- <input type="text" name="calltypeone" id="calltypeone"  value="<?php //echo 1; ?>"/>-->
  </tr>
