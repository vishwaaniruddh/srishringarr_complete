...
<table style="width:80%" width="70%" border="1" cellpadding="2" cellspacing="0" style="margin-top:5px;"  id="custtable" >

<tr>
<th width="15%">Complain ID</th> 
...
<? if(isset($_POST['calltype']) && $_POST['calltype'] =='1') { ?>
<th width="10%">Full Product </th>
<th width="10%">Front Panel Display </th>
<th width="10%">Buyback Product </th>
<th width="10%">Input Voltage </th>
<th width="10%">Output Voltage </th>
<th width="10%">Earth Voltage </th>
...
?>
 ...
 <td>
    <?php if($row[41] !='Done' or $row[41]=='NULL') { 
        
        echo "No Snaps found";
?>  <br> <br>   
 <button input type="button" style="color:blue; font:bold;" <a href="javascript:void(0);" class="btn btn-primary" onclick="window.open('add_snaps.php?id=<? echo $row[0];?>&cnt=1','upload','width=700px,height=500,left=300,top=100')" class="update">Upload Snap</a></button>
  <?  }       
...
$snapqry=mysqli_query($con1,"select * from snap_inst where alert_id='".$row[0]."'");
$snap=mysqli_fetch_row($snapqry);
 ?>
 ...
 <button input type="button" class="btn btn-primary" style="color:blue ;"> <a href="<?php echo $snap[3]; ?>" target="_blank" <image src="<?php echo $snap[3]; ?>.jpg" alt="Inst" width="300" height="300" />Front Panel Display</a> </button>
     <? } else {  ?>
 <button input type="button" style="color:blue; font:bold;" <a href="javascript:void(0);" class="btn btn-primary" onclick="window.open('add_snaps.php?id=<? echo $row[0];?>&cnt=2','upload','width=700px,height=500,left=300,top=100')" class="update">Upload Snap</a></button>
  <?  }  ?>    
 ...
 <button input type="button" class="btn btn-primary" style="color:blue ;"> <a href="<?php echo $snap[4]; ?>" target="_blank" <image src="<?php echo $snap[4]; ?>.jpg" alt="Inst" width="300" height="300" />Buyback Product</a> </button>
     <? } else {  ?>
 <button input type="button" style="color:blue; font:bold;" <a href="javascript:void(0);" class="btn btn-primary" onclick="window.open('add_snaps.php?id=<? echo $row[0];?>&cnt=3','upload','width=700px,height=500,left=300,top=100')" class="update">Upload Snap</a></button>
  <?  }  ?>    
 ...
 <button input type="button" class="btn btn-primary" style="color:blue ;"> <a href="<?php echo $snap[5]; ?>" target="_blank" <image src="<?php echo $snap[5]; ?>.jpg" alt="Inst" width="300" height="300" />Input Voltage</a> </button>
     <? } else {  ?>
 <button input type="button" style="color:blue; font:bold;" <a href="javascript:void(0);" class="btn btn-primary" onclick="window.open('add_snaps.php?id=<? echo $row[0];?>&cnt=4','upload','width=700px,height=500,left=300,top=100')" class="update">Upload Snap</a></button>
  <?  }  ?>    
     
  </td>
  <td>
 <? if($snap[6] !='' && $snap[6] !='NULL') { ?>
 <button input type="button" class="btn btn-primary" > <a href="<?php echo $snap[6]; ?>" target="_blank" <image src="<?php echo $snap[6]; ?>.jpg" alt="Inst" width="300" height="300" />Output Voltage</a> </button>
     <? } else {  ?>
 <button input type="button" style="color:blue; font:bold;" <a href="javascript:void(0);" class="btn btn-primary" onclick="window.open('add_snaps.php?id=<? echo $row[0];?>&cnt=5','upload','width=700px,height=500,left=300,top=100')" class="update">Upload Snap</a></button>
  <?  }  ?>    
 ...
 <button input type="button" class="btn btn-primary" style="color:blue ;"> <a href="<?php echo $snap[7]; ?>" target="_blank" <image src="<?php echo $snap[7]; ?>.jpg" alt="Inst" width="300" height="300" />Earth Voltage</a> </button>
     <? } else {  ?>
 <button input type="button" style="color:blue; font:bold;" <a href="javascript:void(0);" class="btn btn-primary" onclick="window.open('add_snaps.php?id=<? echo $row[0];?>&cnt=6','upload','width=700px,height=500,left=300,top=100')" class="update">Upload Snap</a></button>
  <?  }  ?>    
     
  </td>
  
  <td><a href="#" onClick="window.open('email_snaps.php?id=<?php echo $snap[0]; ?>&atmid=<? echo $atmrow[0];?>','mail','width=700px,height=750,left=200,top=40')"><font color="yellow"> Send snaps</font></a>&nbsp;&nbsp;</td>
