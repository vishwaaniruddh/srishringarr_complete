           ...
           // alert(dept1);
                ...
                $.ajax({
                    ...
                    url:'check_attendance.php',
                     data:'dates='+dates+'&br='+br+'&dept1='+dept1,
...
<input type="hidden" name="br" id="br" value= "<? echo $branch; ?>" >
<input type="hidden" name="dept1" id="dept1" value= "<? echo $dept; ?>" >
...
if(isset($_POST['dept']) && $_POST['dept'] =='service') {
$sql.=" and department='Service'";
}

if(isset($_POST['dept']) && $_POST['dept'] =='other') {
$sql.=" and department !='Service'";
}
