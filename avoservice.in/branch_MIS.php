...
<script>
  ...
  { //alert(eid);
    window.open("br_eng_det.php?eid="+eid+"&ct="+ct, "_blank", "toolbar=yes, scrollbars=yes, resizable=yes, top=200, left=200, width=800, height=600");
  }
</script>
<script>
///////////////////////////////search 
...
<h2 class="h2color">Branch MIS</h2>
