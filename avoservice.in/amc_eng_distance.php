...
<title>Distance Details <?php echo $_SESSION['user']; ?></title>
...
document.getElementById("show").innerHTML ="<center><img src=loader.gif></center>";
            ...
            type:'POST',    
   url:'search_amc_eng_dis.php',
//alert(url);
  data:'Branch='+Branch+'&Employee_name='+Employee_name+'&Page='+Page+'&perpg='+perp+'&status='+status+'&table='+table,
...
<?php include("menubar.php");?>
		 ...
		 <h2 class="h2color" align="center" st>Engg - Site Distance</h2>
<div>
