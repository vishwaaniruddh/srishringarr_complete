...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
		  ...
		  var calltype=document.getElementById('calltype').value;//alert(calltype);	 
			 ...
			 // alert(br);
			//alert("gg"); 
			var url = 'search_so_status_summary.php'; 
		//  }
 	//alert(br);
		    var pmeters="";
			//alert(url);
...
<h2 class="h2color">Sales Order Status Summary </h2>

<div >
<button id="myButtonControlID" onClick="tableToExcel('call_summary1', 'Table Export Example')">Export</button> 
