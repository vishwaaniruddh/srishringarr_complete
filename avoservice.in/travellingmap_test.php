   ...
   <script  type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAPte3KtFoLYgBej7RuZUCg7PSFqV1ov-o&sensor=false" ></script>
    ...
    <div id='input'>
      ...
      //  session_start();       
       ...
       {
        include('config.php');
        $dt=$date;  //date('2020-08-05');
        //$dt1= date('Y-m-d 20:00:00');
        $result = mysqli_query($con1,"SELECT id,latitude,longitude,dt FROM `Location` where engg_id='".$eid."' and dt>='".$dt." 05:00:00' AND dt<='".$dt." 22:00:00' AND latitude != 0.000000 and longitude!='0.000000' order by dt");
    //    echo "SELECT id,latitude,longitude,dt,address FROM `Location` where engg_id='".$eid."' and dt>='2020-07-30 08:00:00' AND dt<='2020-07-30 20:00:00' and latitude != 0.000000 order by dt";
