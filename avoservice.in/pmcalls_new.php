...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
		  ...
		  var br=document.getElementById('br').value;  //get branch id
		 ...
		 /* if(document.getElementById('idd').value=="" && document.getElementById('fname22').value=="")
		  {
			...
			//  var sitetp=document.getElementById('sitetp').value;
			  var branch=document.getElementById('branch').value;   //branch edit
                         //   var complaintno=document.getElementById('complaintno').value;
			  }
			 // alert(br);
			//alert("gg"); 
			var url = 'search_pmalert_new.php'; 
		//  }
 	//alert(br);
		    var pmeters="";
			//alert(url);
			...
			if(a!="Loading"){ 
			 pmeters = 'atmid='+id+'&cid='+cid+'&bank='+bank+'&br='+br+'&Page='+b+'&perpg='+ppg+'&fromdt='+fromdt+'&todt='+todt+'&branch='+branch;
			// alert(pmeters);
			}
			else
			{
...
?></select></th>
   <!-- <th><input type="text" name="docket" id="docket" onkeypress="return runScript(event)" placeholder="Client Docket Number"/></th>-->
    ...
    <th width="75"><input type="text" name="bank" id="bank" onkeypress="return runScript(event)" placeholder="Bank Name"/></th>
...
$brqry=mysqli_query($con1,"Select * from avo_branch");  //query for get branch Name
...
<!--======================filter for branch=======================-->
	 <th>
	 <select name="branch" id="branch" onchange="searchById('Listing','1','');" style="width:150px">
