...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
	...
	xmlhttp.open("GET","get_prod_specs.php?brid="+brid,true);
	xmlhttp.send();
}
...
document.getElementById("search").innerHTML ="<center><img src=../loader.gif></center>";
		  ...
		  if (!HttPRequest) {
			...
			var url = 'search_productwise_sales.php';
		var pmeters="";
		//	alert(url);
			if(a!="Loading"){ 
...
<h2 class="h2color">Product-wise Sales Records</h2>

<div>

<table  border="0" cellpadding="0" cellspacing="0">

<tr><th>Product</th><th>Model</th><th>Customer Vertical</th><th>Branch</th><th>From Bill Date</th><th>To Bill date</th><th>Search</th></tr>
...
<th width="75">
<input type="text" name="sdate" id="sdate"  readonly="readonly" onclick="displayDatePicker('sdate')"; placeholder="From Bill Date"/></th>


<th width="75"><input type="text" name="edate" id="edate"  readonly="readonly" onclick="displayDatePicker('edate')"; placeholder="To Bill Date"/></th>
