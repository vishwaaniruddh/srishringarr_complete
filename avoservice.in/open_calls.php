...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
 	...
 	//alert(br);
			...
			if(a!="Loading"){ 
			 pmeters = 'atmid='+id+'&cid='+cid+'&bravo='+bravo+'&Page='+b+"&openall="+openall+'&perpg='+ppg+'&fromdt='+fromdt+'&todt='+todt+'&eng='+eng+'&complaintno='+complaintno+'&branch_avo='+branch_avo;
			// alert(pmeters);
			}
			else
			{
...
<h2 class="h2color">View Open Calls</h2>
