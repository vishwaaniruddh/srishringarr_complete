...
?>
 ...
 <?php
$str.=" order by party_name ASC  LIMIT 25";
...
<td width="47" height="31" style="color:#AFA;"> <a href='edit_party.php?id=<?php echo $row[0]; ?>' ><font color="yellow">Edit </font></a></td>
