...
<form action="process_newsiteme3.php" method="post" enctype="multipart/form-data"  name="form" onSubmit="return validate(this)">
<table>
<tr>
...
<td colspan="3"><select name="servicetype" id="servicetype"><option value=''>Select</option>
...
<td>ED: </td><td><input type="text" name="ed" id="ed" /></td>
</tr>
...
Rate: <input type="text" name="upsrate" id="upsrate" />
</td>
</tr>
<tr>
...
Rate: <input type="text" name="batteryrate" id="batteryrate" />
</td>
...
Rate: <input type="text" name="isotrate" id="isotrate" />
</tr>
...
Rate: <input type="text" name="stabrate" id="stabrate" />
</tr>
<tr>
<td height="35" >
<b>AVR</b>
...
Rate: <input type="text" name="avrrate" id="avrrate" />
