...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
 	...
 	//alert(br);
			...
			if(a!="Loading"){ 
   pmeters = 'atmid='+id+'&cid='+cid+'&area='+area+'&bank='+bank+'&br='+br+'&Page='+b+"&calltype="+calltype+'&perpg='+ppg+"&docket="+docket+'&fromdt='+fromdt+'&eng='+eng+'&sitetp='+sitetp+'&state='+state+'&complaintno='+complaintno;
			//alert(pmeters);
			}
			else
			{
...
<table cellpadding="" cellspacing="0" >
  <tr>
    <th width="77" colspan=""><select name="calltype" id="calltype">
...
?></select></th>
    <th><input type="text" name="docket" id="docket" onkeyup="" placeholder="Client Docket Number"/></th>
...
//echo $stqry;
?>
<select name="state" id="state" onchange="" style="width:150px"><option value="">-select State-</option>
<?php
...
<th width="75"><input type="text" name="complaintno" id="complaintno" onkeyup="" placeholder="ComplaintNo"/></th>
    ...
    <?php
     ...
     <th width="77" colspan=""><select name="sitetp" id="sitetp" onchange="" style="width:100px">
     ...
     <th width="75" colspan="2"><input type="text" name="fromdt" id="fromdt" readonly="readonly" onclick="displayDatePicker('fromdt');" placeholder="Today Date"/></th>
