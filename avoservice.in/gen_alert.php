...
//   global $con1;
  ...
  function get_po($parameter, $id,$con1){
  ...
  function get_new_sales_order($parameter, $id,$con1){
...
$qrycust=mysqli_query($con1,"Select cust_name from customer where cust_id='".$cust."'");
$cname=mysqli_fetch_row($qrycust);
...
<form action="new_process_alertme.php" method="post" name="form" onSubmit="return validate1(this)" >
...
$po_id = get_new_sales_order('po_trackid', $trackid,$con1);

?>
<input type="text" name="po" id="po" value="<?php echo get_po('po_no',$po_id,$con1); ?>" readonly >
...
?>
<option value="<?php echo $sqlst1[1]; ?>" <?php if($sqlst1[1]== get_atm('state', $trackid,$con1)) echo "selected"; ?>><?php echo $sqlst1[1]; ?></option>
<?php }?>
</select>
</td>
</tr>
...
?>
<option value="<?php echo $sqlbr1[0]; ?>" <?php if($sqlbr1[0]==get_atm('branch_id', $trackid,$con1)) echo "selected"; ?>><?php echo $sqlbr1[1]; ?></option>
<?php }?>
</select>
</td>
</tr>
...
<td colspan="3"><input type="text" name="cname" id="cname" value="<?php echo get_new_sales_order('user_cont_name', $trackid,$con1);?>"/></td>
</tr>

<tr>
<td height="35">Contact : </td>
<td colspan="3"><input type="text" name="cphone" id="cphone" value="<?php echo get_new_sales_order('user_cont_phone', $trackid,$con1);?>"/></td>
</tr>

<tr>
<td height="35">Email : </td>
<td colspan="3"><input type="checkbox" name="em" id="em" checked/><input type="text" name="cemail" id="cemail" value="<?php echo get_new_sales_order('user_mail', $trackid,$con1);?>"/></td>
</tr>
<tr>
...
<tr>
<td colspan="4" height="35"><input type="submit" id= "Submit" name-"Submit" value="submit" class="readbutton" /></td>
</tr>
</table>
</div>
</form>
