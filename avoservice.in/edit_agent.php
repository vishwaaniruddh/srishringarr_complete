...
$qry=mysqli_query($con1,"select * from agents where id='".$agentid."'");
...
<h2>Edit Agent</h2>
<div id="header">
<form action="process_edit_agent.php" method="post" name="engform" enctype="multipart/form-data" id="engform">
<table>


<tr>
<td height="35">Agent Name: </td>
<td><input type="text" name="agent" id="agent" value="<?php echo $row[1]; ?>" required/></td>
</tr>
...
<td><input type="number" min="1111111" max="999999999999999" name="mobile" id="mobile" value="<?php echo $row[4]; ?>" style="font-size:15px; font-weight:bold;" onkeyup="if(parseInt(this.value)>999999999999999){ this.value =''; return false; }" /></td>
</tr>
