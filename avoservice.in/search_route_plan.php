...
<center>
<form name="frm" method="post" action="search_route_plan.php">
...
<?php
	    ...
	    $brname=mysqli_fetch_row($branch);
               ?>
	   <option value="<?php echo $brname[0]; ?>" <? if($_POST['branch']==$brname[0]){ echo 'selected'; } ?>><?php echo $brname[1]; ?></option>
...
$sqlen= "select engg_name from area_engg where engg_id='".$engg_id."'";
