...
$str.="select * from `avo_branchmgr_email` where 1";
...
$brname=mysqli_query($con1,"select `name` from `avo_branch` where `id`='".$row[2]."'");
$brname1=mysqli_fetch_row($brname);
echo $brname1[0]; ?>
</td>
...
<td width="47" height="31"> <a href='edit_brmail.php?id=<?php echo $row[0]; ?>'> Edit </a></td>
