...
$sql="Select * from alert where alert_type ='dere'";
...
$atmrow=mysqli_fetch_row($atmid);
?>

<td width="95"><?php echo $atmrow[0]; ?></td>
...
<!---call Type=====================-->
<td width="95"><?php echo "Reinstall";   ?></td>
