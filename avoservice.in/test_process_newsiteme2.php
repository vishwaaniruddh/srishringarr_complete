...
//=============================inserting code start here==========================================
		 ...
		 $result12=mysqli_query($con1,"insert into `purchase_order`(po_no,no_sites,cust_id,ref_id,pm,po_date,ed,del_type,buyeraddress,gst,salesperson) VALUES ('".$pordr."','".$nos."','".$cust."','".$ref."','".$service."',STR_TO_DATE('".$podt."','%d/%m/%Y'),'0','".$del_type."','".$badd."','".$gst."','".$sp."')");
...
//=========================================================================================================================================		   
		  ...
		  for($i=0;$i<$count;$i++)
		   ...
		   values('".$pordr."','".$srr[$i]."','".$model[$i]."','".$upsno[$i]."','".$upswr[$i]."','".$upsrate[$i]."')");
...
VALUES('$atm','$bank','$area','$pincode','".$city."','".$site_branch."','".$addr."','".$ref."','".$pordr."','".$cust."','".$service."', STR_TO_DATE('".$podt."','%d/%m/%Y'),'".$state."','".$cat."',1)");
 $id=mysqli_insert_id(); 
            }
            else if($flag==1)
            {
...
$qry=mysqli_query($con1,"INSERT INTO `pending_installations`(`atmid`, `po`, `cust_id`, `req_date`, `DNo`, `del_type`, `type`, `status`,`createdby`,`ed`,`contactperson`,`contactno`,`BB_Details`,`bbdrate`,`entry_date`,new_email,bback) VALUES ('".$id."','".$pordr."','".$cust."',STR_TO_DATE('".$dateget."','%d/%m/%Y'),'".$ref."','".$del_type."','".$type."','0','".$userid."','0','".$contact."','".$contactno."','".$bbd."','".$bbdrate."','".$entry_date."','".$newemailr."','".$bback."')");
//echo "INSERT INTO `pending_installations`(`atmid`, `po`, `cust_id`, `req_date`, `DNo`, `del_type`, `type`, `status`,`createdby`,`ed`) VALUES ('".$id."','".$pordr."','".$cust."',STR_TO_DATE('".$dateget."','%d/%m/%Y'),'".$ref."','".$del_type."','".$type."','0','".$userid."','".$ed."')";
$pid=mysqli_insert_id();
	...
	$result1= mysqli_query($con1,"insert into `site_assets`(cust_id,po,assets_name,assets_spec,valid,quantity,atmid,type,rate,callid)values('$cust','$pordr','UPS','".$ups."','".$upswr."','".$upsno."','".$id."','NEW','".$upsrate."','".$pid."')");
	 }
	 if($btryno>0)
	{
	...
	$result1= mysqli_query($con1,"insert into `site_assets`(cust_id,po,assets_name,assets_spec,valid,quantity,atmid,type,rate,callid)values('$cust','$pordr','Battery','".$btry."','".$btrywr."','".$btryno."','".$id."','NEW','".$batteryrate."','".$pid."')");
	 }
	...
	$result1= mysqli_query($con1,"insert into `site_assets`(cust_id,po,assets_name,assets_spec,valid,quantity,atmid,type,rate,callid)values('$cust','$pordr','Isolation Transformer','".$isot."','".$isotwr."','".$isotno."','".$id."','NEW','".$isotrate."','".$pid."')");
	 }
	 if($stabno>0)
	{
	...
	$result1= mysqli_query($con1,"insert into `site_assets`(cust_id,po,assets_name,assets_spec,valid,quantity,atmid,type,rate,callid)values('$cust','$pordr','Stabilizer','".$stab."','".$stabwr."','".$stabno."','".$id."','NEW','".$stabrate."','".$pid."')");
	 }
	 if($avrno>0)
	{
	//echo "insert into `site_assets`(cust_id,po,assets_name,assets_spec,valid,quantity,atmid)values('$cust','$pordr','Stabilizer','".$stab."','".$stabwr."','".$stabno."','".$atm."')";	
	$result1= mysqli_query($con1,"insert into `site_assets`(cust_id,po,assets_name,assets_spec,valid,quantity,atmid,type,rate,callid)values('$cust','$pordr','AVR','".$avr."','".$avrwr."','".$avrno."','".$id."' ,'NEW','".$avrrate."','".$pid."')");
	 }	
	 if(isset($oth) and $oth!='')
	 {
	  $insert=mysqli_query($con1,"insert into `site_assets` (cust_id,po,assets_name,atmid,rate,callid) 
...
//$result= mysqli_query($con1,"INSERT INTO Amc(po,cid,atmid,bankname,area,pincode,city,branch,address,Refid,state)VALUES('".$pordr."', '".$cust."', '".$atm."', '".$bank."', '".$area."', '".$pincode."', '".$city."', '".$site_branch."','".$addr."','".$ref."','".$state."')");
 ...
 $qry=mysqli_query($con1,"INSERT INTO `pending_installations`(`atmid`, `po`, `cust_id`, `req_date`, `DNo`, `del_type`, `type`, `status`,`createdby`,`ed`,`contactperson`,`contactno`,`BB_Details`,`bbdrate`,`entry_date`,new_email) VALUES ('".$id."','".$pordr."','".$cust."',STR_TO_DATE('".$dateget."','%d/%m/%Y'),'".$ref."','".$del_type."','".$type."','0','".$userid."','0','".$contact."','".$contactno."','".$bbd."','".$bbdrate."','".$entry_date."','".$newemailr."')");
//echo "INSERT INTO `pending_installations`(`atmid`, `po`, `cust_id`, `req_date`, `DNo`, `del_type`, `type`, `status`,`createdby`,`ed`) VALUES ('".$id."','".$pordr."','".$cust."',STR_TO_DATE('".$dateget."','%d/%m/%Y'),'".$ref."','".$del_type."','".$type."','0','".$userid."','".$ed."')";
 $pid=mysqli_insert_id();
...
$insert=mysqli_query($con1,"insert into `amcassets`(amcid,amcpoid,assets_name,assetspecid,quantity,siteid,rate,buyback,callid) values('$cust','$pordr','Battery','".$btry."','".$btryno."','".$id."','".$upsrate."','".$batbrate."','".$pid."')");
	}
...
$insert=mysqli_query($con1,"insert into `amcassets`(amcid,amcpoid,assets_name,assetspecid,quantity,siteid,rate,buyback,callid) values('$cust','$pordr','Isolation Transformer','".$isot."','".$isotno."','".$id."','".$isotrate."','".$isobrate."','".$pid."')");
	}
...
$insert=mysqli_query($con1,"insert into `amcassets`(amcid,amcpoid,assets_name,assetspecid,quantity,siteid,rate,buyback,callid) values('$cust','$pordr','Stabilizer','".$stab."','".$stabno."','".$id."','".$stabrate."','".$stbrate."','".$pid."')");
	}
	...
	$insert=mysqli_query($con1,"insert into `amcassets`(amcid,amcpoid,assets_name,assetspecid,quantity,siteid,rate,buyback,callid) values('$cust','$pordr','AVR','".$avr."','".$avrno."','".$id."','".$avrrate."','".$avbrate."','".$pid."')");
	 }
	 if(isset($oth) and $oth!='')
	 {
	  $insert=mysqli_query($con1,"insert into `amcassets` (amcid,amcpoid,assets_name,siteid,rate,callid) 
		   values('$cust','".$pordr."','".$oth."','".$id."','".$othrate."','".$pid."')");
	 }	
	 }
/*
