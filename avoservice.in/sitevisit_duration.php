...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
		  ...
		  if (!HttPRequest) {
			...
			var url = 'search_site_duration.php'; 
	
		    var pmeters="";
//	alert(url);
			//var pmeters = 'mode='+Mode+'&Page='+Page+'&bank='+bank; 
			if(a!="Loading"){ 
			 pmeters = 'Page='+b+'&perpg='+ppg+'&sdate='+sdate+'&edate='+edate+'&engr='+engr+'&branch='+branch;
			// alert(pmeters);
			}
			else
			{
...
<h2 class="h2color">Site Visit Duration</h2>
...
<?   if($_SESSION['designation']=='4'){   ?>
   ...
   <? }  else ?>
    ...
    <option value="<?php echo $name[0]; ?>"><?php echo $name[1]; ?></option>
        ...
        <th width="75"><input type="text" name="sdate" id="sdate" onkeypress="return runScript(event)" readonly="readonly" onclick="displayDatePicker('sdate');" placeholder=" From Date"/></th>
      	
<th width="75"><input type="text" name="edate" id="edate" onkeypress="return runScript(event)" readonly="readonly" onclick="displayDatePicker('edate');" placeholder="To Date"/></th>
