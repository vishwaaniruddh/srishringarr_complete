...
{
//$atmdet=mysql_query("select * from atm where track_id='".$row[0]."'");	
...
$qry2me=mysql_query("Select * from site_assets where atmid = '".$row[0]."' and callid='".$row[8]."'");
while($detailme=mysql_fetch_row($qry2me))
{
//echo "Select * from installed_sitesme where assets like '".$detailme[3]."%' and atm_id='".$row[17]."'";
$qryin=mysql_query("Select * from installed_sitesme where assets like '".$detailme[3]."%' and atm_id='".$row[17]."'");
...
<td width="95">
<?php 
//$stateshow=mysql_query("select state from state where branch_id='".$row[7]."'");
//$stateshow1=mysql_fetch_row($stateshow);
echo $row[12]; ?></td>
...
<td width="75"><?php 
if(isset($row[16]) and $row[16]!='0000-00-00 00:00:00') echo  date('d-m-Y',strtotime($row[16]));
?></td>
<!--<td width="75"><?php 

//$qry2me=mysql_query("select * from site_assets where cust_id='$row[2]' and po='$row[11]' and atmid='".$row[0]."'");
//while($detailme=mysql_fetch_row($qry2me))
//{
