...
$qry=mysql_query("INSERT INTO `satyavan_accounts`.`tempsites` (`id`, `custid`, `po`, `atmid`, `bankname`, `area`, `pincode`, `city`, `state`, `address`, `ref_id`) VALUES (NULL, '".$_POST['cust']."', '".$_POST['po']."', 'temp_".$_POST['atmid']."', '".$_POST['bank']."', '".$_POST['area']."', '".$_POST['pincode']."', '".$_POST['city']."', '".$_POST['state']."', '".$_POST['address']."', '".$_POST['atmid']."')");
...
$up=mysql_query("Update alert set `createdby`='".$qry2ro[0]."_".date("Ymd").$tempid."' where alert_id='".$id."'");
?>
