...
if($check_atm_sql_result){
    ...
    mysql_query("insert into atm (atm_id,cust_id,bank_name,area,pincode,city,branch_id,start_date,address,po,servicetype,podate,state1,so_id, site_type) values('".$atm_id."','".$custid."','".$bank_name."','".$area."','".$pincode."','".$city."','".$branch_id."','".$start_date."','".$address."','".$po."','0','".$po_date."','".$state."','".$so_id."', 'opex')");

    $site_asset_call_id = mysql_insert_id();
