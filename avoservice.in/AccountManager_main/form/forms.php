...
<table border="0">
<tr><td colspan="3" align="center"> <h2 style="color:#069;"><?php if(isset($_GET['success'])) echo $_GET['success']; else {} ?> </h2></td></tr>
<tr>
<td width="130">
Select Customer : </td>
<td width="190">
...
<option value="">Select</option>
<?php
$qry1=mysql_query("select * from state");
while($row=mysql_fetch_row($qry1)){
?>
...
<?php
$qry1=mysql_query("select * from avo_branch");
while($row=mysql_fetch_row($qry1)){
?>
<option value="<?php echo $row[0]; ?>" ><?php echo $row[1]; ?></option>
