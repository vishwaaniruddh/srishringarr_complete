...
$po=$_POST['po'];
 ...
 //print_r($asset);
 //echo "<br>";
 $qrycusid=mysql_query("Select cust_id from customer where cust_name='".$cust."'");
 $cusres=mysql_fetch_row($qrycusid);
$autoid=$_POST['autoid'];
// print_r($asset);
 //$strhy=array();
...
$buyback=mysql_query("INSERT INTO `buyback` (`id`, `alertid`, `desc`, `status`) VALUES (NULL, '".$id."', '".$bdesc."', '0')");
...
//$up=mysql_query("Update alert set `createdby`='".$qry2ro[0]."_".date("Ymd").$id."' where alert_id='".$id."'");


//echo "Update alert set `createdby`='".$_SESSION[user]."'_'".$id."' where alert_id='".$id."'";
//$sq=mysql_query("select max(alert_id) from alert");
...
for($i=0;$i<count($asset);$i++)
{
  ...
  /*echo "INSERT INTO `alert_assets` (`id`, `alert_id`, `po`, `assets`, `qty`, `valid`) VALUES (NULL, '".$id."', '".$po."', '".$asstre."', '".$qtyfinal."', '".$valid."')";*/
	  ...
	  $qryst=mysql_query("INSERT INTO `alert_assets` (`id`, `alert_id`, `po`, `assets`, `qty`, `valid`) VALUES (NULL, '".$id."', '".$po."', '".$asstre."', '".$qtyfinal."', '".$valid."')");
...
$message2="";
		...
		$qry1=mysql_query("Select state_id from state where state='".$state."'");
...
echo "Error Creating Alert".mysql_error();
 ?>
