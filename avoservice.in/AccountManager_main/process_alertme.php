...
$changesta=mysql_query("update `atm` set `pending_status`=0 where `track_id`='".$atm."'");

mysql_query("update `pending_installations` set `status`=2,alert_id='".$id."' where `id`='".$callid."'");
...
for($i=0;$i<count($asset);$i++)
{
	...
	//echo $valid;
//echo $qtyre;
$qryst=mysql_query("INSERT INTO `alert_assets` (`id`, `alert_id`, `po`, `assets`, `qty`, `valid`,`pm`) VALUES (NULL, '".$id."', '".$po."', '".$asstre."', '".$qtyfinal."', '".$valid."','".$_POST['pm']."')");
/*$tab1=$in_obj-
