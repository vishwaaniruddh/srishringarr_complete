...
//$table=mysql_query("select * from alert where state='$br1[$i]'");
...
$fetchengid=mysql_query("Select engg_name from area_engg where engg_id='".$getold[0]."'");
...
$qr=mysql_query("select * from transfersites where alertid='".$row[0]."' and approval LIKE 'disapprove%' and status='0' order by id DESC limit 1");


  ?><br />
   
<a class="update" onclick="newwin('calltransfer.php?id=<?php echo $row[0] ?>','transfer')"  href="#"  >Transfer<?php if(mysql_num_rows($qr)>0){ 
