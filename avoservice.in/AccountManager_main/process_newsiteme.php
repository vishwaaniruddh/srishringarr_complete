...
//=============================inserting code start here==========================================
	...
	//echo "insert into `po_assets` (`po_no`,`assets_name`,`specs`,`qty`,`warranty`,`rate`) values('".$pordr."','UPS','".$ups."','".$upsno."','".$upswr."','".$upsrate."')";
	 ...
	 $addasset=mysql_query("insert into `po_assets` (`po_no`,`assets_name`,`specs`,`qty`,`warranty`,`rate`) 
...
$result= mysql_query("INSERT INTO  atm(atm_id,bank_name,area,pincode,city,branch_id,address,ref_id,po,cust_id,servicetype,podate,state1,cat,pending_status)
...
if($result){
		...
		$qry=mysql_query("INSERT INTO `instdetails`(`atm_id`, `bomno`, `bomdate`, `indentno`, `indentdate`, `vat`, `ed`, `dono`, `freight`) VALUES ('".$id."','".$bomno."',STR_TO_DATE('".$bomdate."','%d/%m/%Y'),'".$indentno."',STR_TO_DATE('".$indentdate."','%d/%m/%Y'),'".$vat."','".$ed."','".$dono."','".$freight."')");
}
	if($upsno>0)
	{
...
$result= mysql_query("INSERT INTO Amc(po,cid,atmid,bankname,area,pincode,city,branch,address,Ref_id,servicetype,state1)VALUES('".$pordr."', '".$cust."', '".$atm."', '".$bank."', '".$area."', '".$pincode."', '".$city."', '".$site_branch."','".$addr."','".$ref."','".$service."','".$state."')");
 $id=mysql_insert_id();
 	$ponum=mysql_query("select `po` from `Amc` where `po`='".$pordr."'");
	$ponum1=mysql_num_rows($ponum);
