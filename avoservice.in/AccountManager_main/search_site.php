...
?>
 <div align="center">
 Records <? echo $Num_Rows; ?> Per Page :<select name="perpg" id="perpg" onchange="searchById('Listing','1','perpg');">
...
$br=mysql_fetch_row($branch);
?>
<td width="95"><?php echo $br[0] ?></td>
...
?></td>
<td width="75"><?php echo date('d/m/Y',strtotime($row[14]));
?></td>
<!--<td width="75"><?php 
...
<a href="javascript:confirm_generate('<?php echo $cid; ?>','<?php echo $row[1]; ?>','<?php echo $row[0]; ?>');" target="_blank"> Generate Call</a>
</td>-->
