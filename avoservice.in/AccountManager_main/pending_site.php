...
if(confirm("Insure Material is delivered at site."),confirm("Insure Site is ready fro Installation."))
  {
    document.location="newalert1.php?cust="+cust+"&atmid="+atmid+"&trackid="+trackid+"&callid="+callid;
  }
...
document.getElementById("search").innerHTML ="<center><img src=../loader.gif></center>";
		 ...
		 /* if(document.getElementById('idd').value=="" && document.getElementById('fname22').value=="")
		  {
			...
			if(type=="sale" || type=="wh"){			
			var url = 'search_pendingsale.php';
			}else{
		...
		var pmeters="";
			...
			if(a!="Loading"){ 
			 pmeters = 'id='+id+'&cid='+cid+'&city='+city+'&state='+state+'&area='+area+'&pin='+pin+'&area='+area+'&bank='+bank+'&Page='+b+'&perpg='+ppg+'&type='+type;
			}//alert("gg");
			else
			{
			pmeters = 'Page='+b+'&perpg='+ppg+'&cid='+cid+'&type='+type;	
			}
			//alert(pmeters);
...
<h2 class="h2color">Pending Site</h2>
