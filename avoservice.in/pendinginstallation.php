...
function confirm_generate(cust,atmid,trackid,cname)
{
//alert("hi");
...
if(confirm("Ensure Material is delivered at site."),confirm("Ensure Site is ready for Installation."))
  {
    document.location="newalert1.php?cust="+cust+"&atmid="+atmid+"&trackid="+trackid+"&cname="+cname;
  }
		 ...
		 /* if(document.getElementById('idd').value=="" && document.getElementById('fname22').value=="")
		  {
			...
			var url = 'siteinstallsearch.php';
			}else{
			var url='amcinstallsearch.php';
		 }
