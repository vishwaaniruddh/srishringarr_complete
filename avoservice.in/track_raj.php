...
<!--</style>-->
   ...
   <script  type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAiPMuQuqUyoDb2r2aap8PcrZ6Ht3Dvhqk&sensor=false&callback=initMap"></script>
 ...
 if(isset($_POST['fdate']) && $_POST['fdate']!='' && isset($_POST['todate']) && $_POST['todate']!='')  {
    $resultx = "SELECT id,latitude,longitude,dt, address FROM `Location` where engg_id='".$srno[2]."' and dt between '".$fromdate." 00:00:00' and '".$todate." 23:59:59' AND latitude != 0.000000";        
 } else  
       
     $resultx = "SELECT id,latitude,longitude,dt, address FROM `Location` where engg_id='".$srno[2]."' and dt > '".$date." 00:00:00' AND latitude != 0.000000";
        
  //  echo $resultx;
    $result= mysqli_query($con1,$resultx);
      ...
      //  echo mysqli_num_rows($result).'<br>';
       ...
       // echo $encodedString;       
        ...
        <form action="track_raj.php" method="post" >
