...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
		  ...
		  var calltype=document.getElementById('calltype').value;//alert(calltype);	 		  
			 ...
			 // alert(br);
			//alert("gg"); 
			var url = 'search_eng_mis_summary1.php'; 
		//  }
 	//alert(br);
		    var pmeters="";
			//alert(url);
			...
			if(a!="Loading"){ 
   pmeters = 'calltype='+calltype+'&Page='+b+'&perpg='+ppg+'&fromdt='+fromdt+'&todt='+todt+'&branch='+branch_avo;
			//alert(pmeters);
			}
			else
			{
...
<h2 class="h2color">Engineer MIS Summary</h2>
