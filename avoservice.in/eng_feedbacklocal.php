...
$qryal=mysqli_query($con1,"Select alert_type from alertlocal where alert_id='".$alert."'");
$alres=mysqli_fetch_row($qryal);
?>
<form action="process_feedbacklocal.php" method="post" name="form"  >
<table width="394">
<tr>
...
$qryalrt=mysqli_query($con1,"Select * from alert_assetslocal where alert_id='".$alert."' and assets like '%".UPS."%'");
...
<?php
$cnt=0;
$qryothr=mysqli_query($con1,"Select assets,qty from alert_assetslocal where alert_id='$alert' and assets not like '%".UPS."%'");
...
<td>
<input type="button" value="Cancel" class="readbutton" onclick="Javascript:location.href='eng_alert_local.php'"/>
</td>
</tr>
</table>
</form>
