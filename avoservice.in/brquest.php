...
{
?>
<form name="frm" method="post" action="processquery.php"  onsubmit="return validate(this)">
<br>
<table>
...
<input type="radio" name="status" value="accept" checked> Call Accepted &nbsp;&nbsp;&nbsp;
...
<input type="hidden" name="state" id="alertid" value="<?php echo $questate; ?>">
<input type="hidden" name="type" id="type" value="<?php echo $type; ?>">
<input type="submit" name="cmdsub" value="Submit" >&nbsp;&nbsp;&nbsp;
<input type="reset" name="cmdreset" value="Reset"></td></tr>
</table>
</form>
<?php
}
