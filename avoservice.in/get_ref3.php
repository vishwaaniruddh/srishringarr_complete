...
echo $amcrow[1]."***".$amcrow[2]."***".$amcrow[3]."***".$amcrow[4]."***".$amcrow[10]."***".$amcrow[7]."***".$amcrow[9]."***".$amcrow[6]."***".$amcrow[5]."***".$ccro[0]."***".$amcrow[8]."***".$amcrow[0]."***".$amcrow[11]."***".$amcrow[21]."***".$amcrow[13];
}
//==================== SITE================ FROM ATM TABLE
if($type=='site')
{
...
$cc=mysqli_query($con1,"select email from emailid where custid='".$amcrow[1]."' and bank='".$amcrow[4]."'");
$ccro=mysqli_fetch_row($cc);
echo $amcrow[2]."***".$amcrow[11]."***".$amcrow[1]."***".$amcrow[3]."***".$amcrow[15]."***".$amcrow[6]."***".$amcrow[9]."***".$amcrow[5]."***".$amcrow[4]."***".$ccro[0]."***".$amcrow[7];
}
?>