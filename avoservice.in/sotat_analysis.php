...
<table cellpadding="" cellspacing="0" >
 ...
 <th><select name="cid" id="cid"  ><option value="">Select Client</option><?php
   ...
   <th width="75"><input type="text" name="fromdt" id="fromdt" onkeypress="return runScript(event)"  onclick="displayDatePicker('fromdt');" placeholder="From Date" value="<?php echo date(d/m/Y); ?>" required="required"/></th>
     
     <th width="75"><input type="text" name="todt" id="todt" onkeypress="return runScript(event)"  onclick="displayDatePicker('todt');" placeholder="Upto Date" value="<?php echo date(d/m/Y); ?>" required="required"/></th>
    
 <th width="75">
<select name="col" id="type">
<option value="inv_date">Invoice Date</option>
<option value="del_date">Delivery Date</option>
<option value="sub_date">Submission Date</option>
