...
$n2=mysqli_num_rows($qryupdate2);
   ...
   // $objSheet->setCellValueByColumnAndRow(15, $row,$atmid);
    $objSheet->setCellValueByColumnAndRow(15, $row,$sql_result['crn_no']);
    $objSheet->setCellValueByColumnAndRow(16, $row,$sql_result['crn_amount']);
    $objSheet->setCellValueByColumnAndRow(17, $row,$del_type);
    $objSheet->setCellValueByColumnAndRow(18, $row,$inst_request);
    $objSheet->setCellValueByColumnAndRow(19, $row,$sql_result['del_mode']);
    $objSheet->setCellValueByColumnAndRow(20, $row, $sql_result['courier']);
    $objSheet->setCellValueByColumnAndRow(21, $row, $sql_result['docketno']);
    $objSheet->setCellValueByColumnAndRow(22, $row, $sql_result['est_date']);
    $objSheet->setCellValueByColumnAndRow(23, $row,$sql_result['dis_date']);
    $objSheet->setCellValueByColumnAndRow(24, $row,$sql_result['del_date']);
    $objSheet->setCellValueByColumnAndRow(25, $row,$status1);
    $objSheet->setCellValueByColumnAndRow(26, $row,$call_ticket_no);
    $objSheet->setCellValueByColumnAndRow(27, $row,$call_status);
    $objSheet->setCellValueByColumnAndRow(28, $row,$pre_invoice);
    $objSheet->setCellValueByColumnAndRow(29, $row,$post_invoice);
