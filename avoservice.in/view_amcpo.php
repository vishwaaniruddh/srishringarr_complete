...
document.getElementById("search").innerHTML ="<center><img src=../loader.gif></center>";
		  ...
		  if (!HttPRequest) {
			 ...
			 var sites=document.getElementById('sites').value; //alert(sites);
		     ...
		     if(document.getElementById('sites').value=="2"){
			
                      var url='search_amcpo.php'
		     
		     } else { var url='search_amcpo_single.php'  }
       
		var pmeters="";
		//	alert(url);
			if(a!="Loading"){ 
 			pmeters = 'cid='+cid+'&po_no='+po_no+'&buyer='+buyer+'&Page='+b+'&perpg='+ppg+'&fromdate='+fromdate+'&todate='+todate+'&status='+status;
			}//alert("gg");
			else
			{
...
<h2 class="h2color">View AMC PO to Upload </h2>
...
<th>
<select name="sites" id="sites" onchange="searchById('Listing','1','');"> 
<option value="2">Bulk sites</option>
