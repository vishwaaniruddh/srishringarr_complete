...
<fieldset class="textbox">
           <legend><h1> <img src="ddmenu/Doctor-icon1.png" height="50" width="50">New Doctor</h1> </legend>
                
          <table width="966" id="sub">
            <tr>
              <td width="82" height="62">
            	<label class="name">
              <span>Name:</span></label></td><td width="236">
                <input id="name" name="name" type="text"  >
                 <input id="link" name="link" type="hidden" value="<?php echo $link ?>"  />
                </td>
                
             <td width="76">
                <label class="Email">
              <span> Email:</span></label></td><td width="239">
                <input id="email" name="email" type="text" style="text-transform:lowercase;">
                </td>
...
<label class="city">
            ...
            <tr>
            <td width="74"  height="79">
                <label class="add">
              <span>Address:</span></label></td><td width="231">
                <textarea name="add" cols="27" rows="4" ></textarea>
                </td>
                
                <td>
                <label class="add">
                <span>Remarks:</span></label></td><td>
                <textarea name="rem" cols="27" rows="4" ></textarea>
            </td>
            ...
            <tr>
              ...
              <span>Specialist In:</span></label></td><td>
                <select name="spl" id="spl"  onChange="addThem1()">
				<option value="0">Select</option>
            ...
            <td>
            <a href="home.php" > <button class="submit formbutton" type="button" onClick="<?php if(isset($_GET['link'])=='doc'){ ?> window.close() <?php }else { ?>javascript:location.href = 'home.php';<?php } ?>">Cancel</button></a>
            </td>
