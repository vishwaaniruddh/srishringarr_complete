...
<div class="M_page">
         ...
         <form method="post" class="" action="new_opdme.php" name="opdform" onSubmit="return opdvalidate(this)" enctype="multipart/form-data" style="font-variant:normal">
...
?>Clinical Details:</label> 
  ...
  <select name="findi"  onChange="addThem3()">
      ...
      <br />
          <textarea name="comp" id="comp" cols="50" rows="10" style="resize:none;font-variant:normal; width:800px; height:120px"><?php echo $qrytxtres[0];?></textarea>
      </td>
