...
function advisevalidate(adviseform)
{
	with(adviseform)
	{	
		if(advisename.value=="")
		{
			alert("Please enter Advise");
			return false;
		}
	}
	return true;
...
<!--New Advise-->
          ...
          <form method="post" class="signin" action="new_advise.php" name="adviseform" onSubmit="return advisevalidate(this)">
