...
$query ="select a.srno,a.name,a.city,a.area,a.date,a.reference,b.id from patient a,patient_package b where 1 ";	
...
$renewqry=$query." order by b.expdt DESC";
$query.=" order by b.expdt DESC LIMIT $Page_Start , $Per_Page";
//echo $query;
$result = mysql_query($query) or die(mysql_error());

?>
<link href="All_MiddleBar.css" rel="stylesheet" type="text/css" />
<input type="hidden" id="renewqry" value="<?php echo $renewqry; ?>"/>
...
<tr>
	...
	$dt=mysql_query("select * from patient_package where patientid='$row[0]' and id='".$row['id']."'");
