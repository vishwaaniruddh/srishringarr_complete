...
<body onLoad="searchById('Listing','1')">
   ...
   <td><input type="text" name="mob" id="mob"  onkeyup="searchById('Listing','1');" placeholder="Phone Number"/></td>
    <td><button class="submit formbutton" type="button" onClick="var qry=document.getElementById('renewqry').value;
          window.open('renewprint_print.php?qry='+qry, '_BLANK')">Print</button></td>
    <td></td>
    </tr>
    </table>
