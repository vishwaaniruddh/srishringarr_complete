...
function citywindow(field)
{
 ...
 function addreference(field)
{

  mywindow = window.open("addreference.php?field="+field, "mywindow", "location=400,status=1,scrollbars=1, width=200,height=200,left=350,top=200");
