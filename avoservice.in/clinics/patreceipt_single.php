...
$collect2=mysql_query("select sum(amt) from opd_collection where patientid='".$patientid."' and packid='".$packidme."' and id<='".$id."'");
...
$qrydet=mysql_query("select * from opd_collection where patientid='".$patientid."' and packid='".$packidme."' and id<='".$id."'");
       ...
       {?>
        ...
        <strong><?php echo $detres[7]; ?></strong>
         <?php
            ...
            <td>
                <p>
                    <strong><?php echo $detres[2];?>/-</strong>
                </p>
            </td>
            <td>
                <p>
        ...
        <tr>
            <td  colspan="6" class="td_bg_col" >
                  ...
                  <p><b>  Note :</b></p>
                        ...
                        <p><b>As per the registration form duly accepted &amp; signed by the patient charges paid are non refundable and cannot be adjusted either.</b></p>
                        <p><b>  Consultation &amp; treatment can be availed of only during the membership period.</p>                   
                        <p><b>Cheques are subject to realization.</b></p>                                    
                        <p><b>Subject to Mumbai Jurisdication only.</b></p>
