...
<html>
    ...
    Reference Doctor : <input type="text" name="doc" style="width:250px;" value="<?php echo $row2[1]; ?>"/><br><br>
    <input type="hidden" name="print1"  value="cp"/>
  <b>  Dear Doctor, Respected Doctor, Dear Sir, Respected Sir,</b><br><br>
    ...
    <textarea name="status" rows="20" cols="100"></textarea>
