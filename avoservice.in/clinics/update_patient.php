...
$patref='';
if(isset($_REQUEST['patref']) && $_REQUEST['patref']!='')
$patref=",REFERENCE='".$_REQUEST['patref']."' ";
...
//echo $_POST['packamt']." ".$packro[2]." ".$expdt;
$dis=$packro[2]-$_POST['packamt'];
//echo "select * from patient_package where patientid='".$id."' and status=0";
...
//echo "Update patient_package set patientid='".$id."', packid='".$packro[1]."',startdt='".$stdt2."',expdt='".$expdt."',amt='".$_POST['netamt']."',discount='".$_POST['disamt']."',center='".$center."' where patientid='".$id."' and status=0";
$package=mysql_query("Update patient_package set patientid='".$id."', packid='".$packro[1]."',startdt='".$stdt2."',expdt='".$expdt."',amt='".$_POST['netamt']."',discount='".$_POST['disamt']."',center='".$center."' where patientid='".$id."' and status=0");
}
else
{
...
$package=mysql_query("Insert into patient_package(`patientid`,`packid`,`startdt`,`expdt`,`amt`,`discount`,center) Values('".$id."','".$_POST['pack']."','".$stdt2."','".$expdt."','".$_POST['netamt']."','".$_POST['disamt']."','".$center."')");
}
 ...
 //if($oldcenter==$center)
 if(strcasecmp($oldcenter,$center)==0)
$sql="update patient set name='".$fname."',birth='".$dob."',age='".$age."',sex='".$gender."',telno='".$con12."',mobile='".$con22."',city='".$city."',address='".$address."',ref='".$ref."',email='".$email1."', email2='".$email2."',photo='".$newname."',area='".$center."',type='".$_POST['pattype']."',mobile2='".$_POST['mob2']."',occupation='".$_POST['occu']."',maritalstatus='".$_POST['marit']."'".$patref." where srno='".$id."'";
else
{
 $resultx=mysql_query("select max(no) from patient where area='".$center."'");
 $rowx=mysql_fetch_row($resultx)	;
 $newid=$rowx[0]+1;
 if(strcasecmp($center,'malad')==0)
 $newsr='M-'.$newid;
 else
 $newsr='B-'.$newid;
 $sql="update patient set name='".$fname."',birth='".$dob."',age='".$age."',sex='".$gender."',telno='".$con12."',mobile='".$con22."',city='".$city."',address='".$address."',ref='".$ref."',email='".$email1."', email2='".$email2."',photo='".$newname."',area='".$center."',type='".$_POST['pattype']."',mobile2='".$_POST['mob2']."',occupation='".$_POST['occu']."',maritalstatus='".$_POST['marit']."',no='".$newid."',srno='".$newsr."'".$patref." where srno='".$id."'";
$package=mysql_query("Update patient_package set patientid='".$newsr."' where patientid='".$id."' and status=0 order by id DESC Limit 1");

$package=mysql_query("Update opd_collection set patientid='".$newsr."',center='".$center."' where patientid='".$id."' ");
}
//echo $sql;
...
if($result){
header("location: view_patient1.php?newuser=".$newsr." ");
}
