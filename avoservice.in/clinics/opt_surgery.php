...
$sql1="select * from  patient where srno='$id'";
...
<div id="" class="login-popup">
            ...
            <form method="post" class="signin" action="new_Waitsurgery.php"  name="surgeryform">
                ...
                <p style="color:#ac0404; font-weight:bold; font-size:16px;" align="center">Waiting List For Surgery</p><br>
                
                OPD ID: <input type="text" name="opd_id" value=""  readonly style="background-color:#DCDCDC;width:100px;"/>
                Patient ID: <input type="text" name="patient_id" value="<?php echo $id; ?>"  readonly style="background-color:#DCDCDC;width:100px;"/>
                <table width="456">
                ...
                <td width="317"> <input id="name" name="name" type="text" autocomplete="on"  value="<?php echo $row1[6]; ?>" readonly style="background-color:#DCDCDC;"></td>
                </tr>
...
<!--                <tr>
    ...
    -->            
               ...
               <td><input type="text" name="next_date" id="next_date" onclick="displayDatePicker('next_date');" /></td>
               </tr>
                 <tr>
               <td>Number of Days :</td>
               <td><input type="text" name="days" id="days"  onblur="formshowhide();" onclick="formshowhide();" readonly/></td>
			   </tr>
			   
			   <tr>
			   <td>Room No. : </td>
			   <?php $result17=mysql_query("select * from room where no<>'' order by no ASC"); ?>
			   <td><select name="room" id="room" style="width:300px; height:26px;border:1px #ac0404 solid;">
			   ...
			   <tr>
			   <td>Discharge : </td>
			   <td><input type="text" name="dis" id="dis" onclick="displayDatePicker('dis');" /></td>
               </tr>
                ...
                <input type="hidden" name="appfor" id="appfor" />
