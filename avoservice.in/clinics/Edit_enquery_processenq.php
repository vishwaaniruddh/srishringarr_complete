...
$res=mysql_query("INSERT INTO `enquirystatus` (`id`, `feedback`, `entrydt`, `enteredby`,`nextcall`, `status`,`perid`) VALUES (NULL, '".$_POST['rem']."', Now(), '".$_SESSION['SESS_USER_NAME']."',STR_TO_DATE('".$_POST['nxtdate']."','%d/%m/%Y'), '0','".$_POST['srno']."')");
if(!$res)
