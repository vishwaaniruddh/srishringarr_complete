		  ...
		  /*if(document.getElementById('searchdate').value=="" && document.getElementById('fname22').value=="" && document.getElementById('cont').value=="")
		  {
			...
			var url = 'get_app.php?fname='+s+'&searchdate='+searchdate+'&cont='+cont;
			  ...
			  var cont=document.getElementById('cont').value;//alert(city);
			   ...
			   var center=document.getElementById('center').value;//alert(center);
			  
			  var url = 'get_missapp.php';
			
			var pmeters = 'mode='+Mode+'&Page='+Page+'&name='+name+'&searchdate='+searchdate+'&cont='+cont+'&hos='+hos+'&ref='+ref+'&edate='+edate+'&center='+center;
...
function add_update(cnt,ld,srno)
{
...
xmlhttp.open("GET","add_misapp_update.php?rem="+rem+"&id="+ld+"&srno="+srno,true);
xmlhttp.send();
...
<legend> <h1><img src="ddmenu/apointment.png" style="width:50px; height:50px;" />Missed Appointments</h1></legend>
...
<table>
   <tr>
   <td><input type="text"  name="searchdate" id="searchdate" onBlur="searchById('Listing','1');"  placeholder="From Date" onClick="displayDatePicker('searchdate');" value="<?php  if(isset($_GET['searchdate'])){ echo $_GET['searchdate']; } ?>"/></td>
   <td><input type="text"  name="edate" id="edate" onBlur="searchById('Listing','1');"  placeholder="To Date" onClick="displayDatePicker('edate');"/></td>
   ...
   <td>
	<select name="center" id="center" onchange="searchById('Listing','1');">
   ...
   <td><button class="submit formbutton" type="button" onClick="var qry=document.getElementById('misappqry').value;
          window.open('missing_app_print.php?qry='+qry, '_BLANK')">Print</button></td>
   </tr>
</table>
