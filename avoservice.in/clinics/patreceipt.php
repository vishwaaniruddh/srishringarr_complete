...
$collect2=mysql_query("select sum(amt) from opd_collection where patientid='".$patientid."'and date<='".$collectro[3]."'and packid='".$packidme."'");
...
$qrydet=mysql_query("select * from opd_collection where patientid='".$patientid."'and date<='".$collectro[3]."' and packid='".$packidme."'");
