...
<table width="1102"  border="1" id="results" cellpadding="4" cellspacing="0" style="text-transform:uppercase;font-size:13px;">
         ...
         <tr>
          ...
          <td style="color:#ac0404; font-size:12px; font-weight:bold;">Phone</td>
         </tr>
...
*/
if($_REQUEST['diag']!=""){
$query ="select a.SRNO,a.name,a.city,a.area,a.date,a.reference,b.diagnosis,a.MOBILE,a.no from patient a,opd b where ";	}

else if($_REQUEST['ref']!=""){
$query ="select a.SRNO,a.name,a.city,a.area,a.date,a.reference,c.name,a.MOBILE,a.no from patient a,doctor c where ";	}

else
$query ="select a.SRNO,a.name,a.city,a.area,a.date,a.reference,a.MOBILE,a.no from patient a where  ";
