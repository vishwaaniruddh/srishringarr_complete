...
<tr><td width="712">
<input type="button" style="width:100px; height:30px; color:#ac0404;" <?php if($link=='detail') { ?>onClick="javascript:location.href = '../patient_detail.php?id=<?php echo $id; ?>';"<?php } if($link=='detail1') { ?>onClick="javascript:location.href = '../view_patient.php';" <?php } else{  ?>onClick="javascript:location.href = '../view_opd.php';"<?php } ?> value="Go Back" />
...
?>
		...
		while($opd3=mysql_fetch_row($opd2)){
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             ...
             <div style="background-color:#FC9;"><p><b>Complaints : </b> <pre><font color="#000000">  <?php echo $opd3[29]; ?></font></pre></p></div><br/>
...
$tak= explode(',',$opd3[92]);
$dos = explode(',',$opd3[80]);
$cmnt=explode(',',$opd3[93]);
?>

<?php
for($i = 0; $i < count($med); $i++){ 
?>         <br><br>
             <table  bgcolor="#FFFF66" width="100%"><tr>
             <td><p>Medicine Name:&nbsp;&nbsp;&nbsp;<b><?php echo $med[$i]; ?> </b></p></td></tr>
              
            <tr><td><p>Potency:&nbsp;&nbsp;&nbsp;<b><?php echo $tak[$i]; ?></b></p></td></tr>
              
           <tr> <td><p>Repetition:&nbsp;&nbsp;&nbsp;<b><?php echo $dos[$i]; ?> </b> </p></td></tr>								
              
             <tr><td><p>Comment:&nbsp;&nbsp;&nbsp;<b><?php echo $cmnt[$i]; ?></b></p></td></tr>
             </table><br>
