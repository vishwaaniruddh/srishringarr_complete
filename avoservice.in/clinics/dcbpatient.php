...
<body onLoad="searchById('Listing','1')">
   ...
   <fieldset class="textbox">
    ...
    <td><input type="text"  name="pdate" id="pdate"  onBlur="searchById('Listing','1');" placeholder="From Date" onClick="displayDatePicker('pdate');" value="<?php  echo date('d/m/Y',strtotime('-1 month')); ?>"/></td>
    <td><input type="text"  name="todate" id="todate"  onBlur="searchById('Listing','1');" placeholder="To Date" value="<?php echo date('d/m/Y'); ?>" onClick="displayDatePicker('todate');"/></td>
   ...
   <td><input type="text" name="mob" id="mob"  onkeyup="searchById('Listing','1');" placeholder="Phone Number"/></td>
    <td><button class="submit formbutton" type="button" onClick="var qry=document.getElementById('dcbqry').value;
          window.open('dcbprint.php?qry='+qry, '_BLANK')">Print</button></td>
    <td></td>
    </tr>
    </table>
