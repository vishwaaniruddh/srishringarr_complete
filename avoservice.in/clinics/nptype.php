...
<script type="text/javascript">
        function init(){
            window.setInterval(autoSave,4000);                  // 8 seconds
        }
        function autoSave(){
...
xmlhttp.onreadystatechange=function()
 ...
 alert("get_nextappdt.php?val="+dt);
xmlhttp.open("GET","get_nextappdt.php?val="+dt+"&nxtdt="+nextdt,true);
xmlhttp.send();
...
<script>
 ...
 function personPrescription(id,date)
    {
	  var xmlhttp;
if (window.XMLHttpRequest)
  {// code for IE7+, Firefox, Chrome, Opera, Safari
...
xmlhttp.open("GET","get_datepresc.php?pid="+id+"&date="+date,true)
xmlhttp.send();
...
<div class="M_page">
         ...
         <form method="post" class="" action="processnptype.php" name="opdform" onSubmit="return opdvalidate(this)" enctype="multipart/form-data" style="font-variant:normal">
...
?>
  ...
  <tr>
    <td><label> History: </label>
      ...
      <br /><br /><br />
       <tr><td colspan="3">   <textarea name="saved_text" id="saved_text" cols="50" rows="10" style="resize:;font-variant:inherit; color:#333; background-color:#F4FBE1; font-size:17px; font-weight:bold; width:1000px; height:420px; padding:30px;"><?php echo $saved_text;?></textarea>
      </td>
...
&nbsp;				</div>
				...
				{
				?>
                   <option value="<?php echo $cenro[0]; ?>"><?php echo $cenro[0];  ?></option>
                   <?php
