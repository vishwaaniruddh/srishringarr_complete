		  ...
		  /*if(document.getElementById('searchdate').value=="" && document.getElementById('fname22').value=="" && document.getElementById('cont').value=="")
		  {
			...
			var url = 'get_app.php?fname='+s+'&searchdate='+searchdate+'&cont='+cont;
			  ...
			  var cont=document.getElementById('cont').value;//alert(city);
			   ...
			   var inactivetype=document.getElementById('inactivetype').value;//alert(inactivetype);
			  
			  var url = 'get_inactive_patient.php';
			
			var pmeters = 'mode='+Mode+'&Page='+Page+'&name='+name+'&cont='+cont+'&hos='+hos+'&ref='+ref+'&inactivetype='+inactivetype+'&sname='+sname;
...
// alert(response);
				  ...
				  document.getElementById("numrow").innerHTML = "<h2>Total Records : "+st[1]+"</h2>";
			  }
		}
  }
...
function printpage()
{
	...
	var ref=document.getElementById('ref').value;//alert(city);
	var inactivetype=document.getElementById('inactivetype').value;//alert(inactivetype);
	var pmeters = 'name='+name+'&cont='+cont+'&hos='+hos+'&ref='+ref+'&inactivetype='+inactivetype+'&sname='+sname;
        window.open('print_inactive_patient.php?'+pmeters , '_BLANK');
}
// onLoad="searchById('Listing','1')"
</script>
...
<legend> <h1><img src="ddmenu/apointment.png" style="width:50px; height:50px;" />Incative Patients</h1></legend>
...
<table>
   ...
   <td><input type="text"  name="cont" id="cont" placeholder="Contact"/></td>
   <td><input type="text"  name="ref" id="ref" placeholder="Reference"/></td>
   <td><input type="text"  name="hos" id="hos" placeholder="Appointment Type"/></td>
    <td>
	<select id="inactivetype">
		<!--<option value="">-select Type-</option>-->
		<option value="to">Term Over</option>
		<option value="tr">Term Remaining</option>
		<option value="nip">NOT IN PACKAGE</option>
	</select>
    </td>
   <td><button class="submit formbutton" type="button" onClick="searchById('Listing','1');">Search</button></td>
   <td><button class="submit formbutton" type="button" onClick="printpage();">Print</button></td>
   </tr>
</table>
