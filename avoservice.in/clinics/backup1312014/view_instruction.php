...
if(confirm("Are you sure you want to delete this entry?"))
  {
    document.location="delete_instruction.php?id="+id;
  }
}
</script>
...
<?php 
include('config.php');
$result66 = mysql_query("select * from ins1 where name<>'' order by name ASC");
...
?>
    ...
    <td> <a href='edit_instruction.php?id=<?php echo $row66[1]; ?>'> Edit </a></td>
...
<td width="338">
<form method="post" class="signin" action="new_instruction.php"  >
                <fieldset class="textbox">
                <p>Add New Instruction</p><br />
