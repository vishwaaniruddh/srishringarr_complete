...
if(confirm("Are you sure you want to delete this entry?"))
  {
    document.location="delete_clinicaldetail.php?id="+id;
  }
}
</script>
...
<?php 
include('config.php');
$result66 = mysql_query("select * from clinic where name<>'' order by name ASC");
...
?>
    ...
    <td> <a href='edit_clinicaldetail.php?id=<?php echo $row66[1]; ?>'> Edit </a></td>
...
<td width="338">
<form method="post" class="signin" action="new_clinicaldetail.php"  >
                <fieldset class="textbox">
                <p>Add New Clinical Detail</p>
