...
$id=$id3[1];*/
	...
	$pat=mysql_query("select * from patient where srno='".$id2."'");
	$patro=mysql_fetch_row($pat);
	if($patro[1]<'2013-11-13')
	{
		//echo $patro[19];
		
        //"wordfile/"<?php echo $patro[19]."/".$id2.".html";
       echo "<a href='wordfile/".$patro[19]."/".$id2.".html' target='_new'>View Word File</a>";
      //  <a href="wordfile/example.php?patid=<?php echo $id2; &br=<?php echo $patro[19]; " target="_new">View Word File</a>
