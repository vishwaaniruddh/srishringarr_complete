...
if(confirm("Are you sure you want to delete this entry?"))
  {
    document.location="delete_opdcollheads.php?id="+id;
  }
}
</script>
...
<?php 
include('config.php');
$result66 = mysql_query("select * from opdmast where name<>'' order by name ASC");

?>


    
                <h2>View OPD Collection Heads</h2>
                
      <table width="913" style="font-size:13px; text-transform:uppercase;" class="se"><tr><td width="563" height="154">                   
...
?>
    ...
    <td> <a href='edit_opdcollheads.php?id=<?php echo $row66[2]; ?>'> Edit </a></td>
    <td> <a href="javascript:confirm_deleteaction(<?php echo $row66[2]; ?>);"> Delete </a></td>
    </tr>
    <?php } ?>
...
<td width="338">
<form method="post" class="signin" action="new_opdcollheads.php"  >
                <fieldset class="textbox">
                <p>Add New OPD Collection Heads</p>
                
            	<label class="name">
                <span>OPD Collection Heads :</span>
