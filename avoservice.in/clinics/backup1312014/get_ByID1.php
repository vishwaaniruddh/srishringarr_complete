...
<td > <a href="patient_detail.php?id=<?php echo $row[0]; ?>"> Details </a> / <a href="#" onClick="window.open('opdpayment.php?appid=<?php echo '';  ?>&amt=<?php //echo $bal; ?>&pid=<?php echo $row[0]; ?>','opdpay','width=600,height=300,left=200,top=100')" style="text-decoration:none; color:#099">Make Payment</a></td>
