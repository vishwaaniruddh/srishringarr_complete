...
function confirm_deletephygoal(id)
{
if(confirm("Are you sure you want to delete this entry?"))
  {
    document.location="delete_phygoal.php?id="+id;
  }
}
</script>
...
<?php 
include('config.php');
$result66 = mysql_query("select * from goals where name<>'' order by name ASC");

?>
     
               <h2>View Physiotherapy Goals </h2>
             
                
      <table width="913" class="se"><tr><td width="563" height="154" style="font-size:13px; text-transform:uppercase;">                   
...
?>
    ...
    <td> <a href='edit_phygoal.php?id=<?php echo $row66[1]; ?>'> Edit </a></td>
    <td> <a href="javascript:confirm_deletephygoal(<?php echo $row66[1]; ?>);"> Delete </a></td>
    </tr>
    <?php } ?>
...
<td width="338">
<form method="post" class="signin" action="new_phygoal.php"  >
                <fieldset class="textbox">
                <p>Add New Physiotherapy Goal</p>
