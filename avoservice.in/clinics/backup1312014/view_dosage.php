...
if(confirm("Are you sure you want to delete this entry?"))
  {
    document.location="delete_dosage.php?id="+id;
  }
}
</script>
...
<?php 
include('config.php');
$result66 = mysql_query("select * from medicine where name<>'' order by name ASC");
...
?>
    ...
    <td> <a href='edit_dosage.php?id=<?php echo $row66[5]; ?>'> Edit </a></td>
...
<td width="338">
<form method="post" class="signin" action="new_dosage.php"  >
