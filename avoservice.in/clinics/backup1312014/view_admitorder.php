...
function confirm_deleteadmitorder(id)
{
if(confirm("Are you sure you want to delete this entry?"))
  {
    document.location="delete_admitorder.php?id="+id;
  }
}
</script>
...
<?php 
include('config.php');
$result66 = mysql_query("select * from orders where name<>'' order by name ASC");

?>


      <h2>View Admit Orders </h2>
               
                
      <table width="913"  class="se">
      <tr><td width="563" height="154" style="font-size:13px; text-transform:uppercase;">                   
...
?>
    ...
    <td> <a href='edit_admitorder.php?id=<?php echo $row66[1]; ?>'> Edit </a></td>
    <td> <a href="javascript:confirm_deleteadmitorder(<?php echo $row66[1]; ?>);"> Delete </a></td>
    </tr>
    <?php } ?>
...
<td width="338">
<form method="post" class="signin" action="new_admitorder.php"  >
                <fieldset class="textbox">
                <p>Add New Admit Order </p>
