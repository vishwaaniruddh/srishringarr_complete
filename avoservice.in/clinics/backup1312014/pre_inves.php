...
<div id="" class="login-popup">
         ...
         <form method="post" class="signin" action="process_invest.php" name="opdform" onSubmit="return opdvalidate(this)" enctype="multipart/form-data">
              ...
              <legend>  <h1>Pre-Investigation</h1></legend>
...
?>
              ...
              <button class="submit formbutton" type="button" onClick="javascript:location.href = 'opd.php?id=<?php echo $id; ?>&aid=<?php echo $aid; ?>';">Cancel</button>
