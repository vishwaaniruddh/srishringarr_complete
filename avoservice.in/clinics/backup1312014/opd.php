...
?>Clinical Details:</label> 
  ...
  <select name="findi"  onChange="addThem3()">
      ...
      <br />
          <textarea name="comp" id="comp" cols="50" rows="10" style="resize:none;font-variant:normal; width:800px; height:120px"></textarea>
      </td>
...
<option value="5WEEKS">5WEEKS</option> 
<option value="pls make it">pls make it</option> 
<option value="till">till</option>
<option value="52weeks">52weeks</option> 
...
<option value="12BTLS">12BTLS</option>
                 ...
                 <td><input type="text" name="cmnt[]" id="cmnt[]" style="width:140px;" class="cmnt[]"/></td>
                </tr>
