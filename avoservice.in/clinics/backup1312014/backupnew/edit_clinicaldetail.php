...
<style>
	...
	<div id="site_title_bar">
       ...
       <h2>Edit Clinical Details</h2>
          ...
          <form method="post" class="signin" action="update_clinicaldetail.php" >
                <fieldset>
                ...
                <button class="submit formbutton" type="button" onClick="javascript:location.href = 'view_clinicaldetail.php';">Cancel</button>
