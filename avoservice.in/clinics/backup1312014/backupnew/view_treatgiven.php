...
if(confirm("Are you sure you want to delete this entry?"))
  {
    document.location="delete_treatgiven.php?id="+id;
  }
}
</script>
...
<?php 
include('config.php');
$result66 = mysql_query("select * from treat1 where name<>'' order by name ASC");

?>


                <h2>View Treatment Given</h2>
                
      <table width="913" class="se"> 
      <tr><td width="563" height="154">                   
...
?>
    ...
    <td> <a href='edit_treatgiven.php?id=<?php echo $row66[1]; ?>'> Edit </a></td>
...
<td width="338">
<form method="post" class="signin" action="new_treatgiven.php"  >
                <fieldset class="textbox">
                <p>Add New Treatment Given</p>
