...
<!--HEADER STARTE HERE-->
  ...
  <input type="file" name="photo" id="photo" style="background:none; border:none;" onchange="show_pic()"/>
               ...
               <!--till here-->
                  <tr>
                    <td width="128" height="33"><label class="fname"> Full Name: </label></td>
                    <td width="348"><input id="fname" name="fname" type="text" />
                    </td>
...
age +=-2 ; 	     //calculating age 
           document.getElementById("age").value= age;
                  ...
                  <tr>
                    ...
                    <td> 
                         <table> <tr> <td width="68"><label> Male:</label></td> <td width="236"><input name="gen" id="gen" type="radio" value="Male" /></td></tr>
               ...
               <div class="suggestionsBox" id="citysuggestions" style="display: none; position:absolute; left:280px; z-index:10">
...
?>
               ...
               <div class="suggestionsBox" id="centersuggestions" style="display: none; position:absolute; left:280px; z-index:10">
				<img src="autocomplete/upArrow.png" style="position: relative; top: -12px; left: 30px;" alt="upArrow" />
                ...
                <div id="package" style="display:none">
                  <table width="956">
                    <tr><td width="125"><label>Select Package:</label>&nbsp;&nbsp;<a href="#" onclick="packagewindow('pack');"><img src="images/add.png" height="15px" width="15px" title="Add New Package" /></a></td>
                    <td width="378"><select name="pack" id="pack" onchange="getpackamt(this.id,'packamt');"><option value="">-select Package-</option><?php 
				  $pack=mysql_query("select * from package where status=0 order by amt ASC ");
				  while($packro=mysql_fetch_array($pack))
				  {
				  ?>
                  <option value="<?php echo $packro[1]; ?>"><?php echo $packro[1]; ?></option>
                  <?php
				  }
				   ?></select></td><td width="91"><label>Package Start Date:</label></td>
                  <td width="342"><input type="text" name="stdt" id="stdt" value="<?php echo date("d/m/Y"); ?>"  onClick="displayDatePicker('stdt');"/></td></tr>
			...
			<!--	<?php
               ...
               <div class="suggestionsBox" id="ngsuggestions" style="display: none; position:absolute; left:370px; z-index:10">
				...
				<td><button class="submit formbutton" type="submit" style="width:180px;">Save & Clinical Info</button> </td> 
                </tr>   
                </table>
