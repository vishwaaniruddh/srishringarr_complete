...
<legend><h1>OPD COLLECTION</h1></legend>
   <table >
   <tr>
   <th><input type="text"  name="searchdate" id="searchdate" onBlur="searchById('Listing','1');"  placeholder="Date" onClick="displayDatePicker('searchdate');" value="<?php  if(isset($_GET['searchdate'])){ echo $_GET['searchdate']; } ?>"/></td>
