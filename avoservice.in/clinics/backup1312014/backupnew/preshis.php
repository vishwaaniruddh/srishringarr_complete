...
<fieldset class="textbox">
   <legend> <h1><img src="ddmenu/img1.png" height="50" width="50">Patient's Records</h1></legend>
    ...
    <td><input type="text"  name="area" id="area"  onkeyup="searchById('Listing','1');" placeholder="Center"/></td>
     <!--<td><input type="text" style="border:none; width:65px;" name="ref" id="ref"  onkeyup="searchById('Listing','1');" placeholder="Reference"/></td>-->
