...
////alert("get_timeslot1.php?hos="+str+"&appdate="+str1);
 xmlHttp.open("GET", "get_time1ajax.php?hos="+hos+"&appdate="+dt+"&ad="+id, true);
...
function MakeRequest1(dt,id,hosp)
...
////alert("get_timeslot1.php?hos="+str+"&appdate="+str1);
 xmlHttp.open("GET", "get_timeslot1.php?hos="+hos+"&appdate="+dt+"&ad="+id, true);
...
<div id="calendar"><?php include("planner/index.php"); ?></div></td>
<td valign="top" id="editapp" style="display:none"><div>
<form name="editapp" method="post" action="update_appajax.php">
<input type="hidden" name="id" id="id"><input type="hidden" name="appdate" id="appdate">
Remarks : <input type="text" name="rem" id="rem">
<div id="detail1"></div><div id="detail"></div>
...
<input type="submit" name="cumedt" value="Update" class="submit formbutton">
 ...
 <td><input type="text"  name="ref" id="ref"  onkeyup="searchById('Listing','1');" placeholder="Reference"/></td>
   <td><input type="text"  name="hos" id="hos"  onkeyup="searchById('Listing','1');" placeholder="Hospital"/></td>
   </tr>
   </table>
