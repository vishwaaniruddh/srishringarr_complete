...
//echo "SELECT * FROM  `package` WHERE  `desc` LIKE  '".$_POST['pack']."'";
$pack=mysql_query("SELECT * 
FROM  `package` 
WHERE  `desc` LIKE  '".$_POST['pack']."'");
...
$package=mysql_query("Insert into patient_package(`patientid`,`packid`,`startdt`,`expdt`,`amt`,`discount`,`center`) Values('".$newsrno."','".$_POST['pack']."','".$stdt2."','".$expdt."','".$_POST['packamt']."','".$dis."','".$center."')");
if(!$package)
echo "failed".mysql_error();
}
if($result)
