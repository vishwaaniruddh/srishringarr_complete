...
$sql="select * from  attend where date='$id'";
$result = mysql_query($sql);
$row = mysql_fetch_row($result);


$sql1="select name from staff where staff_id='$row[2]'";
...
<div id="" class="login-popup">
          ...
          <form method="post" class="signin" action="update_attendence.php"  name="attform">
                ...
                <button class="submit formbutton" type="button" onClick="javascript:location.href = 'viewattendence.php';">Cancel</button>
