...
$get=mysql_query("select * from patient_package where patientid='".$id."' and startdt='".$stdt2."'  and status=0");
...
$package=mysql_query("Update patient_package set packid='".$_POST['pack']."',startdt='".$stdt2."',expdt='".$expdt."',amt='".$_POST['packamt']."',discount='".$dis."' where patientid='".$id."' and status=0 order by id DESC Limit 1");
}
else
{
...
$package=mysql_query("Insert into patient_package(`patientid`,`packid`,`startdt`,`expdt`,`amt`,`discount`,`center`) Values('".$id."','".$_POST['pack']."','".$stdt2."','".$expdt."','".$_POST['packamt']."','".$dis."','".$center."')");
}
}
...
$sql="update patient set name='".$fname."',birth='".$dob."',age='".$age."',sex='".$gender."',telno='".$con12."',mobile='".$con22."',city='".$city."',address='".$address."',ref='".$ref."',email='".$email1."', email2='".$email2."',photo='".$newname."',area='".$center."',type='".$_POST['pattype']."',mobile2='".$_POST['mob2']."',occupation='".$_POST['occu']."',maritalstatus='".$_POST['marit']."' where srno='".$id."'";
