...
$sql1="select staff_id,name from staff where staff_id='$row[2]'";
...
<div id="" class="login-popup">
          ...
          <form method="post" class="signin" action="update_leave.php" onSubmit="return appvalidate(this)" name="appform">
				...
				<option value="<?php echo $row1[0]; ?>"><?php echo $row1[1]; ?></option>
				 <?php
				 $sql2="select staff_id,name from staff where name<>''";
                ...
                <a href="home.php" > <button class="submit formbutton" type="button" onClick="javascript:location.href = 'view_leavereport.php';">Cancel</button></a>
