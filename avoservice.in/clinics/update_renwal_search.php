...
if($_REQUEST['type_view']=='r' || $_REQUEST['type_view']=='f' || $_REQUEST['type_view']=='o')
$query ="select a.srno,a.name,b.rem,b.entrdt from patient a,rem_update b where b.srno=a.srno ";	
if($_REQUEST['type_view']=='e')
$query ="select a.trackid,a.name,b.rem,b.entrdt from enquiryperson a,rem_update b where b.srno=a.trackid ";
/*
...
if(isset($_REQUEST['type_view']) && ($_REQUEST['type_view']!=''))
{
$query.=" and b.type like '".$_REQUEST['type_view']."' ";
}
...
$query.=" order by b.entrdt DESC LIMIT $Page_Start , $Per_Page";
//echo $query;
$result = mysql_query($query) or die(mysql_error());
