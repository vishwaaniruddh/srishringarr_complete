...
if(confirm("Are you sure you want to delete this entry?"))
  {
    document.location="delete_invest.php?id="+id;
  }
}
</script>
...
<?php 
include('config.php');
$result66 = mysql_query("select * from investi where name<>'' order by name ASC");
...
?>
                ...
                <h2>View New X-Ray & Investigation</h2>
...
?>
    ...
    <td> <a href='edit_invest.php?id=<?php echo $row66[0]; ?>'> Edit </a></td>
...
<td width="338">
<form method="post" class="signin" action="new_invest.php"  >
                <fieldset class="textbox">
                <p>Add New X-Ray &amp; Investigation</p>
                
            	<label class="name">
                <span>New X-Ray & Investigation :</span>
