...
//echo "select * from opd_collection where patientid='".$patientid."'";
$qrydet=mysql_query("select * from opd_collection where patientid='".$patientid."'");
...
table{border:px solid #F00; width:75%;; margin-left:auto; margin-right:auto; border-collapse:collapse;}
...
<table>
    <thead>
     <tr>
     <th colspan="6"><h2>DR. RAI'S HEALTH CARE PVT. LTD.</h2></th>
     </tr>
     </thead>
     <tbody>
     <tr>
     ...
     <?php
        ...
        <tr>
            <td colspan="4" class="td_bg_col" >
                <p>
                    <strong>Bill No. :<?php echo $row2[0];?></strong><br>
        ...
        <tr>
         <tr>
           <td colspan="6" class="td_bg_col" >
                    ...
                    <p><strong>Ailment/Problems : <?php echo $prob; ?></strong></p>
