...
function confirm_deletehosp(id)
{
if(confirm("Are you sure you want to delete this entry?"))
  {
    document.location="delete_hospital.php?id="+id;
  }
}
</script>
...
<?php 
include('config.php');
$result66 = mysql_query("select * from hospital order by name ASC");
...
?>
    ...
    <td> <a href='edit_hospital.php?id=<?php echo $row66[7]; ?>'> Edit </a></td>
    <td> <a href="javascript:confirm_deletehosp(<?php echo $row66[7]; ?>);"> Delete </a></td>
    </tr>
    <?php } ?>
...
<td width="338">
<form method="post" class="signin" action="new_hospital.php"  >
                <fieldset class="textbox">
                <p>Add New Hospitals</p>
                
            	<label class="name">
                <span>Hospital Name :</span>
                <textarea id="hosname" name="hosname" rows="3" cols="35" style="resize:none;border:1px #ac0404 solid;"></textarea>
                </label>
