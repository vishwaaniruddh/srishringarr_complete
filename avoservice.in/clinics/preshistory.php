...
<tr>
<th>Patient Name :</th>
<th><b><?php echo $row[8]; ?></th><br />

<th>ID :</th>
<th><b><?php echo $row[9]; ?></th><br />

<th><?php echo "Date :".$row[6]; ?></th>
<th id="td<?php echo $row[11]; ?>"><a href="#" onClick="printDiv('<?php echo $row[11]; ?>');">Print</a></th>
...
<th><b>Medicine</b></th>
<th><b>Potency</b></th>
<th><b>Duration/week</b></th>
<th><b>Repetition</b></th>
<th><b>Comment</b></th>
</tr>
</tbody>
<?php  
...
<tr>
<td><?php echo $i+1; ?></td>
<td><?php echo $med[$i]; ?></td>
<td><?php echo $pot[$i]; ?></td>
<td><?php echo $days[$i]; ?> weeks</td>
