        ...
        <form method="post" class="signin" action="processapp.php" onSubmit="return appvalidate(this)" name="appform" >
                ...
                <input type="hidden" id="sl" name="sl"/> 
                  ...
                  <tr>
                   ...
                   <td width="445"> <input id="appdate" name="appdate" type="text" onBlur="MakeRequest();" style="width:100px;" value="<?php echo date('d/m/Y'); ?>"><button name="appbutton" class="submit formbutton"   value="" id="se" onClick="displayDatePicker('appdate');" >SelectDate</button>
