...
<legend> <h1><img src="ddmenu/red-cross1.png" height="50" width="50">Hospital Summary</h1> </legend>
          <table width="302">
          <tr>
          
          <td width="157" style="border:none;"><input type="text"  name="hos" id="hos" placeholder="Search By Hospital" onKeyUp="searchById('Listing','1');"/></td>
          ...
          <td width="133" style="border:none;" valign="top"><button class="submit formbutton" type="button" onClick="var n=document.getElementById('hos').value;
         var adate=document.getElementById('adate').value;
          window.open('hos_print.php?hos='+n+'&adate='+adate, '_BLANK')">Print</button></td>
          </tr>
          </table>
