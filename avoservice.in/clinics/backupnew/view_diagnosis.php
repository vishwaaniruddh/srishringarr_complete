...
if(confirm("Are you sure you want to delete this entry?"))
  {
    document.location="delete_diagnosis.php?id="+id;
  }
}
</script>
...
<?php 
include('config.php');
$result66 = mysql_query("select * from diag where name<>'' order by name ASC");
...
?>
    ...
    <td> <a href='edit_diagnosis.php?id=<?php echo $row66[1]; ?>'> Edit </a></td>
...
<td width="338">
<form method="post" class="signin" action="new_diagnosis.php"  >
                <fieldset class="textbox">
                <p>Add New Diagnosis</p><br />
