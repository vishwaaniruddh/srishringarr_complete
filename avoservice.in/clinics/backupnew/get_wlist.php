...
$query ="select a.w_real_id,a.p_id,a.wdate,a.days,a.waiting,b.no,b.name,b.mobile,b.city,b.telno,a.adm_date,a.room_type,a.type from surgery_wait a,patient b where a.p_id=b.srno and a.waiting='No' and ";
...
<table class="results">
         ...
         <td style="color:#ac0404; font-size:12px; font-weight:bold;">Room No.</td>    
		        <td style="color:#ac0404; font-size:12px; font-weight:bold;">N/F.</td>  
          <td style="color:#ac0404; font-size:12px; font-weight:bold;">Admission</td>
...
?>  
    ...
    <td align="center"><input name="code4[]" id="code4[]" type="checkbox" value="<?php //echo $row[0]; ?>" onclick="window.location.href='admission.php?id=<?php echo $row[1]; ?>'" /> </td>
