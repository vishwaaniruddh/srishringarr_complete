...
$id=$_GET['id'];
$sql="select * from action where action_id='$id'";
...
<style>
	...
	<div id="site_title_bar">
       ...
       <h2>Edit Action Plan</h2>
          ...
          <form method="post" class="signin" action="update_action.php" >
                <fieldset>
                ...
                <button class="submit formbutton" type="button" onClick="javascript:location.href = 'viewaction.php';">Cancel</button>
