...
$app="insert into `appoint`(no,hospital,app_date,block_id,slot,app_real_id,app_id,new_old,center) values('$patid','$hospital',STR_TO_DATE('".$nxtdate."','%d/%m/%Y'),'$block_id','$slot','$newsrnonx','$newpatidnx','O','$hos1')";
