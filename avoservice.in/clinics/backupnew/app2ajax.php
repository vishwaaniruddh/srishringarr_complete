        ...
        <form method="post" class="signin" action="processapp2ajax.php" onSubmit="return appvalidate(this)" name="appform" autocomplte="false" >
                ...
                <input type="hidden" id="sl" name="sl"/> 
                  ...
                  <tr>
                   ...
                   <td width="483"> <input id="appdate" name="appdate" type="text" onBlur="MakeRequest();" style="width:100px;" value="<?php echo date('d/m/Y'); ?>">
                <input name="appbutton" type="button"  value="select" id="se" onClick="displayDatePicker('appdate');"/>
                </td>
