...
?>
                ...
                <?php } ?>
                  ...
                  <td><input type="text"  name="email2"  id="email2" value="<?php echo $row[41]." ".$row[0]; ?>" /></td>
                  </tr>
               ...
               <select name="phys" id="phys" style="background:#fff;border:1px solid #ac0404;width:180px;height:27px;text-transform:uppercase" onchange="physs();">
                ...
                <tr>
                <td>
                <input id="id" name="id" type="hidden" value="<?php echo $id; ?>"><input type="submit" class="submit formbutton" name="submit" value="Save & Exit">
                </td>
