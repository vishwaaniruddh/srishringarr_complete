...
<?php 
include('config.php');
$result66 = mysql_query("select * from action where name<>'' order by name ASC");
...
?>
    ...
    <td> <a href='edit_action.php?id=<?php echo $row66[1]; ?>'> Edit </a></td>
...
<td width="338">
<form method="post" class="signin" action="new_action.php"  >
                <fieldset class="textbox">
                <p>Add New Action Plan</p>
