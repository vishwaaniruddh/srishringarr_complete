...
$id=$_GET['id'];
$sql="select * from treat1 where treat_id='$id'";
...
<style>
	...
	<div id="site_title_bar">
        ...
        <h2>Edit Treatment Given</h2>
          <form method="post" class="signin" action="update_treatgiven.php" >
                <fieldset>
                ...
                <button class="submit formbutton" type="button" onClick="javascript:location.href = 'view_treatgiven.php';">Cancel</button>
