            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card m-b-30">
                        ...
                        <form action="excelLead_process.php" method="post" enctype="multipart/form-data" onSubmit="return validate(this)" name="form">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="form-group">
                                ...
                                <b> <a href="Excel/lead.xls" download>Download format </a></b>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="inputAddress">Lead Source</label>
                                <select class="form-control" name="LeadSource" id="LeadSource" required>
                        ...
                        <div class="form-group">
                                <label for="inputAddress">Lead Delegate</label>
