...
<h2>Generate Service Call</h2>

<form action="process_sercall.php" method="post" name="form" onSubmit="return validate1(this)">
...
<tr><td>Client Docket number:</td>

<td><select class="form-control" id="docket"  name="docket" required>
...
<<td><label>Problems:</label></td>
        <td><select class="form-control" id="prob"  name="prob" required>
                     <option value="">Select</option>
...
<td><input type="text" name="cname" id="cname" maxlength="20"  required/></td>
</tr>

<tr>
<td height="35">Contact No.: </td>
<td><input type="text" name="cphone" id="cphone"  onkeypress="return isNumber(event)" maxlength="10"  required/></td>
</tr>
