...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
		...
		var accnt=document.getElementById('acc').value;
			...
			var url = 'search_areahead.php'; 
	
		    var pmeters="";
			
			if(a!="Loading"){ 
			 pmeters = 'Page='+b+"&name="+name+'&perpg='+ppg+"&email="+email+'&number='+con+'&acc='+accnt;
			// alert(pmeters);
			}
			else
			{
				 pmeters = "Page="+b+'&perpg='+ppg+'&acc='+accnt;
			}
			//alert(pmeters);
...
{
	if (confirm("Are you sure you want to Activate this Id?"))
	{
		document.location="activate_cityhead.php?id="+id;
	}
...
<table>
<th><select name="acc" id="acc" onchange="searchById('Listing','1','');">
...
<option value="0">Deleted Ids</option>
<? } ?>
</select></th>
