...
$result= mysqli_query($con1,"INSERT INTO  atm(atm_id,bank_name,area,pincode,city,state,address,ref_id,po,cust_id,servicetype,podate,state1,cat)  VALUES('$atm','$bank','$area','$pincode','$city','$state','$addr','".$ref."','$pordr','$cust','".$service."',STR_TO_DATE('".$dateget."','%d/%m/%Y'),'$state','$cat')");
 $id=mysqli_insert_id();
 
if($result){
	echo "INSERT INTO `instdetails`(`atm_id`, `bomno`, `bomdate`, `indentno`, `indentdate`, `vat`, `ed`, `dono`, `freight`) VALUES ('".$id."','".$bomno."','".$bomdate."','".$indentno."','".$indentdate."','".$vat."','".$ed."','".$dono."','".$freight."')";
		$qry=mysqli_query($con1,"INSERT INTO `instdetails`(`atm_id`, `bomno`, `bomdate`, `indentno`, `indentdate`, `vat`, `ed`, `dono`, `freight`) VALUES ('".$id."','".$bomno."','".$bomdate."','".$indentno."','".$indentdate."','".$vat."','".$ed."','".$dono."','".$freight."')");
}
	if($upsno>0)
	{
	...
	//echo "insert into `site_assets`(cust_id,po,assets_name,assets_spec,valid,quantity,atmid)values('$cust','$pordr','Battery','".$btry."','".$btrywr."','".$btryno."','".$atm."')";
	...
	$result1= mysqli_query($con1,"insert into `site_assets`(cust_id,po,assets_name,assets_spec,valid,quantity,atmid,type,rate)values('$cust','$pordr','Stabilizer','".$avr."','".$avrwr."','".$avrno."','".$id."','NEW' ,'".$avrrate."')");
	 }		
	if(!$result1)
