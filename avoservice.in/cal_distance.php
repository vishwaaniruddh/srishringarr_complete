...
$result=mysqli_query($con1,"SELECT engg_id FROM `area_engg` where status=1 and deleted=0");
...
while($row=mysqli_fetch_row($result))
{
    ...
    mysqli_query($con1,"insert into engg_distances(eng_id,mac_id,dis_date,dis_travelled) values('".$row[0]."','".$mac."','".$date."','".$tot_distance."')");
    
//echo "insert into engg_distances(eng_id,mac_id,dis_date,dis_travelled) values('".$row[0]."','".$mac."','".$date."','".$tot_distance."')";
