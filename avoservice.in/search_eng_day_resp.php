...
<th width="10%" rowspan="1">Designation</th>
...
$qry="SELECT engg_id,engg_name, loginid, emp_code,area,engg_desgn FROM `area_engg` where area='".$branch."' and status=1 and deleted=0";
...
/*$alert= "select count(distinct alert_id)  as `count` from alert_progress where engg_id= '".$engname[2]."' and responsetime between '".$frmdt." 00:00:00' and '".$todt." 23:59:59' " ;    
