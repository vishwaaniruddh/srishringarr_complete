...
<title>edit Attendance-<?php echo $_SESSION['user']; ?></title>
...
perp=document.getElementById(perpg).value;
         ...
         document.getElementById("show").innerHTML ="<center><img src=loader.gif></center>";
            ...
            type:'POST',    
   url:'editattendance_process.php',
  data:'Branch='+Branch+'&Employee_name='+Employee_name+'&Employee_code='+Employee_code+'&from='+from+'&Page='+Page+'&perpg='+perp,
...
<?php include("menubar.php");?>
		      ...
		      <h2 class="h2color" align="center" st>Edit Attendance</h2>
<div>
