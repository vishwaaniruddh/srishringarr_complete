...
if(confirm("Insure Material is delivered at site."),confirm("Insure Site is ready fro Installation."))
  {
			...
			var url = 'get_docID.php?fname='+s;
			 ...
			 if(a!="Loading"){
				...
				var cid=document.getElementById('cid').value; //alert(eng);		  	
			  	...
			  	var BuyStatus=document.getElementById('BuyStatus').value;
			  	//var sub_date=document.getElementById('sub_date').value;
				var atmid=document.getElementById('atmid').value;
                               var BuyCondition=document.getElementById('BuyCondition').value;
                               // var sostats=document.getElementById('sostats').value;


                                var address=document.getElementById('address').value; 
 
 pmeters="&Page="+b+'&perpg='+ppg+'&fromdt='+fromdt+'&todt='+todt+'&cid='+cid+'&branch_avo='+branch_avo+'&invno='+invno+'&crnno='+crnno+'&BuyStatus='+BuyStatus+'&atmid='+atmid+'&address='+address+'&BuyCondition='+BuyCondition;
			      //   alert(pmeters);
			  }
			  else
			  {
...
<table cellpadding="" cellspacing="0" >
 ...
 <th><select name="cid" id="cid" onchange="searchById('Listing','1','');" ><option value="">Select Client</option><?php
  ...
  <tr>
    ...
    <th width="75"><input type="text" name="atmid" id="atmid" placeholder="ATM ID"/></th>
    
    <th width="77">
     	<select name="BuyStatus" id="BuyStatus" >       				
                <option value="">BuyBack Status</option>                
   ...
   <th width="77">
     	<select name="BuyCondition" id="BuyCondition" >       				
                <option value="">BuyBack Condition</option>                
                <option value="y">Available SO </option>
                <option value="n">Not Available SO</option>
        </select>
</th>
