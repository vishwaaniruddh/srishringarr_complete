                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <i class="icon-circle-plus"></i>
                                                                    <!--<i class="icon-android-add-circle" id="design_copy" style="font-size: 3rem; color: #F6BB42;cursor: pointer;"></i>-->
                        ...
                        $("#add").click();
                           ...
                           let a = `<div class="card row" id="Footage_section" >
                                <div class="col-sm-3">
                                    ...
                                    <input type="date" name="footage_date" class="form-control" value="<? echo $date; ?>" />
                                </div>
                                <div class="col-sm-3">
                                    <label> From </label>
