                    ...
                    for ($row = 2; $row <= $highestRow; $row++){ 
                     ...
                     /*  if($chkdata==0){
                        ...
                        if($_row_array[9]!=""){
                            ...
                            $checkmonthsql = "select * from mis_staff_salary_test where month='".$month."' and account_number='".$_row_array[9]."'
                                              and department='".$_row_array[11]."' and year='".$year."'";
                            ...
                            if($checkrowcount==0){
                               // echo '<pre>';print_r($_row_array);echo '</pre>';die;
                                $insertexcelsql = "insert into mis_staff_salary_test(company,categories,staff_type,customer,payee_name,amount,emp_code,beneficiary_name,
                                                 beneficiary_name_fencer,account_number,ifsc,department,email_body,state,branch_location,sup_name,bank,atm_id,month,salary_date,required_by,
...
<div class="pcoded-content">
    ...
    <div class="outer-container">
        <form action="uploadSalaryPaymentExcelParticulars.php"  method="POST" name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data">
                            <div>
                                <label>Choose Excel
