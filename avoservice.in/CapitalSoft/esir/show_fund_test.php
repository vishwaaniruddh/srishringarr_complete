...
<style>
    ...
    font-size: 16px;
         ...
         <?  $_ispostsubmit = 0; $_isfundtransfer = 0;
                                            ...
                                            <tbody>
                                               ...
                                               // }
                                                ...
                                                if($_isfundtransfer == 1){
                                                    ...
                                                    $userfundtransferstmt = "select status,current_status,approved_amt from mis_fund_transfer where req_id=".$id." order by id desc" ;
                                                    $userfundtransfersql = mysqli_query($con,$userfundtransferstmt);
                                                    $userfundtransfer_rowresult = mysqli_fetch_row($userfundtransfersql);
                                                    if($userfundtransfer_rowresult[0]>1){
                                                        $_istransferdone = 1;
                                                    }else{
                                                        $_istransferdone = 0;
                                                    }
                                                    ...
                                                    if($_ispostsubmit == 1){ 
                                                      if(in_array("pending",$arr_status)){
                                                          if($userfundtransfer_rowresult[1]>1 && $userfundtransfer_rowresult[1]<4){
                                                              $_istransferdone = 1;
                                                          }else{
                                                              $_istransferdone = 0;
                                                          }
