...
<script
  ...
  crossorigin="anonymous"></script>
      ...
      <style>
         #particles-js {
         background-color: #1e0e20; /* Replace with your desired background color */
         }
         .login-block{
         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  ...
                  <form action="process_registration.php" class="md-float-material form-material" method="POST" >
                     ...
                     <div class="auth-box card">
                        <div class="card-block">
                           <div class="row m-b-20">
                              <div class="col-md-12">
                                 <p style="text-align:center;"><img src="../files/assets/images/logo.png" alt="logo.png"></p>
                                 <hr />
                           ...
                           <div class="row">
                            ...
                            <div class="col-sm-6">
                            <div class="form-group form-primary">
                            <input type="text" name="officecontactno" class="form-control" required="" placeholder="Office Contact No">
                            <span class="form-bar"></span>
                            </div>
                            </div>
                            <div class="col-sm-6">
                            <div class="form-group form-primary">
                            <input type="text" name="personalcontactno" class="form-control" required="" placeholder="Personal Contact No">
                            <span class="form-bar"></span>
                            </div>
                            </div>
                            </div>
                           ...
                           <div class="row m-t-30">
                              <div class="col-md-12">
                                 <input class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20" type="submit" value="Sign Up Now"> 
                              </div>
                           </div>
                           <hr />
                        </div>
