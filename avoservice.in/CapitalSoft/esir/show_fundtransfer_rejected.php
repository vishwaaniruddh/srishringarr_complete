                                    ...
                                    <div class="card-block" style=" overflow: auto;">
                                        <table id="myTable" class="table table-bordered table-striped table-hover dataTable no-footer" style="width:100%">
                                            ...
                                            <tbody>
                                                <?  
                                                    $total = 0;
                                                    $sql="select t1.beneficiary_name, t1.account_number, t1.ifsc_code, sum( t1.approved_amt ), t2.fundDetails, t1.id,t1.fund_remark,t2.type,t1.req_id,t1.remarks
                                                           from mis_fund_transfer as t1, rnm_fund as t2 where t1.req_id = t2.id and t1.status=2 and t1.current_status=0 and t1.action_by='".$action_by."'
                                            	   ...
                                            	   if(!empty($table)) {
                                                    ...
                                                    <tr>
                                                       <!-- <td><input type='checkbox' id="checkbox_<? echo $i; ?>" name='apps[]' value="<? echo $id; ?>" onclick="deductamt(<? echo $i; ?>)"></td>-->
                                                         ...
                                                         <td><? echo $row[6] ?></td>
                                                         <td class='btn btn-danger'><? echo 'Rejected'; ?></td>
                                                         <td><? echo $row[9] ?></td>
