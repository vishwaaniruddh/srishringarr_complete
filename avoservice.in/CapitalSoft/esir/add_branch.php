                    ...
                    <div class="main-body">
                        <div class="page-wrapper">
                          ...
                          if(isset($_POST['submit'])){
                              ...
                              $statement = "insert into newbranch(branch,status,created_at,created_by) values('".$branch."','1','".$date."','".$userid."')";
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table class="table table-bordered table-striped table-hover dataTable js-exportable no-footer">
                                            ...
                                            <tbody>
                                                <? $i = 1 ; 
                                                $sql = mysqli_query($con,"select * from newbranch where status=1");
