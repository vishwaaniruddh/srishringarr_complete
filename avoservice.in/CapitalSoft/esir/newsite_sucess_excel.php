...
$contents='';
$contents.="Sr no \t activity \t customer \t bank \t atmid \t atmid2 \t atmid3 \t trackerno \t address \t city \t state \t zone \t branch \t bm_name \t bm_number \t created_by \t created_at \t ";
// $contents.="Sr no \t activity \t customer \t bank \t atmid \t atmid2 \t atmid3 \t trackerno \t address \t city \t state \t zone \t branch \t bm_name \t bm_number \t created_by \t created_at \t pincode \t live_date \t";
...
$contents = strip_tags($contents); 
  ...
  header("Content-Disposition: attachment; filename=success.xls");
