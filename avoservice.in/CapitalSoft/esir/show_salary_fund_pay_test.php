                            ...
                            <div class="page-body">
                                <div class="card">
                                    <div class="card-block" style=" overflow: auto;">
                                         <form action="cms_salaryexp_test.php" method="POST">
                                         ...
                                         <form action="showsalaryfundtransferaction1.php" method="POST" id="form">
                                            ...
                                            <tbody>
                                                <?  $req_ids = array();
                                                	...
                                                	for($x=0;$x<count($app);$x++){  
                                                        ...
                                                        $currentsql="select current_status,transferred_date,amount,beneficiary_name,account_number,ifsc_code from mis_salary_fund_transfer where req_id='".$app[$x]."'";  
                                                    ...
                                                    <tr>
                                                        <td><? echo $i; ?></td>
                                                         <td><? echo $currentrow[3] ?></td>  
                                                         <td><? echo $currentrow[4] ?></td>  
                                                         <td><? echo $currentrow[5] ?></td>  
                                                         <td><? echo $_customer_total_amt ?></td>  
                                                        <? if($_currentstatus==2 || $_currentstatus==3){ ?>
                                                           <td>
...
<center>
 ...
 <button class="btn btn-danger"><a href="showsalaryfundtransfer1.php">Cancel</a></button>
...
$('#transModal form').on('submit', function (e) {
          ...
          e.preventDefault();
          $("#transModal .btn-success").hide();
          $.ajax({
            type: 'post',
            url: 'process_salaryfundtransferdate_action1.php',
