									...
									<div class="row">
										<div class="col-md-2" >
											...
											<select name="activity" id="activity" class="form-control" required>
												...
												<?php $ac_sql = mysqli_query($con,"select distinct(activity) as activity from mis_newsite where status=1");
                                                    while($ac_sql_result = mysqli_fetch_assoc($ac_sql)){ ?>
    													<option value="<?php echo $ac_sql_result['activity'];?>" <? if(isset($_POST[ 'activity']) && $_POST[ 'activity']==$ac_sql_result[ 'activity'] ){ echo 'selected'; } ?>>
    														<?php echo $ac_sql_result['activity'];?>
    													</option>
    													<? } ?>
										...
										<div class="col-md-2">
											<label>ATMID</label>
											<input type="text" name="atmid" class="form-control" value="<?php echo $_POST['atmid']; ?>"> </div>
										<div class="col-md-3">
											<label>From Visit Date</label>
											<input type="date" name="fromdt" class="form-control" value="<?php if($_POST['fromdt']){ echo  $_POST['fromdt']; }else{ echo '2023-02-01' ; } ?>"> </div>
										
											<div class="col-md-3">
											<label>To Visit Date</label>
											<input type="date" name="todt" class="form-control" value="<?php if($_POST['todt']){ echo  $_POST['todt']; }else{ echo date('Y-m-d') ; } ?>"> </div>
