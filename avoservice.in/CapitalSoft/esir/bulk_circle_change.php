                            ...
                            <div class="page-body">
                                <div class="card">
                                    <div class="card-block">
                                                                        ...
                                                                        <div class="two_end">
                                    <h5>Update Bulk Site Circle <span style="font-size:12px; color:red;">(Bulk Upload)</span></h5>
...
$_date = str_replace("-","_",$date);
 ...
 $sitebackup = mysqli_query($con,"create table site_circle_comnew1_".$_date." as select * from site_circle_comnew ");
      ...
      $old_circle = $rowData[$i][0][1];
        if($old_circle){
          ...
          //  $datetime = date('Y-m-d h:i:s');
                ...
                $updatesql = "update site_circle_comnew set Circle = '".$new_circle."' where ATMID = '".$ATMID."' ";
                ...
                if(mysqli_query($con,$updatesql)){ 
                    ...
                    $sentence = "Circle ".$old_circle." not able to update its value";
                    array_push($error_array,$sentence); 
                }
            
    
        }else{
            $sentence = "Row ".$i." not have circle";
            array_push($error_array,$sentence); 
        }
