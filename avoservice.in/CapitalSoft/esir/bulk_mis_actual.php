...
if(mysqli_query($con,$statement)){
    ...
    $mis_id = $con->insert_id ;
        ...
        $detai_statement = "insert into mis_details(mis_id,atmid,component,subcomponent,docket_no,status,created_at,ticket_id,amount,engineer) values('".$mis_id."','".$atmid."','".$component."','".$subcomponent."','".$docket_number."','open','".$created_at."','".$ticket_id."','".$amount."','".$engineer_user_id."')" ;
