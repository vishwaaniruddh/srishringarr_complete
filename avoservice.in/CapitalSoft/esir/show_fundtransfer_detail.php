                                            ...
                                            <tbody>
                                                <?  
                                                    ...
                                                    $sql="select t1.beneficiary_name, t1.account_number, t1.ifsc_code, sum( t1.approved_amt ), t2.fundDetails, t1.id,t1.fund_remark,t2.type,t1.req_id
                                                           from mis_fund_transfer as t1, rnm_fund as t2 where t1.req_id = t2.id and t1.status=2 and t1.current_status=1
                                            	   ...
                                            	   if(!empty($table)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                          <a id="reject_<? echo $i; ?>" data-toggle="modal" data-reqid="<? echo $row[8]; ?>" data-checkboxid="<? echo $i; ?>" data-req_amt="<? echo $row[3]; ?>" data-id="<? echo $id; ?>" class="open-RejectDialog btn btn-danger" href="#rejectModal">Reject</a>
                                                        </td>
                                                    </tr>         
                                                <?  } 	}
                                                ?>
