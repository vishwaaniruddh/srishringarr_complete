...
function refreshDatePicker(dateFieldName, year, month, day)
{
 //alert("fh");
  ...
  var xTR = "</tr>" + crlf;
  var TD = "<th class='dpTD' onMouseOut='this.className=\"dpTD\";' onMouseOver=' this.className=\"dpTDHover\";' ";   
  var TD_title = "<th colspan=5 class='dpTitleTD'>";
  var TD_buttons = "<th class='dpButtonTD'>";
  var TD_todaybutton = "<th colspan=7 class='dpTodayButtonTD'>";
