...
// echo $roleid  = $_SESSION['role_id'];

// $user = "select role from mis_loginusers_test where id='".$usrid."';
$usersql = mysqli_query($con,"select role from mis_loginusers_test where id = '".$usrid."' ");
