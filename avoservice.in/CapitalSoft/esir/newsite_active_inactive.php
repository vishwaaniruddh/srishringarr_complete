                            ...
                            <div class="page-body">
                                <div class="card">
                                    <div class="card-block">
                                        <div class="two_end">
                                            <h5>Bulk Sites Active/Inactive  <span style="font-size:12px; color:red;">(Bulk Upload)</span></h5>
                                            <a class="btn btn-success" href="excelformat/bulk_active_inactive_atmid.xlsx" download>BULK SITES ACTIVE/INACTIVE UPLOAD FORMAT</a>
                                        </div>
                                      <?php 
                                              ...
                                              $atmid = $rowData[$i][0][0];
                                                if($atmid){
                                                    ...
                                                    $datetime = date('Y-m-d h:i:s');
                                                        ...
                                                        $updatesql = "update mis_newsitetest set status = '".$_status."',updated_at='".$datetime."' where ATMID = '".$atmid."' ";
