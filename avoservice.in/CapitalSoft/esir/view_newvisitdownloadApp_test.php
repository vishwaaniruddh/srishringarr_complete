...
if(isset($_POST['download'])){
    if($_POST['id']){
        ...
        $getimagesql = "select link from misvisit_images_app_new_test where misvisitid='".$visitid."'"; 
        ...
        $atmid = $_REQUEST['atmid'];
            header('Content-disposition: attachment; filename="'.trim($atmid).'".zip');
...
?>
<script>
  window.location = "view_newvisit_app.php";
</script>