									...
									<div class="row">
										...
										<div class="col-md-3">
											...
											<select name="status" class="form-control" required>
											    ...
											    <option value="3" <? if(isset($_POST['status'])) { if($_POST['status']=='3'){ echo 'selected' ;  }} ?>>DisApproved</option>
											</select>
										</div>
									</div>
                                            ...
                                            $i=1;
                                                ...
                                                while($sql_result_app = mysqli_fetch_assoc($sql_app)){
                                                    ...
                                                    <td>
                                                        ...
                                                        <?} else if($sql_result_app['status']==2) { echo "Approved ";} else { echo "disapproved";} ?>
                                                    <td>
                                                        <a href="newcheckquality_details_test.php?id=<? echo $id; ?>" target="_blank"><button type="submit" class="btn btn-warning" >View More</button></a>
                                                    </td>
                                                    <td>
                                                        <? if($_view_img==1) { ?>
