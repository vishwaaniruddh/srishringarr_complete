...
//echo '<pre>';print_r($rowData);echo '</pre>';die;
    for($i = 1; $i<=$row; $i++){
      ...
      $atmid = $rowData[$i][0][0];
        if($atmid){
            $sql = mysqli_query($con,"select * from mis_newsite where atmid like '%".$atmid."%'");
            $engineer_user_id = "";
...
$statement = "insert into mis_1_test(atmid,bank,customer,zone,city,state,location,call_receive_from,remarks,status,created_by,created_at) values('".$atmid."','".$bank."','".$customer."','".$zone."','".$city."','".$state."','".$location."','".$call_receive."','".$remarks."','open','".$created_by."','".$created_at."')";
...
if(mysqli_query($con,$statement)){
    ...
    $mis_id = $con->insert_id ;
        ...
        $last_sql = mysqli_query($con,"select id from mis_details_1_test order by id desc");
        ...
        $detai_statement = "insert into mis_details_1_test(mis_id,atmid,component,subcomponent,docket_no,status,created_at,ticket_id,amount,engineer) values('".$mis_id."','".$atmid."','".$component."','".$subcomponent."','".$docket_number."','open','".$created_at."','".$ticket_id."','".$amount."','".$engineer_user_id."')" ;
