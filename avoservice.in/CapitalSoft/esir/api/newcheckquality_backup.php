...
if($wizard_no==1){
    $count_visit_query = mysqli_query($con,"select id from newcheckquality order by id DESC LIMIT 1");
    ...
    $count_visit_query = mysqli_query($con,"select visit_id from newcheckquality where atmid='".$atmid."' order by id DESC LIMIT 1");
    $count_visit = mysqli_fetch_assoc($count_visit_query);
    $visit_id = $count_visit['visit_id'];
}
...
if($wizard_no==1){
    $is_qry = 1;
    $query_result = mysqli_query($con,"insert into newcheckquality (`customer`,`atmid`, `visit_id`, `bank`,  `question_list`, `wizard_number`, `status`, `created_at`, `updated_at`, `created_by`) values ('".$customer."','".$atmid."','".$visit_id."','".$bank."','".$testarray."','".$wizard_no."','".$status."','".$created_at."','".$created_at."','".$eng_id."') ");
}
if($wizard_no==2){
    $is_qry = 1;
   // $updat = "update newcheckquality SET  `question_list_2`='".$testarray."', `wizard_number`='".$wizard_no."', `updated_at`='".$created_at."' where visit_id='".$visit_id."'";
    $query_result = mysqli_query($con,"update newcheckquality SET  `question_list_2`='".$testarray."', `wizard_number`='".$wizard_no."', `updated_at`='".$created_at."' where visit_id='".$visit_id."'");
    ...
    if($cnt>0){
        ...
        // foreach($_FILES as $k => $v){
          ...
          /*$info = getimagesize($source_file);
            if ($info['mime'] == 'image/jpeg') $image = imagecreatefromjpeg($source_file);
            elseif ($info['mime'] == 'image/gif') $image = imagecreatefromgif($source_file);
            elseif ($info['mime'] == 'image/png') $image = imagecreatefrompng($source_file);
            else $image = imagecreatefromjpeg($source_file);
            $quality = 20;
            $_return = imagejpeg($image, $target_file, $quality); */
           // if($return==1){
...
if($wizard_no==3){
    $is_qry = 1;
    $query_result = mysqli_query($con,"update newcheckquality SET  `question_list_3`='".$testarray."', `wizard_number`='".$wizard_no."', `updated_at`='".$created_at."' where visit_id='".$visit_id."'");
    ...
    //$filename = strtotime("now").".jpg";
    $totalfiles_ts = 0;$hdderr_ts = 0;$err_ts=0;
    if($cnt_ts>0){
...
if($wizard_no==4){
    $is_qry = 1;
    $query_result = mysqli_query($con,"update newcheckquality SET  `question_list_4`='".$testarray."', `wizard_number`='".$wizard_no."', `updated_at`='".$created_at."' where visit_id='".$visit_id."'");
...
if($wizard_no==5){
    $is_qry = 1;
    $query_result = mysqli_query($con,"update newcheckquality SET  `question_list_5`='".$testarray."', `wizard_number`='".$wizard_no."', `updated_at`='".$created_at."' where visit_id='".$visit_id."'");
...
if($wizard_no==6){
    $is_qry = 1;
    $query_result = mysqli_query($con,"update newcheckquality SET  `question_list_6`='".$testarray."', `wizard_number`='".$wizard_no."', `updated_at`='".$created_at."' where visit_id='".$visit_id."'");
...
if($is_qry == 1){
    if($query_result)
	{
	    ...
	    $wizard_no = $wizard_no + 1;
	    $array = array('Code'=>200,'wizard_no'=>$wizard_no);
	}       
    else
    {
