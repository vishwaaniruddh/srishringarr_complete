...
<? 
$sql1 = mysqli_query($con,"select distinct(zone) as zone from mis_branch_zone_master where zone in($zone) order by zone"); 
...
$sql = mysqli_query($con,"select branch,zone from mis_branch_zone_master where zone ='".$zone."' order by branch");
