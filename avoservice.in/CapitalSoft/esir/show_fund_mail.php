                                            ...
                                            <tbody>
                                               ...
                                               if($_ispostsubmit == 1){
                                                ...
                                                if($_isfundtransfer == 1){ 
                                                    $userfundtransferstmt = "select status,current_status,approved_amt from mis_fund_transfer where req_id='".$id."' order by id desc limit 1" ;
...
$('#myModal form').on('submit', function (e) {
          ...
          $.ajax({
            type: 'post',
            url: 'process_rnmfund_action_mail.php',
