                                            ...
                                            <tbody>
                                                <?  $req_ids = array();
                                                	...
                                                	for($x=0;$x<count($app);$x++){  
                                                      ...
                                                      $row13 = str_replace(' ', '', $row[13]);
                                                      $row10 = str_replace(' ', '', $row[10]);
                                                      $combinevalue = $row13."_".$row10;
                                                      //  $combinevalue = $row[13]."_".$row[10];
                                                        if(!in_array($combinevalue,$accountno_array)){
                                                          //  echo $combinevalue."<br>";
                                                        //   $accs=mysqli_query($con,"select req_id,approved_amt from mis_fund_transfer where status=3 and trans_id='".$trans_id."' and account_number='".$row[20]."'"); 
                 $accs=mysqli_query($con,"select req_id,approved_amt,current_status from mis_fund_transfer where trans_id='".$trans_id."' and account_number='".$row[10]."' and fund_remark='".$row[13]."'"); 
                                                           ...
                                                           while($accr=mysqli_fetch_array($accs)){
                                                               if(in_array($accr[0],$app)){
                                                                 //  $req_amt_data=mysqli_query($con,"select approved_amt from mis_fund_requests_test where req_id=".$accr[0]." order by id desc");
                                                    ...
                                                    <tr>
                                                        ...
                                                        <? } ?> 
                                                         <? if($_currentstatus==3){ ?>
                                                           <td>
                                                            <?php if($transferred_date=='0000-00-00'){?>
                                                            ...
                                                            <?php }else{ echo $transferred_date;}?>
                                                            </td>
                                                        <? } ?>
                                                        <? if($_currentstatus==4){ ?>
