                                ...
                                <div class="card">
                                    <div class="card-block" style=" overflow: auto;">
                                         ...
                                         <?
                                           $_case = $_GET['case'];
                                           if($_case==1){
                                               $statement = "SELECT * FROM `rnm_fund` WHERE created_by='".$user_id."'" ;  
    
                                           }
                                           if($_case==2){
                                               $statement = "SELECT * FROM `rnm_fund` as rf JOIN `mis_fund_requests` as mfr ON mfr.req_id=rf.id WHERE rf.created_by='".$user_id."' AND mfr.action=1 group by mfr.req_id" ;  
    
                                           }
                                           if($_case==3){
                                               $statement = "SELECT * FROM `rnm_fund` as rf JOIN `mis_fund_requests` as mfr ON mfr.req_id=rf.id WHERE rf.created_by='".$user_id."' AND mfr.status=0 group by mfr.req_id" ;  
    
                                           }
                                           if($_case==4){
                                               $statement = "SELECT * FROM `rnm_fund` as rf JOIN `mis_fund_transfer` as mfr ON mfr.req_id=rf.id WHERE rf.created_by='".$user_id."' AND mfr.transferred_date!='0000-00-00' AND mfr.current_status=4 group by mfr.req_id" ;  
    
                                           }
                                           if($_case==5){
                                               $statement = "SELECT * FROM `rnm_fund` as rf JOIN `mis_fund_transfer` as mfr ON mfr.req_id=rf.id WHERE rf.created_by='".$user_id."' AND mfr.current_status=0 group by mfr.req_id" ;  
    
                                           }
                                           if($_case==6){
                                               $statement = "SELECT *,id as req_id FROM `rnm_fund`" ;  
                                    ...
                                    <table class="table table-bordered table-striped table-hover dataTable js-exportable no-footer">
                                     <!--   <table id="example" class="table table-bordered table-striped table-hover no-footer" style="width:100%"> -->
                                            ...
                                            <tbody>
                                                ...
                                                $approved_amt = $userfundaction_rowresult['approved_amt'];
                                                ...
                                                if($userfundaction_rowresult['action']==0){
                                                    ...
                                                    if($userfundaction_rowresult['status']>5){
                                                        $userfundtransaction = "select current_status,status,req_amt,approved_amt,transferred_date,batch_no from mis_fund_transfer where req_id=".$id." order by id desc limit 1" ;
                                                        ...
                                                        $approved_amt = $userfundtransaction_rowresult['approved_amt'];
                                               ...
                                               // $total_amount = $total_amount + $sql_result['required_amount']; 
                                                ?>
