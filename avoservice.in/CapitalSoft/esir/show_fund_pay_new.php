...
if($_SESSION['username']){ 
    include('header.php');
    $app=$_POST['apps'];// echo '<pre>';print_r($app);echo '</pre>';die;
    include('config.php');
?>
                            ...
                            <div class="page-body">
                                <div class="card">
                                    <div class="card-block" style=" overflow: auto;">
                                         <form action="cmsexp1.php" method="POST">
                                                ...
                                                <?  $req_ids = array();
                                                	...
                                                	for($x=0;$x<count($app);$x++){  
                                                        ...
                                                        if(!in_array($row[20],$accountno_array)){
                                                           $accs=mysqli_query($con,"select * from rnm_fund where account_number='".$row[20]."' group by fundDetails"); 
