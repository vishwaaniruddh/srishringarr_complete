...
$mnth=date('M-Y');
                                                	...
                                                	for($x=0;$x<count($app);$x++){  
                                                        ...
                                                        $row20 = str_replace(' ', '', $rowdata[20]);
                                                        if(!in_array($row20,$accountno_array)){
                                                            
                                                           $accs=mysqli_query($con,"select * from rnm_fund where account_number='".$row20."'"); 
                                                           ...
                                                           array_push($accountno_array,$row20);
                                                           $view = 1;
                                                        }
...
$objSheet->setCellValueByColumnAndRow(20, $row, $rowdata[24]);
 $row++;
$srn++;
}
}
