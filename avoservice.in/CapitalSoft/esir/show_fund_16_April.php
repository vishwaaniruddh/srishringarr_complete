                                            ...
                                            <div class="row">
                                                 ...
                                                 <div class="col-md-3">
                                                     ...
                                                     <select id="multiselect_zone" class="form-control" name="zone[]" multiple="multiple">
                                                         <option value="3,4,5" <? if(isset($_POST['zone'])) {  if(in_array("3,4,5",$_POST['zone'])){ echo 'selected';}}?>>Operation</option>
                                                         <option value="4,5" <? if(isset($_POST['zone'])) {  if(in_array("4,5",$_POST['zone'])){ echo 'selected';}}?>>Manager</option>
    ...
    if(isset($_POST['status'])){
        if(in_array("pending",$arr_status)){
            if(in_array('3',$arr_zone)){
             ...
             $statement .=" and a.status in($zone)" ;
        }
    }else{
        $statement .=" and a.status in($zone)" ;
    }
