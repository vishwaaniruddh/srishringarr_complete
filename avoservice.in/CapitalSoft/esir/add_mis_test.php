                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        <div class="card-block">
                            ...
                            <form id="form" action="process_addMis_test.php" method="POST">
                                <!-- add_mis_process_check -->
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label>ATM ID</label>
                                        <div class="input-group input-group-button">
                                            <input type="text" name="atmid" id="atmid" class="form-control"
                                                placeholder="Atm ID">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <input class="form-control" type="text" name="zone" id="zone"
                                            value="<? echo $zone ; ?>" readonly>
                                    </div>

                                    <div class="col-sm-2">
                                        <label class="label_label">City</label>
                                        <input class="form-control" type="text" name="city" id="city"
                                            value="<? echo $city; ?>" required readonly>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <label>Css BM</label>
                                        <input type="text" class="form-control" name="bm" id="bm" readonly>
                                    </div>
                                    
                                    <div class="col-sm-3">
                                        <label>Engineer</label>
                                        <input class="form-control" type="text" name="engineer" id="engineer" readonly>
                                    </div>
