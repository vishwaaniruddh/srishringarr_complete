                            ...
                            <div class="page-body">
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        $ide = $sql_result['id'];
                                        $detail_history = mysqli_query($con,"select * from mis_history_test  where mis_id = '".$ide."' ");
                                    ...
                                    <div class="card-block">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <!--    <option value="MRS" <? if($mis_status == 'MRS'){ echo 'selected' ; }?> style="<? if($status_view==1){ echo 'display:none'; } ?>"> Material Pending </option>-->
                                                    <!--<option value="open" <? if($mis_status == 'open'){ echo 'selected' ; }?> > Open </option>-->
                                                    
                                                <!--</select>-->
                                                
                                                <select class="form-control" name="status" id="status">
                                                    <?php if($mis_status == 'open') {?>
                                                        <option value="">Select</option>
                                                        <option value="schedule"> Schedule</option>    
                                                        <option value="fund_required"> Fund Requirement</option>
                                                    <?php } ?>
                                                    <?php if($mis_status == 'schedule') {?>
                                                        <option value="">Select</option>
                                                        <option value="material_requirement">Material Requirement</option>
                                                        <option value="customer_dependency">Customer Dependency</option>
                                                        <option value="fund_required"> Fund Requirement</option>
                                                        <option value="close">close</option>
                                                    <?php } ?>
                                                    <?php if($mis_status == 'material_requirement') {?>
                                                        <option value="">Select</option>
                                                        <option value="material_dispatch">Material Dispatch</option>
                                                        <option value="MRS">Material Pending</option>
                                                        <option value="close">close</option>
                                                    <?php } ?>
                                                    <?php if($mis_status == 'customer_dependency') {?>
                                                        <option value="">Select</option>    
                                                        <option value="schedule"> Schedule</option>    
                                                        <option value="fund_required"> Fund Requirement</option>
                                                    <?php } ?>
                                                    <?php if($mis_status == 'fund_required') {?>
                                                        <option value="">Select</option>
                                                        <option value="material_requirement">Material Requirement</option>
                                                        <option value="customer_dependency">Customer Dependency</option>
                                                        <option value="close">close</option>
                                                    <?php } ?>
                                                    <?php if($mis_status == 'material_dispatch') {?>
                                                        <option value="">Select</option>
                                                        <option value="material_delivered">Material Delivered</option>
                                                        <option value="close">close</option>
                                                    <?php } ?>
                                                    <?php if($mis_status == 'close') {?>
                                                        <option value="">Select</option>
                                        ...
                                        if(isset($_POST['status'])){
                                            ...
                                            if($_POST['status']=='dispatch' || $_POST['status']=='MRS' || $_POST['status'] =='permission_require' || $_POST['status']=='broadband' || $_POST['status']=='material_not_available' || $_POST['status'] =='material_available_in_branch'){
                                                $remark = $_POST['remark'];
                                                $status = $_POST['status'] ;
                                                echo $statement = "insert into mis_history_test (mis_id,type,remark,status,created_at,created_by) values('".$id."','".$status."','".$remark."','1','".$date."','".$userid."')" ;
                                            }
                                            elseif($_POST['status']=='schedule'){
                                                ...
                                                $statement = "insert into mis_history_test (mis_id,type,engineer,remark,schedule_date,status,created_at,created_by) values('".$id."','".$status."','".$engineer."','".$remark."','".$schedule_date."','1','".$date."','".$userid."')" ;
                                                mysqli_query($con,"update mis_details_1_test  set engineer = '".$engineer."' where id = '".$id."'");
                                            ...
                                            elseif($_POST['status']=='material_requirement'){
                                                ...
                                                $statement = "insert into mis_history_test (mis_id,type,material,material_condition,remark,status,created_at,created_by,delivery_address,contact_person_name,contact_person_mob) values('".$id."','".$status."','".$material."','".$material_condition."','".$remark."','1','".$date."','".$userid."','".$address."','".$contact_name."','".$contact_mob."')" ;
                                                
                                                mysqli_query($con,"insert into material_inventory_test(mis_id,material,material_condition,remark,status,created_at,created_by,delivery_address) values('".$id."','".$material."','".$material_condition."','".$remark."','1','".$date."','".$userid."','".$delivery_address."')");
                                            ...
                                            elseif($_POST['status']=='material_dispatch'){
                                                ...
                                                $remark = $_POST['remark'];
                                                $statement = "insert into mis_history_test (mis_id,type,courier_agency,pod,dispatch_date,remark,status,created_at,created_by) values('".$id."','".$status."','".$courier."','".$pod."','".$dispatch_date."','".$remark."','1','".$date."','".$userid."')" ;
                                            }
                                            elseif($_POST['status']=='material_delivered'){
                                                $status = $_POST['status'] ;
                                                $delivery_date = $_POST['delivery_date'];
                                                $statement = "insert into mis_history_test (mis_id,type,status,created_at,created_by,delivery_date) values('".$id."','".$status."','1','".$date."','".$userid."','".$delivery_date."')" ;
                                            }
                                            elseif($_POST['status']=='paste_control'){
                                                ...
                                                $image = $_FILES['image']['name'];
                                                 if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_dir .'/' .$image )) {
                                                    ...
                                                    $remark = $_POST['remark'];
                                                    $statement = "insert into mis_history_test (mis_id,type,status,created_at,created_by,attachment) values('".$id."','".$status."','1','".$date."','".$userid."','".$link."')" ;
                                                 }   
                                            }
                                            elseif($_POST['status']=='close'){
                                                ...
                                                $serial_no = $_POST['sno'];
                                                if(!is_dir('close_uploads/test/'.$year .'/'. $month.'/'.$atmid)){
                                                    mkdir('close_uploads/test/'.$year .'/'. $month .'/'.$atmid , 0777 , true) ; 
                                                }
                                                $target_dir = 'close_uploads/test/'.$year .'/'. $month.'/'. $atmid ;
                                                $link = "";
                                                $link2 = "";
                                                $image = $_FILES['image']['name'];
                                                if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_dir .'/' .$image )) {
                                                ...
                                                $statement = "insert into mis_history_test (mis_id,type,attachment,attachment2,remark,status,created_at,created_by,close_type,serial_number) values('".$id."','".$status."','".$link."','".$link2."','".$remark."','1','".$date."','".$userid."','".$close_type."','".$sno."')" ;
                                                mysqli_query($con,"update mis_details_1_test  set close_date = '".$date."' where id = '".$id."'");
                                            }
                                            elseif($_POST['status']=='fund_required' || $_POST['status']=='customer_dependency'){
                                                $remark = $_POST['remark'];
                                                $status = $_POST['status'];
                                                $statement = "insert into mis_history_test (mis_id,type,remark,created_at,created_by) values('".$id."','".$status."','".$remark."','".$date."','".$userid."')" ;
                                            }
                                            elseif($_POST['status']=='reopen'){
                                                ...
                                                mysqli_query($con,"update mis_details_1_test set status = 'open', close_date = '' where id = '".$id."' ");
                                            }
                                            ...
                                            mysqli_query($con,"update mis_details_1_test  set status = '".$status."' where id = '".$id."'");
                                            ...
                                            <script>
                                                swal("Great !", "Call Updated Successfully !", "success");
                                                    ...
                                                    setTimeout(function(){ 
                                                        // window.location.href="mis_details_raj.php?id=<? echo $id ; ?>";
                                    ...
                                    <div class="card-block" style="overflow:scroll;">
                                        ...
                                        <table class="table table-bordered table-striped table-hover dataTable js-exportable no-footer">
                                            ...
                                            <tbody> 
                                                ...
                                                $his_sql = mysqli_query($con,"select * from mis_history_test  where mis_id ='".$id."'");
                                                $i = 1 ; 
...
<script>
    ...
    $("#status_col").html('');
        ...
        if(status == 'dispatch'){
           ...
           var html = '<input type="hidden" name="status" value="material_requirement"><div class="col-sm-6"><label>Request Material For Site</label><select class="form-control" name="material"><option value="">Select</option><? $mat_sql =mysqli_query($con,"select * from material where status=1 "); while($mat_sql_result = mysqli_fetch_assoc($mat_sql)){ ?> <option value="<? echo $mat_sql_result['material'] ; ?>"><? echo $mat_sql_result['material'] ; ?></option> <? } ?></select></div><div class="col-sm-6"><label>Material Conditions</label><select class="form-control" name="material_condition"><option value="">Select</option><option value="Missing">Missing</option><option value="Faulty">Faulty</option><option value="Not Installed">Not Installed</option></select></div><div class="col-sm-12"><label>Remark</label><input type="text" name="remark" class="form-control"></div><div class="col-sm-3"><label>Address Type</label><select class="form-control" id="address_type" name="address_type" onchange="setaddress()"><option value="Other" id="Other">Other</option></select></div> <?php if ($address_history != '') {?> <div class="col-sm-9"><label>Address</label><input class="form-control" name="address" id="address" value="<?php echo $address_history; ?>" readonly="readonly"></div> <?php } else {?> <div class="col-sm-9"><label>Address</label><input class="form-control" name="address" id="address" value="<?php echo $address_history; ?>"></div> <?php } if ($name != '') {?> <div class="col-sm-4" id="Contactperson_name"><label for="Contactperson_name">Contact Person Name</label><input type="text" class="form-control" name="Contactperson_name" id="Contactperson_name_text" value="<?php echo $name; ?>" readonly="readonly"></div> <?php } else {?> <div class="col-sm-4" id="Contactperson_name"><label for="Contactperson_name">Contact Person Name</label><input type="text" class="form-control" name="Contactperson_name" id="Contactperson_name_text" value="<?php echo $name; ?>"></div> <?php }  if ($mobile != '') {?> <div class="col-sm-4" id="Contactperson_mob"><label for="Contactperson_mob">Contact Person Mobile</label><input type="text" class="form-control" name="Contactperson_mob" id="Contactperson_mob_text" value="<?php echo $mobile; ?>" readonly="readonly"></div> <?php } else {?> <div class="col-sm-4" id="Contactperson_mob"><label for="Contactperson_mob">Contact Person Mobile</label><input type="text" class="form-control" name="Contactperson_mob" id="Contactperson_mob_text" value="<?php echo $mobile; ?>"></div> <?php }?> <div class="col-sm-4"><br><input class="btn btn-success" type="submit" name="submit"></div>';  
