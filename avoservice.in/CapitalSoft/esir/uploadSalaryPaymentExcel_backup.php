                                ...
                                <div class="card">
                                    <div class="card-block" style=" overflow: auto;">
                                        ...
                                        <div class="two_end">
                                            ...
                                            <a class="btn btn-success" href="excelformat/Comfort_Techno_Staff_Salary.xlsx" download>SALARY UPLOAD FORMAT</a>
                                        </div>
                                        <hr>
    ...
    <div class="outer-container">
        <form action="uploadSalaryPaymentExcel.php" method="POST" name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data">
                            <div>
                                ...
                                <button type="submit" id="submit" name="import" value="import"
