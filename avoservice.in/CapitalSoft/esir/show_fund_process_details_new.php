  ...
  /*  $app=$_POST['apps'];
    ...
    if(isset($_POST['submit'])){
        ...
        $misrequest_table=mysqli_query($con,$_misfundrequestsql);  
         while($misfundreqtabledata=mysqli_fetch_array($misrequest_table)){
               
               $uniquereq_id = $misfundreqtabledata[0];
               $_misfundrequestsql_1 = "select action,status,id from mis_fund_requests where req_id='".$uniquereq_id."' order by id desc limit 1";
               $misrequest_table_1=mysqli_query($con,$_misfundrequestsql_1);  
               $misfundreqtabledata_1=mysqli_fetch_row($misrequest_table_1);
               $mis_req_status = $misfundreqtabledata_1[1];
               $mis_req_action = $misfundreqtabledata_1[0];
               $uniquemis_req_id = $misfundreqtabledata_1[2];
               
               if($mis_req_status=='6' && $mis_req_action=='2'){
                        $mainsql="select req_id,current_status from mis_fund_transfer where req_id='".$uniquereq_id."' and status=3";
                    ...
                    $misrequestsql="select req_id,action from mis_fund_requests where id='".$uniquemis_req_id."'";
