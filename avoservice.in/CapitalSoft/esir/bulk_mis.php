                                    ...
                                    for ($i = 1; $i <= $row; $i++) {
                                        ...
                                        $remarks = $rowData[$i][0][11];
                                           ...
                                           if($num_rows>0) {
                                            ...
                                            //echo $city."_".$state."_".$zone."_".$engineer_user_id;die;
                                            // $engineer_user_id = "";
                                            $amount = 'NULL';

                                            $statement = "insert into mis(atmid,bank,customer,zone,city,state,location,branch,bm,call_receive_from,remarks,status,created_by,created_at) values('" . $atmid . "','" . $bank . "','" . $customer . "','" . $zone . "','" . $city . "','" . $state . "','" . $location . "','".$branch."','".$bm."','" . $call_receive . "','" . $remarks . "','open','" . $created_by . "','" . $created_at . "')";
                                            ...
                                            if (mysqli_query($con, $statement)) {
                                                ...
                                                $detai_statement = "insert into mis_details(mis_id,atmid,component,subcomponent,docket_no,status,created_at,ticket_id,amount,mis_city,zone,engineer,branch,case_type,call_type) 
                                                values('" . $mis_id . "','" . $atmid . "','" . $component . "','" . $subcomponent . "','" . $docket_number . "','open','" . $created_at . "','" . $ticket_id . "','" . $amount . "','".$mis_city."','".$zone."','" . $engineer_user_id . "','".$branch."','Internal','Service')";
