...
if(mysqli_query($con,$sql)){ 
    ...
    // echo "insert into visitsite_details(visit_id,type,status,cam1,cam2,cam3,cam4,hdd_status,router_name,routerid,other_status,visitstatus,created_at) values('".$insert_id."','".$tabselect."','".$status."','".$cam1."','".$cam2."','".$cam3."','".$cam4."','".$hdd_status."','".$routername."','".$routerid."','".$other_status."','1','".$datetime."')"; 
