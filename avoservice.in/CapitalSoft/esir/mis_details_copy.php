                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <select class="form-control" name="status" id="status">
                                                    ...
                                                    <option value="fund_required" <? if($mis_status == 'fund_required'){ echo 'selected' ; }?> style="<? if($status_view==1){ echo 'display:none'; } ?>"> Fund Required </option>
                                                    <option value="service_center" <? if($mis_status == 'service_center'){ echo 'selected' ; }?> style="<? if($status_view==1){ echo 'display:none'; } ?>"> Service Center </option>
                                                </select>
                                            </div>
                                        </div>
                                        <hr>
                                        ...
                                        if(isset($_POST['status'])){
                                            ...
                                            if($_POST['status']=='dispatch' || $_POST['status']=='MRS' || $_POST['status'] =='permission_require' || $_POST['status']=='broadband' || $_POST['status']=='material_not_available' || $_POST['status'] =='material_available_in_branch'){
                                                ...
                                                $image = $_FILES['image']['name'];
                                                 ...
                                                 $remark = $_POST['remark'];
                                                    $statement = "insert into mis_history_test(mis_id,type,attachment,remark,status,created_at,created_by,close_type) values('".$id."','".$status."','".$link."','".$remark."','1','".$date."','".$userid."','".$close_type."')" ;
                                            ...
                                            <script>
                                                swal("Great !", "Call Updated Successfully !", "success");
                                                    ...
                                                    setTimeout(function(){ 
                                                        window.location.href="mis_details_copy.php?id=<? echo $id ; ?>";
                                                    }, 2000);
...
<script>
    ...
    $("#status_col").html('');
        ...
        else if(status == 'service_center'){
                var html = '<input type="hidden" name="status" value="service_center"><div class="col-sm-12"><label>Remark</label><input type="text" name="remark" class="form-control"></div><div class="col-sm-4"><br><input class="btn btn-success" type="submit" name="submit"></div>';
        }
