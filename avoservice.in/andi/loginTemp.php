...
//echo "Select * from alert_delegation where engineer='".$ro[0]."' and call_close_status=0 and status=0 and alert_id in (select alert_id from alert where ( call_status<>'Rejected' and status<>'Done' and call_status<>'Done'))";
