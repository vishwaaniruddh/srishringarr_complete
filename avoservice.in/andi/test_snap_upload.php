...
.cust_file{
    ...
    <center>
        ...
        <h2> Test Snaps</h2>
               <br>
          <form action="test_process_snapupload.php" method="post" enctype="multipart/form-data">
  
          <input type="file" name="full_product" class="form-control cust_file">
          
          <input type="hidden" name="alert_id" value="1328045">
