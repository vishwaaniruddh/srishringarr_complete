...
//==========================================	
if($_POST['br']=='all')
 $sql="Select * from atm where active='N' and site_type='opex'";
else
 $sql="Select * from atm where active='N' and site_type='opex' and branch_id in(".$br.") ";	
