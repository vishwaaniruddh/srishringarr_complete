...
<tr>
                ...
                <th width="3%">End User Name</th>
                <th width="3%">Site Id</th>
                <th width="3%">City</th>
                <th width="3%">Area</th>
...
$status= $row['status'];
//=================== Site Data=========
$sitedata=mysqli_query($con1,"select * from `new_amc_sites` where `po_id`='".$id."'");
$site=mysqli_fetch_assoc($sitedata);

$branch=mysqli_query($con1,"select name from `avo_branch` where `id`='".$site['branch_id']."'");
$br=mysqli_fetch_row($branch);
...
<td width="70"><?php echo $site['enduser']; ?></td>
<td width="70"><?php echo $site['atm_id']; ?></td>
<td width="70"><?php echo $site['city']; ?></td>
<td width="70"><?php echo $site['area']; ?></td>
<td width="70"><?php echo $site['address']; ?></td>
<td width="70"><?php echo $br[0]; ?></td>
...
<td width="75">
    <?php if ($status==1) { echo "Pending"; }
    else if ($status==2) { echo "Completed"; }
    ?> </td> 

<?php if ($status==1) { ?>
<td>
<a href="javascript:void(0);" class="btn btn-primary" onclick="window.open('update_amc_table.php?id=<? echo $id;?>','view updates','width=700px,height=500,left=200,top=60')" class="update">Upload</a>
</td>
