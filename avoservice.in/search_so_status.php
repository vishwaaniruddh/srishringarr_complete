...
<th width="8%">SO upload time</th>
<th width="8%">Invoice upload time</th>
...
<!--===PO===-->
<td  valign="top">&nbsp;
<?php $poname=mysqli_query($con1,"select `po_no` from `purchase_order` where `id`='".$row[1]."'");
...
<!--===so time===-->   
<td  valign="top">&nbsp;<?php echo $atm[2]; ?></td>
 
<!--===Invoice upload time ===  --> 
<td  valign="top">&nbsp;<?php echo $so[21]; ?></td>
