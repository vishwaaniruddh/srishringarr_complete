...
<th width="103">Group Name</th>

<th width="80">User Name</th>
<th width="80">WhatsApp Number</th>
<th width="80">Service / Sales </th>
...
$str="select a.cust_name, b.group_id,b.name,b.whatsapp_no, b.id  from customer a, whatsapp_customer b where a.cust_id=b.cust_id and b.status=1";
...
$groupde=mysqli_query($con1,"select * from whatsapp_groupname where id='".$row[1]."'");
$gname=mysqli_fetch_row($groupde);

?>
<tr class="<?php if($count%2==0){ echo "res1"; } else{ echo "res2"; }  ?>">
<td><?php echo $row[0]; ?></td>
<td><?php echo $gname[2]; ?></td>
<td><?php echo $row[2]; ?></td>
<td><?php echo $row[3]; ?></td>
<td><?php echo $gname[3]; ?></td>
<td width="47" height="31"> <a href='edit_whatsapp_no.php?id=<?php echo $row[4]; ?>'> Edit </a></td>
<td width="56" height="31">  <a href="javascript:confirm_delete(<?php echo $row[4]; ?>);" class="update"> Delete </a></td>
<?php  } ?>
</tr>
