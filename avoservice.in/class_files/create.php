...
class create{
	function create_table($server_name,$db_username,$db_password,$db_name,$table,$arr_column_and_datatype){
		...
		$bool = mysql_query("create table $table($column_and_datatype_string)");
		if($bool) return true;
		else return false;
