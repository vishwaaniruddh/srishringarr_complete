...
class update{
	function update_table($server_name,$db_username,$db_password,$db_name,$table_name,$array_target_column_name,$array_new_value,$ref_column_name,$ref_column_value){	
		include_once('database_connection.php');	
		$con_obj=new database_connection();
		$con_obj->open_connection($server_name,$db_username,$db_password,$db_name);
		$check_exists_query = mysql_query("select * from $table_name where $ref_column_name = '$ref_column_value'");
	...
	//echo $set_str;
		$update_query = mysql_query("update $table_name set $set_str where $ref_column_name = '$ref_column_value'");
