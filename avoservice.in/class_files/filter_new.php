...
include("config.php");
class filter_new{
	function filter($atm_id,$cust_id,$bank_name,$area,$pincode,$city,$state,$from_date,$to_date){
		...
		$qry1=mysql_query("select * from customer where cust_name like('$cust_id%')");
while($crow=mysql_fetch_row($qry1)){
echo $crow[0]."<br/>";*/
...
////////////filter
function filter1($atm_id,$cust_id,$bank_name,$area,$pincode,$city,$state,$from_date,$to_date){
