...
perp=document.getElementById(perpg).value;
         ...
         document.getElementById("show").innerHTML ="<center><img src=loader.gif></center>";
            ...
            type:'POST',    
   url:'viewemployee_process.php',
  data:'Branch='+Branch+'&Department='+Department+'&status='+status+'&Employee_name='+Employee_name+'&Employee_code='+Employee_code+'&Page='+Page+'&perpg='+perp,
...
<?php include("menubar.php");?>
		      ...
		      <h2 class="h2color" align="center" st>View Employee</h2>
<div>
