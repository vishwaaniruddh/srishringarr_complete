...
<td width="181"><?php echo $row[4]?></td>
<td width="109"><?php echo $row[5]?></td>
<td width="109"><?php echo $row[7]?></td>
<td width="138"><?php echo $row[8]?></td>
<td width="102"><?php echo $row[6]?></td>
<td width="138"><?php echo $row[9]?></td>
<td width="109"><?php echo $row[3]?></td>
<td width="206"><?php 
$qry2me=mysqli_query($con1,"select * from amcassets where `siteid`='$row[0]'");
while($detail1=mysqli_fetch_row($qry2me))
{
//echo "select * from assets_specification where ass_spc_id='$detail1[2]'";
$qry3me=mysqli_query($con1,"select * from assets_specification where ass_spc_id='$detail1[2]'");
$row3me=mysqli_fetch_row($qry3me);

$qry4me=mysqli_query($con1,"select * from assets where assets_id='$row3me[1]'");
$row4me=mysqli_fetch_row($qry4me);

$qry5me=mysqli_query($con1,"select * from `amcpurchaseorder` where amcsiteid='".$row[0]."'");
