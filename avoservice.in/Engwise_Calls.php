...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
		 ...
		 var branch_avo=document.getElementById('branch_avo').value; //alert(branch_avo);
			 ...
			 // alert(br);
			//alert("gg"); 
			var url = 'Engwise_Calls_Search.php'; 
		//  }
 	//alert(br);
		    var pmeters="";
			//alert(url);
...
<h2 class="h2color">First Call Response time-Slot</h2>
...
<th width="77"> <select name="type" id="type" > 
        ...
        <option value="reach">Reach site</option>
    <!--    <option value="left">Last Left site</option> -->
</select>
</th>
