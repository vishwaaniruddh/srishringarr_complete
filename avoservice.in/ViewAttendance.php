...
<title>View Attendance-<?php echo $_SESSION['user']; ?></title>
...
perp=document.getElementById(perpg).value;
         ...
         document.getElementById("show").innerHTML ="<center><img src=loader.gif></center>";
            ...
            type:'POST',    
   url:'ViewAttendance_process.php',
//url:'testing.php',
  data:'Branch='+Branch+'&Department='+Department+'&Employee_name='+Employee_name+'&Employee_code='+Employee_code+'&from='+from+'&to='+to+'&Page='+Page+'&perpg='+perp,
...
<?php include("menubar.php");?>
		      ...
		      <h2 class="h2color" align="center" st>View Attendance</h2>
<div>
...
<option value="">Select</option> 
      ...
      <?php } ?>
				...
				<td><input type="text" name="Employee_code" id="Employee_code" ></td>
