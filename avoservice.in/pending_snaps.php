...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
	...
	var cid=document.getElementById('cid').value;//alert(cid);
 	...
 	//alert(br);
			...
			if(a!="Loading"){ 
			 pmeters = 'atmid='+id+'&cid='+cid+'&bravo='+bravo+'&Page='+b+'&perpg='+ppg+'&fromdt='+fromdt+'&todt='+todt+'&complaintno='+complaintno+'&branch_avo='+branch_avo+'&engg='+engg;
			// alert(pmeters);
			}
			else
			{
				 pmeters = 'bravo='+bravo+"&Page="+b+'&perpg='+ppg+'&branch_avo='+branch_avo+'&engg='+engg+'&cid='+cid;
			}
			//alert(pmeters);
...
<h2 class="h2color">Pending Installation Snaps</h2>
<div >
