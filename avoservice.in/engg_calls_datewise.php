...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
		 ...
		 var branch_avo=document.getElementById('branch_avo').value; //alert(branch_avo);
			 ...
			 // alert(br);
			//alert("gg"); 
			var url = 'search_engg_calls_datewise.php'; 
		//  }
 	//alert(br);
		    var pmeters="";
			//alert(url);
...
<h2 class="h2color">Engineers date-wise calls</h2>
<h4 class="h4color">Branch selection must</h4>
...
<th width="77"> <select name="type" id="type" > 
        ...
        <option value="resol">calls</option>
