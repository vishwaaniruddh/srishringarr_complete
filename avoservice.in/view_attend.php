...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
		  ...
		  var calltype=document.getElementById('calltype').value;//alert(calltype);	 
			 ...
			 if(a!="Loading" && document.getElementById('br').value=="all"){
			 	var br=document.getElementById('br').value;
				//var calltype=document.getElementById('calltype').value;//alert(calltype);	 
				...
				var branches=document.getElementById('branches').value; //alert(branches);
 	...
 	//alert(br);
			...
			//alert(pmeters);
				...
				pmeters = 'cid='+cid+'&br='+br+'&Page='+b+'&perpg='+ppg+'&fromdt='+fromdt+'&todt='+todt;
				}
			else
			{
...
<h2 class="h2color">VIEW BRANCH ENG. ATTENDENCE</h2>
