...
$contents='';
 $contents.="Sr. No.\t Complaint ID\t  Vertical-Client Name\t Site/Sol/ATM ID\t End User\t  Address\t  Branch\t Alert Date\t Delegation time\t Call Hold time\t Un-Hold Time\t Engineer Name\t Call Type\t  Response Time\t Call Resol TAT\t Call close time\t Last update\t All FeedBack\t  ";
// echo $contents;
 $cnt=0;
