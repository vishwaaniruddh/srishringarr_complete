...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
		 ...
		 var branch_avo=document.getElementById('branch_avo').value; //alert(branch_avo);
			 ...
			 // alert(br);
			//alert("gg"); 
			var url = 'search_engg_cisit_count.php'; 
		//  }
 	//alert(br);
		    var pmeters="";
			//alert(url);
			...
			if(a!="Loading"){ 
			 pmeters='Page='+b+'&perpg='+ppg+'&date='+date+'&branch_avo='+branch_avo+'&fromdate='+fromdate;
			 //alert(pmeters);
			}
			else
			{
...
<h2 class="h2color">Engineers Site Attendance count</h2>

<div >
 <button id="myButtonControlID" onClick="tableToExcel('custtable', 'Engr Ser TAT')">Export to Excel</button>
...
<th width="75"><input type="text" name="fromdate" id="fromdate" onkeypress="return runScript(event)" readonly="readonly" onclick="displayDatePicker('fromdate');" placeholder="From Date"/></th>
<th width="75"><input type="text" name="date" id="date" onkeypress="return runScript(event)" readonly="readonly" onclick="displayDatePicker('date');" placeholder=" to Date"/></th>
