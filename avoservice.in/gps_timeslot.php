...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
		 ...
		 var branch_avo=document.getElementById('branch_avo').value; //alert(branch_avo);
			 ...
			 // alert(br);
			//alert("gg"); 
			var url = 'search_gps_timeslot.php'; 
		//  }
 	//alert(br);
		    var pmeters="";
			//alert(url);
			...
			if(a!="Loading"){ 
			 pmeters='Page='+b+'&perpg='+ppg+'&fromdt='+fromdt+'&branch_avo='+branch_avo+'&engg='+engg;
			 //alert(pmeters);
			}
			else
			{
...
<h2 class="h2color">Daywise GPS Timeslot</h2>
...
<th width="75"><input type="text" name="fromdt" id="fromdt" onkeypress="return runScript(event)" readonly="readonly" onclick="displayDatePicker('fromdt');" placeholder="Date"/></th>
