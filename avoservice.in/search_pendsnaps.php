...
$sql.="Select * from alert where branch_id <>'' and close_date >= '2022-10-01 00:00:01'and snap_file =''";
...
?>
 ...
 <td>
    <?php /// Snap file row41 ?>
    <button input type="button" style="color:blue; font:bold;" <a href="javascript:void(0);" class="btn btn-primary" onclick="window.open('add_snaps.php?id=<? echo $row[0];?>&cnt=1','upload','width=700px,height=500,left=300,top=100')" class="update">Upload Snaps</a></button>
