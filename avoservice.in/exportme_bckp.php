...
$contents='';
 $contents.="Sr. No.\t Complaint ID\t Call Request Type\t Vertical-Client Name\t Site/Sol/ATM ID\t End User\t City\t Area\t Address\t State\t Branch\t Problem\t Alert Date\t Delegation time\t Contact Person\t Phone\t Engineer Name\t Engr Mobile\t Distance from Engr\t Call Type\t Customer Status\t Response Time\t Resolution Time\t Call close time\t Last FeedBack\t  Last update Time\t Engineers FeedBack\t Problem Type\t Call Open Easing\t Eng Close Status\t Branch Close status\t Approved By\t Approval Remarks\t  UPS Model\t Visits\t Repeat Call\t Hold Time\t Unhold Time\t Hold Reason\t";
// echo $contents;
 $cnt=0;
