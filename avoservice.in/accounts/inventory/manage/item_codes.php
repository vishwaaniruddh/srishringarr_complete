...
div_start('code_table');
	...
	$th = array(_("EAN/UPC Code"), _("Quantity"), _("Units"), 
		_("Description"),_("Category"), "", "",_("Barcode"));
        ...
        while ($myrow = db_fetch($result))
        {
            ...
            label_cell($myrow["cat_name"]);
		 	...
		 	//label_cell($myrow["item_code"]);
		 	?>
		 	<td><a href="http://sarmicrosystems.in/accounts/barcodes/index.php/items/generate_barcodes/<?php echo $myrow['item_code']; ?>" ><?php echo $myrow["item_code"]; ?></a></td>
		 	<?php
            end_row();
