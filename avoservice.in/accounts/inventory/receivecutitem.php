...
$cid=substr($sid,0,-1);
 ...
 $rawquery=mysql_query("select * from rawmaterial where rawid='".$id."' and prefix='".$cid."'");
...
{
//alert(i);
document.getElementById('piece'+i).value=0;
}
...
<form action="receivecutting.php" method="post">
<table width="781" height="381" border="1">
<tr>
		<th  align="center" colspan="3"><h2>Receive Material</h2><a href="viewcuttingfrm.php">View Cutting Quantity</a>&nbsp;&nbsp;&nbsp;<a href="viewwashing.php">View Washing</a> </th>
    </tr>
    <tr>
		<th align="center">Quantity in meters :</th>
		<td colspan="3"><input type="hidden" name="rawid" id="rawid" value="<?php echo $id; ?>"><input type="text" name="meters" id="meters" value="<?php echo $rawro[2]; ?>"></td>
    </tr>
	<tr>
                ...
                <tr>
                    ...
                    <?php 
							 for($i=0;$i<$cnt;$i++)
 										{
 					?>
 						 <tr height="20px"><td><input type="text" name="ratio[]" id="ratio<?php echo $i; ?>" value="<?php echo $rawro[$i+4]; ?>" onBlur="calratio(this.id,'piece<?php echo $i; ?>')" width="20px"></td></tr>
 					<?php
 										}
 					 ?>
