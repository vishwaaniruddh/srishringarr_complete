...
$j=0;
$qry=mysql_query("INSERT INTO `satyavan_accounts`.`rawmaterial` (`rawid`, `prefix`, `meters`, `catid`, `28`, `30`, `32`, `34`, `36`, `38`, `40`, `42`, `44`, `46`, `48`, `50`) VALUES (NULL, '".$cid."', '".$meters."', '".$cat."', '".$piece[$j]."', '".$piece[$j+1]."', '".$piece[$j+2]."', '".$piece[$j+3]."', '".$piece[$j+4]."', '".$piece[$j+4]."', '".$piece[$j+5]."', '".$piece[$j+6]."', '".$piece[$j+7]."', '".$piece[$j+8]."', '".$piece[$j+9]."', '".$piece[$j+10]."')");
if(!$qry)
