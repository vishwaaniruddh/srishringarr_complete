...
class customers_app extends application 
{
	function customers_app() 
	{
		...
		$this->add_rapp_function(1, _("Create &Wholesale Bill"),
			"sales/wholesaleinvoice.php", 'SA_SALESTRANSVIEW', MENU_REPORT);
			
		$this->add_rapp_function(1, _("Create &Retail Bill"),
			"sales/retailinvoice.php", 'SA_SALESTRANSVIEW', MENU_REPORT);
		$this->add_rapp_function(1, _("&Manual Bill"),
			"sales/Manual_bill.php", 'SA_SALESTRANSVIEW', MENU_REPORT);
		$this->add_rapp_function(1, _("Current Rates"),
			"sales/current_rates.php", 'SA_SALESTRANSVIEW', MENU_REPORT);
