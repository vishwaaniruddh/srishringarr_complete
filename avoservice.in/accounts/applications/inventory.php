...
class inventory_app extends application
{
	function inventory_app()
	{
		...
		$this->add_rapp_function(1, _("Stock &Report"),
			"reporting/rep306.php?Class=2", 'SA_ITEMSTRANSVIEW', MENU_REPORT);
			$this->add_rapp_function(1, _("Stock Movement Report"),
			"reporting/rep307.php?Class=2", 'SA_ITEMSTRANSVIEW', MENU_REPORT);
			
		$this->add_module(_("Maintenance"));
		$this->add_lapp_function(2, _("&Items"),
			"inventory/manage/items.php?", 'SA_ITEM', MENU_ENTRY);
		$this->add_lapp_function(2, _("&Item Details"),
			"inventory/manage/itemdetails.php?", 'SA_ITEM', MENU_ENTRY);	
		...
		$this->add_rapp_function(2, _("&Reorder Levels"),
			...
			$this->add_rapp_function(2, _("Raw Materials"),
			"inventory/rawfrm1.php?", 'SA_REORDER', MENU_MAINTENANCE);
			$this->add_rapp_function(2, _("Cutting Material"),
			"inventory/viewcuttingfrm.php?", 'SA_REORDER', MENU_MAINTENANCE);
			$this->add_rapp_function(2, _("Wash Material"),
			"inventory/viewwashing.php?", 'SA_REORDER', MENU_MAINTENANCE);
