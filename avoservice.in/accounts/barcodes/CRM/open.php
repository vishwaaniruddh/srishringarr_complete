...
//alert(s);
xmlhttp.open("POST","getType.php?cid="+s,true);
...
{ 
 ...
 var id=document.getElementById('id').value;
  xmlHttp.open("GET", "searchopen.php?cont="+cont+"&cid="+s+"&pin="+s1+"&id="+id, true);
//alert("searchopen.php?cont="+cont+"&cid="+s+"&pin="+s1);
  xmlHttp.send(null);
...
<option value="service">AMC Customer</option>
<option value="temp">One Time Customer</option>
</select>
</td>
</tr>
