...
$sql="select * from amcservice where customer='$id' and service_date='$sdate1'";
...
<input type="button" value="cancel" onclick="javascript:location.href = 'amcview.php';" class="button"/>
</center>
</body>
</html>