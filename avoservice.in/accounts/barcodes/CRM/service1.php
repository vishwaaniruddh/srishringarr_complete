...
<h2>New AMC Service Customer </h2>
<select id="cust" onchange="changeuser();">
  <option value="domestic">Domestic</option>
  <option value="commercial">Commercial</option>
</select>

<div id="dom">
<form action="process_newcustomer3.php" method="post">
<table>
<tr>
...
<tr>
<td height="40">Amount : </td>
<td><input type="text" name="amount" id="amount" /></td>
</tr>

<tr>
<td height="40">Date of Contract : </td>
<td><input type="text" name="dop" id="dop" class="firstcal" value=""/><input type="hidden" id="pack" value="3 Months" /><input type="hidden" id="pack1" value="3 Months" /></td>
</tr>
...
<form action="process_newcustomer4.php" method="post">
<table>
<tr>
<td width="155" height="40">Customer Name : </td>
<td width="246"><input type="text" name="cname" id="cname" /></td>
