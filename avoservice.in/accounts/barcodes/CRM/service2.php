...
$pdate=$_GET['pdate'];
$sdate1=$_GET['sdate1'];
//echo "select name from phppos_service where id='$cid'";
$sql="select `name` from phppos_service where cust_id='c-$cid'";
$result=mysql_query($sql);
$row=mysql_fetch_row($result);
echo $row[0];
?>
<form action="process_service.php" method="get">
<table width="418">
<tr>
<td height="38">Customer : </td>
<td><input type="text" value="<?php echo $row[0]; ?>" readonly style="background-color:#CCC"/></td>
<tr>
