...
class Sales extends Secure_area
{
	...
	function complete()
	{
		...
		//SAVE sale to database
              ...
              $sal=$this->Sale->save($data['cart'], $customer_id,$employee_id,$comment,$data['payments']);
              mysql_query("insert into  phppos_order(sales_id,status) values('$sal','pending')");
              $data['sale_id']='POS '.$sal;
        ...
        function challan($sale_id)
	{
		...
		$data['sale_id']='POS '.$sale_id;
		$this->load->view("sales/challan",$data);
		$this->sale_lib->clear_all();
