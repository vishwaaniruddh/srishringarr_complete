...
<table width="773">
  <tr>
    <td width="435" align="right"><div id="sale_receipt"><?php echo "CHALLAN" ?></div></td><td width="326" align="right">Phone : <?php echo $this->config->item('phone'); ?></td>
  </tr></table>
<?php
