...
$sid=substr($sale_id,4);
		...
		$sq3=mysql_query("select name from phppos_items where item_id='$ro2[1]'");
  ...
  <IMPORTDATA>
   ...
   <REQUESTDATA>
    <TALLYMESSAGE xmlns:UDF="TallyUDF">';
     ...
     $xml.="<VOUCHER REMOTEID=".$voucher_remote_id;
	 ...
	 $xml.="VCHTYPE=\"Sales\" ACTION=\"Create\" OBJVIEW=\"Invoice Voucher View\">";
      ...
      $xml.="<GUID>".$guid./*989755e0-a5d7-11de-8655-0014859c82f4-000018bd*/"</GUID>";
      ...
      $xml.="<VOUCHERNUMBER>".$voucherNumber./*SP -1*/"</VOUCHERNUMBER>";
      ...
      $xml.="<ALTERID>".$alterId./* 12635*/"</ALTERID>";
      ...
      $xml.="<MASTERID>".$masterId./* 6333*/"</MASTERID>";
      $xml.="<VOUCHERKEY>".$voucherKey./*177661322199048*/"</VOUCHERKEY>";
      ...
      <LEDGERENTRIES.LIST>
       <OLDAUDITENTRYIDS.LIST TYPE=\"Number\">";
        $xml.="<OLDAUDITENTRYIDS>".$oldAuditEntryIds./*-1*/"</OLDAUDITENTRYIDS>";
       $xml.="</OLDAUDITENTRYIDS.LIST>";
       ...
       $xml.="<AMOUNT>".$ro5[2]./*-36000.00*/"</AMOUNT>";
      ...
      <LEDGERENTRIES.LIST>
       ...
       <BASICRATEOFINVOICETAX.LIST TYPE=\"Number\">
        <BASICRATEOFINVOICETAX> 12.50</BASICRATEOFINVOICETAX>
       ...
       $xml.="<AMOUNT>".$ro4[4]./*4000.00*/"</AMOUNT>";
      ...
      <ALLINVENTORYENTRIES.LIST>";
       ...
       $xml.="<AMOUNT>".$amount3./*32000.00*/"</AMOUNT>";
       $xml.="<ACTUALQTY>".$ro2[5]./* 2 no*/"</ACTUALQTY>";
       $xml.="<BILLEDQTY>".$ro2[5]./* 2 no*/"</BILLEDQTY>";
    ...
    <TALLYMESSAGE xmlns:UDF=\"TallyUDF\">
     <COMPANY>
      <REMOTECMPINFO.LIST MERGE=\"Yes\">";
       $xml.="<NAME>".$name./*989755e0-a5d7-11de-8655-0014859c82f4*/"</NAME>";
...
$filename = 'D:/Shilpa/MyXMLFIle.xml';
