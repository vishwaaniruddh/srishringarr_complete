...
<td colspan="2"><font size="2" ><b>Net Amount:</b><br /><br /><b>Discount :</b><br /><br /><b>VAT (1.2%):</b><br /><br /><b>Total Amount:</b></font></td>
         <td colspan="2" align="right"><font size="2" ><b><?php if(isset($_POST['submit'])){ $amount=$_POST['prz']; echo array_sum($amount); }  ?></b><br><br><b><input type="text" name="dis" value="<?php if(isset($_POST['submit'])){$amount=$_POST['prz'];if($_POST['dis']!='0'){echo $_POST['dis']; }else{ echo 0;}} ?>"></b><br><br><b>
