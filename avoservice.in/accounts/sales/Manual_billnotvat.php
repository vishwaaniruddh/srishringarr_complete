...
<font size="2" >
<b>Net Amount:</b><br /><br />
<b>Discount :</b><br /><br />
<b>VAT (1.2%):</b><br /><br />
<b>Total Amount:</b></font></td>

<td colspan="2" style="text-align:right;">
<font size="2" >
<b><?php if(isset($_POST['submit'])){ $amount=$_POST['prz']; echo array_sum($amount); }  ?>
</b><br><br><b>
<input style="text-align:right;" type="text" name="dis" value="<?php if(isset($_POST['submit'])){$amount=$_POST['prz'];if($_POST['dis']!='0'){echo $_POST['dis']; }else{ echo 0;}} ?>">
</b><br><br><b>
<?php  if(isset($_POST['submit'])){ $amount=$_POST['prz'];if($_POST['dis']!='') { $dis=$_POST['dis']; }else{ $dis=0;} $vat=array_sum($amount)-$dis;  }  ?></b><br><br><b><?php  if(isset($_POST['submit'])){ $amount=$_POST['prz'];if($_POST['dis']!='') { $dis=$_POST['dis']; }else{ $dis=0;} $vat=array_sum($amount)-$dis;  echo $vat; } ?></b><br><br>
  ...
  <tr>
    <td width="419" valign="top"><ul>
      ...
      <li> <font size="2">CST TIN NO.: &nbsp;27641156905C</font></li>
	   <li> <font size="2">CIN NO.: &nbsp;U36912MH2015PTC270763</font></li>
	  </ul></td>
...
<center><a href="#" onclick='PrintDiv();'>Print</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://localhost/accounts/sales">Back</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="submit" value="Calculate No VAT"></center>
</form>
</body>
</html>