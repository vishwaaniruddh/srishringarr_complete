...
<center><img src="bill.png" width="408" height="165" align="center"/></center>
...
echo "<br>";
start_table(TABLESTYLE2, "width=95%","border=0");
echo "<tr valign=top><td>"; // outer table

/*Now the customer charged to details in a sub table*/
start_table(TABLESTYLE, "width=100%","border=0");
start_row();
label_cells(_("Charge To :"),$myrow["DebtorName"],"class='tableheader2'" . "<br>" . nl2br($myrow["address"]), "nowrap");
end_row(); 
start_row();
label_cells(_("Charge Branch :"),$branch["br_name"],"class='tableheader2'" . "<br>" . nl2br($branch["br_address"]), "nowrap"); 
end_row();
start_row();
...
if (db_num_rows($result) > 0)
{
	...
	label_row(_("Sub-total"), $display_sub_tot, "colspan=5 align=right",
...
label_row(_("Shipping"), $display_freight, "colspan=5 align=right", "nowrap align=right");
...
label_row(_("TOTAL INVOICE"), $display_total, "colspan=5 align=right",
	"nowrap align=right");
end_table(1);
