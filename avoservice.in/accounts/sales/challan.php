...
{
//echo "select * from ".$cid."_item_codes where description='".$row2[4]."'";
//$qry3=mysql_query("select * from ".$cid."_item_codes where description='".$row2[4]."'");
...
<tr><td colspan="16"><div class="cenr"> <b>Delivery Challan</b></div></td></tr>

<tr><td colspan="10"><b>Name & Address of the Party:</b></td>    
<td colspan="6">Challan No:<b><?php echo date("dmY",strtotime($debttransro[5])); ?></b> </td></tr>

<tr><td colspan="10"> <b><?php echo $debtro[1]; ?></b> <br /> <?php echo $debtro[3]; ?><br /> AGENT:-CHETAN PAREKH</td>    <td colspan="6">Date: <b><?php echo date("d/m/Y",strtotime($debttransro[5])); ?></b> </td></tr>
...
//echo "Select quantity,description from ".$cid."_debtor_trans_details where  debtor_trans_no='".$transno."' and debtor_trans_type='10' and description like '".$desc[$i]."%'";
$scot=mysql_query("Select quantity,description from ".$cid."_debtor_trans_details where  debtor_trans_no='".$transno."' and debtor_trans_type='10' and description like '".$desc[$i]."%'");
...
//break;
?>
<tr><td width="5%"><b><?php echo $i+1; ?></b></td><td width="10%"><b><?php echo $desc[$i];  ?></b></td><td width="10%"><b><?php
$shade=split(" ",$desc[$i]);
 $sh=count($shade);
echo $shade[$sh-1];
