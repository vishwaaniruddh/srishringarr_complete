...
return "<a target='_blank' href='../inv2.php?transno=".$row['trans_no']."'>Invoice</a>";
}
function challan($row)
{
	if($row["type"] == ST_SALESINVOICE)
return "<a target='_blank' href='../challan.php?transno=".$row['trans_no']."'>Challan</a>";
}
...
$cols = array(
	...
	_("RB") => array('align'=>'right', 'type'=>'amount'),
		...
		array('insert'=>true, 'fun'=>'app'),
		array('insert'=>true, 'fun'=>'challan')
	);
