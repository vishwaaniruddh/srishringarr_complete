...
<tr>
    ...
    <table width="780" >
       <tr>
        <td colspan="3" align="center" >
          <font size="2">
            <B><U>WHOLESALE INVOICE  </U></B></font></td>
         </tr>            
  <tr>
  ...
  <th width="49"><font size="2" >Sr.No.</font></th>
    <th width="150"><font size="2" >Item</font></th>
    ...
    <th width="40"><font size="2" >Net Wt.</font></th>
     <th width="40"><font size="2" >G Rate</font></th>
        ...
        <th width="40"><font size="2" >D Rate</font></th>
   	    <th width="40"><font size="2" >CS Wt</font></th>
        <th width="40"><font size="2" >CS Rate</font></th>                                	    	    
...
$itmrow=mysql_fetch_row($itmqry);
 ...
 // echo $p." / ". $sum."<br/>";
  ...
  <td><font size="2" ><?php echo $j++; ?></font></td>
    ...
    <td align="center"><font size="2" ><b><?php echo $itmrow[6]; ?></b></font></td>
    <td align="center"><font size="2" ><b><?php echo $csr[$i]; ?></b></font></td>        
    <td align="center"><font size="2" ><b><?php echo $mkr[$i]; ?></b></font></td>    
     <td align="center"><font size="2" ><b><?php $total+=$prz[$i]; echo $prz[$i]; ?></b></font></td>
  </tr> <?php }
...
<tr>
<td colspan="8"><font size="2" ><b>Total Rupees : <?php echo convert_number_to_words($netamt)." only"; ?></b></font></td>
