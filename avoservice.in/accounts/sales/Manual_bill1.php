...
<tr>
  ...
  <tr height="21">
    <td  width="30"><font size="3" >M/s.&nbsp;:&nbsp;&nbsp;</font></td><td><b><input type="text" name="cid" id="cid" value="" size="35"></b></td>
    <td width="128"><font size="2" >Invoice Date: </font><b><input type="text" name="bill_date" id="bill_date" onClick="displayDatePicker('bill_date');"/></b></td>
    </tr>
    
  <tr height="23" valign="top">
    <td width="30"><font size="3" >Address</font>.:</td>
    <td align="left"><b><textarea name="tp" id="tp" cols="37"> </textarea></b></font></td>
    <td><font size="3" >Invoice No:</font><b><input type="text" name="invno" id="invno" value=""></b></td></tr>
    <tr>
    <td width="30"><font size="3" >Contact No.: &nbsp;&nbsp;&nbsp;</font></td><td align="left"><input type="text" name="phoneNo" id="phoneNo" value="" size="35" /> </td><td width="290"></td></tr>
  </table>
  ...
  <td><font size="2" size="1"><?php echo $j++; ?></font></td>
    <td align="center"><font size="2" ><b><input name="design[]" type="text" class="design" size="38"/></b></font></td>
    <td align="center"><font size="2" ><b><input name="kt[]" type="text" class="kt" size="2"/></b></font></td>
    <td align="center"><font size="2" ><b><input name="gwt[]" type="text" class="gwt" size="2"/></b></font></td>
    <td align="center"><font size="2" ><b><input name="nwt[]" type="text" class="nwt" size="2"/></b></font></td>
    <td align="center"><font size="2" ><b><input name="grate[]" type="text" class="grate" size="3"/></b></font></td>
    <td align="center"><font size="2" ><b><input name="dwt[]" type="text" class="dwt" size="2"/></b></font></td>
    <td align="center"><font size="2" ><b><input name="drate[]" type="text" class="drate" size="3"/></b></font></td>    
    <td align="center"><font size="2" ><b><input name="mkr[]" type="text" class="mkr" size="2"/></b></font></td>    
     <td align="center"><font size="2" ><b><input name="prz[]" type="text" class="prz" size="10"/></b></font></td>
  </tr> <?php }	 
	  ?>    	
<tr>
<td colspan="6"><font size="2" ><b>Total Rupees : </b></font></td>
<td colspan="2"><font size="2" ><b>Net Amount:</b><br /><br /><b>Discount :</b><br /><br /><b>VAT (1.2%):</b><br /><br /><b>Total Amount:</b></font></td>
         <td colspan="2" align="right"><font size="2" ><b><?php   ?></b><br><br><b><?php  ?></b><br><br><b>
		 <?php  ?></b><br><br><b><?php   ?></b><br><br></font></td></tr>
</tr>
</table></font>
...
<center><a href="#" onclick='PrintDiv();'>Print</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://localhost/accounts/sales">Back</a></center>
