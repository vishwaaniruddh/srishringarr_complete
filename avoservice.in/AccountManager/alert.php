...
while ($sqlst1 = mysqli_fetch_row($sqlst)) {
    ?>
<option value="<?php echo $sqlst1[1]; ?>" <?php if ($sqlst1[1] == get_atm('state', $trackid)) {
        echo "selected";
    }
    ?>><?php echo $sqlst1[1]; ?></option>
<?php }?>
</select>
</td>
</tr>
...
while ($sqlbr1 = mysqli_fetch_row($sqlbr)) {
    ?>
<option value="<?php echo $sqlbr1[0]; ?>" <?php if ($sqlbr1[0] == get_atm('branch_id', $trackid)) {
        echo "selected";
    }
    ?>><?php echo $sqlbr1[1]; ?></option>
<?php }?>
</select>
</td>
</tr>
