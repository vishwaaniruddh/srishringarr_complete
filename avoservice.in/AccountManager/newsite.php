...
<form action="../process_newsite.php" method="post" enctype="multipart/form-data" onSubmit="return validate(this)" name="form">
...
<td colspan="2"><b>Data Format(ATM Id,Bank Name,Area,Pincode,City,State,Address,Ref_id,PO date,Ups,Number of Ups, Ups warrenty,Battery(separated with commas if multiple),Number of Battery (separated with commas),Battery warranty(separated with commas if multiple), Isolation Transformer,Number of Isolation transformer,Isolation Transformer Warranty, Stablizer,number of stablizer, Stablizer warranty)</b></td>
</tr>
...
<td colspan="2"><b>Data Format(ATM Id,Bank Name,Area,Pincode,City,State,Address,Ref_id,Amc Start date,Ups,Number of Ups, Ups warrenty,Battery(separated with commas if multiple),Number of Battery (separated with commas),Battery warranty(separated with commas if multiple), Isolation Transformer,Number of Isolation transformer,Isolation Transformer Warranty, Stablizer,number of stablizer, Stablizer warranty)</b></td>
</tr>
