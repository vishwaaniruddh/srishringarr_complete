...
<?php
$qryspecups = mysqli_query($con1, "Select * from assets_specification where assets_id='1'");
    while ($rowups = mysqli_fetch_row($qryspecups)) {
        ?>
...
<option value="0">select</option>
<?php
$qryspecbat = mysqli_query($con1, "Select * from assets_specification where assets_id='2'");
    while ($rowbat = mysqli_fetch_row($qryspecbat)) {
        ?>
...
<option value="0">select</option>
<?php
$qryiso = mysqli_query($con1, "Select * from assets_specification where assets_id='8'");
    while ($rowiso = mysqli_fetch_row($qryiso)) {
        ?>
...
<option value="0">select</option>
<?php
$qrystab = mysqli_query($con1, "Select * from assets_specification where assets_id='7'");
    while ($rowstab = mysqli_fetch_row($qrystab)) {
        ?>
...
<option value="0">select</option>
<?php
$qryavr = mysqli_query($con1, "Select * from assets_specification where assets_id='10'");
    while ($rowavr = mysqli_fetch_row($qryavr)) {
        ?>
...
$qryspecups = mysqli_query($con1, "Select * from assets_specification where assets_id='1'");
    while ($rowups = mysqli_fetch_row($qryspecups)) {
        ?>
<option value="<?php echo $rowups[0]; ?>" <?php if ($rowups[0] == $row[0]) {
            echo "selected";
        }
        ?>><?php echo $rowups[2]; ?></option>
<?php
}
    ?>
...
<option value="<?php echo $i; ?>" <?php if ($i == $atmrow[7]) {
        echo "selected";
    }
        ?>><?php echo $i; ?></option>
...
$qryspecbat = mysqli_query($con1, "Select * from assets_specification where assets_id='2'");
    while ($rowbat = mysqli_fetch_row($qryspecbat)) {
        ?>
<option value="<?php echo $rowbat[0]; ?>" <?php if ($rowbat[0] == $row[0]) {
            echo "selected";
        }
        ?>><?php echo $rowbat[2]; ?></option>
<?php
}
    ?>
</select>
