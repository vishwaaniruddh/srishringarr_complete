...
function confirm_generate(cust,atmid,trackid)
{
//alert("hi");
...
if(confirm("Insure Material is delivered at site."),confirm("Insure Site is ready fro Installation."))
  {
    document.location="newalert1.php?cust="+cust+"&atmid="+atmid+"&trackid="+trackid;
  }
...
<? $branch=mysqli_query($con1,"select id, name from avo_branch");
   ?>
<th width="75"><select name="state" id="state" onchange="searchById('Listing','1','');" placeholder="Branch"/>

<option value="">Select Branch</option>
<?  while($br=mysqli_fetch_array($branch)) { ?>
<option value="<?php echo $br[0]; ?>"><?php echo $br[1]; ?></option>
<? } ?>
