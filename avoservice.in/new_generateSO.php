...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
 	...
 	//alert(br);
			...
			if(a!="Loading"){ 
			 pmeters='&bravo='+bravo+'&Page='+b+'&perpg='+ppg+'&fromdt='+fromdt+'&todt='+todt+'&eng='+eng+'&branch_avo='+branch_avo+'&type='+type+'&cid='+cid+'&atmid='+atmid+'&sp='+sp;
			 //alert(pmeters);
			}
			else
			{
...
<h2 class="h2color">Generate Sales Orders</h2>
...
<table cellpadding="" cellspacing="0" >
 ...
 <th><select name="cid" id="cid" onchange="searchById('Listing','1','');" ><option value="">Select Client</option><?php
    ...
    <th width="75" ><select name="type" id="type" ><option value="sales">Sales</option><option value="amc">Amc</option></select></th>
        ...
        <br />
        <tr>
    <th width="75"><input type="text" name="sp" id="sp" placeholder="SALES PERSON"/></th>
