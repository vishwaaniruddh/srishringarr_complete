...
<?php include("menubar.php");?>
		 ...
		 <h2 class="h2color" align="center" st>Branch Approved Claims</h2>
<div>
...
$selbr= mysqli_query($con1,"select distinct(branch_id) from daily_expenses order by branch_id ASC"); 

} else {

$selbr= mysqli_query($con1,"select distinct(branch_id) from daily_expenses where branch_id IN (".$_SESSION['branch'].") order by branch_id ASC");
}
?> 
