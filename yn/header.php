...
<head>
<link rel="stylesheet" href="https://<? echo $_SERVER['SERVER_NAME']?>/yn/style.css">
	<meta charset="utf-8">
	...
	<link rel="shortcut icon" href="https://<? echo $_SERVER['SERVER_NAME']?>/yn/assets/logo.jpg" type="image/icon">
...
src="https://www.facebook.com/tr?id=1777498652565564&ev=PageView&noscript=1"
alt="Yosshitaneha Facebook"
/></noscript>
<!-- End Meta Pixel Code -->
...
if(isset($_GET['type'])){
  if($_GET['type']==2){
	...
	<meta name="description"
		content="Buy/Stitch exclusive Indian Designer Wear. Saree Blouses, Lehenga Cholis, Indo Western, Evening Gowns, Kalamkari Outfits, Kurtis|YosshitaNeha">
	<meta name="keyword"
		content="Apparels, Indian Wear, Indian Wedding Wear, Saree Blouses, Lehenga Choli, Indo Western, Indian Designer Outfits, Evening Wear, Custom made Blouses, Kalamkari Kurtis, Kurtis, Designer Wear, Designer Blouses, Indian Traditional Wear">
  ...
  {?>
	<meta name="description"
		content="Buy from one of India's widest collection of designer Jewelry -Yosshita Neha.Bridal Jewelry,Kundan Jewelry,Earrings,Mang Tika,Borla,Nath,Diamond Set,Accessories">
	<meta name="keyword"
		content="Wedding Jewelry,Bridal Jewelry,Jewelry for Bride,Sabyasachi Style Jewelry,Kundan Set,Necklace Set,Mang Tika,Nath,Bridal Nath,Bangle,Damini,Borla,Earring,Diamond Jewelry,Antique Jewelry,Payal,Acessories">
  ...
  ?>
	<meta name="description"
		content="Buy Designer Jewellery & Outfits for any occasions. Exclusive Lehenga Choli, IndoWestern, Gowns and Jewelry. Also stitch Blouses & other Outfits at our studio.">
	<meta name="keyword"
		content="Designer Studio,Stitch Blouses,Designer in India,Designer Wear,Blouse,Lehenga,Indo Western,Indian Wear,Evening Gown,Jewellery,Buy Earrings,Mang Tika,Borla,Necklace Set,Damini,Kundan Jewelery,Nath,Bridal Jewelery & Accessories,Diamond Jewelery.">
...
?>
	...
	<link rel="preload" href="https://<? echo $_SERVER['SERVER_NAME']?>/yn/css/vela-fonts.css" as="style"
		onload="this.onload=null;this.rel='stylesheet'">
	<noscript>
	    <link rel="stylesheet" href="https://<? echo $_SERVER['SERVER_NAME']?>/yn/css/vela-fonts.css">
	</noscript>

	<!--<link href="css/plugin.css" rel="stylesheet" type="text/css" media="all">-->
	<link rel="preload" href="https://<? echo $_SERVER['SERVER_NAME']?>/yn/css/plugin.css" as="style"
		onload="this.onload=null;this.rel='stylesheet'">
	<noscript>
	...
	<link rel="preload" href="https://<? echo $_SERVER['SERVER_NAME']?>/yn/css/vela-site.scss.css" as="style"
		onload="this.onload=null;this.rel='stylesheet'">
	<noscript>
		<link rel="stylesheet" href="https://<? echo $_SERVER['SERVER_NAME']?>/yn/css/vela-site.scss.css">
	</noscript>
	...
	<script src="https://<? echo $_SERVER['SERVER_NAME']?>/yn/js/jquery-3.5.0.min.js"></script>
	<script async="" src="https://<? echo $_SERVER['SERVER_NAME']?>/yn/js/1.js"></script>
	<script async="" src="https://<? echo $_SERVER['SERVER_NAME']?>/yn/js/2.js"></script>
	...
	<script>
		...
		window.loading_url = "https://yosshitaneha.com/asset/loader.gif";
	...
	<script
		id="__st">var __st = { "a": 27646165110, "offset": -18000, "reqid": "9465a689-ea15-4679-96b8-a8d9a53e937c", "pageurl": "velademorubix-fashion.myshopify.com\/", "u": "f616310d0d66", "p": "home" };</script>
	...
	<script async=""
		src="//cdn.shopify.com/shopifycloud/shopify/assets/shop_events_listener-68ba3f1321f00bf07cb78a03841621079812265e950cdccade3463749ea2705e.js"></script>
	<script src="https://<? echo $_SERVER['SERVER_NAME']?>/yn/requiredfunction.php"></script>
	...
	<meta property="og:image"
		content="https://cdn.shopify.com/s/files/1/0276/4616/5110/files/logo.png?height=628&amp;pad_color=fff&amp;v=1589372129&amp;width=1200">
	...
	<script id="boomr-scr-as" src="https://cdn.shopify.com/shopifycloud/boomerang/shopify-boomerang-1.0.0.min.js"
		async=""></script>
...
.menuMobileContainer .memoNav li a{
	...
	<?php include($_SERVER['DOCUMENT_ROOT'].'/yn/header1.php'); ?>
	<?php include($_SERVER['DOCUMENT_ROOT'].'/yn/header2.php'); ?>
		...
		<div class="menuMobileWrapper">
			...
			<div class="memoHeader">
				<div class="product-card__image" style="padding-top:18.461538461538463%;">
					<a href="https://yosshitaneha.com/">
					    <img style="width: 135px; height:100%;"
							class="product-card__img lazyautosizes ls-is-cached lazyloaded" sizes="90px"
							srcset="https://<? echo $_SERVER['SERVER_NAME']?>/yn/assets/logo.jpg"
			...
			<li class="hasMemoDropdown">
					<a href="#" title="" class="memoBtnDropdown collapsed" data-toggle="collapse" data-target="#memoDropdown11">Jewellery  »</a>
					
					<ul id="memoDropdown11" class="memoDropdown collapse">
						<li class="hasMemoDropdown active">
							<a href="#" title="" class="memoBtnDropdown collapsed" data-toggle="collapse" data-target="#memoDropdown111">All categories  »</a>
							...
							<ul id="memoDropdown111" class="memoDropdown collapse">
								...
								<li>
									<a
										href="https://<? echo $_SERVER['SERVER_NAME']?>/yn/list.php?type=1&id=<?php echo $rowjew1[0]; ?>">
										<?= ucwords(strtolower($rowjew[2])); ?>
						...
						<li class="hasMemoDropdown active">
							<a href="#" title=""  class="memoBtnDropdown collapsed" data-toggle="collapse" data-target="#memoDropdown112">Necklace Sets  »</a>
							...
							<ul id="memoDropdown112" class="memoDropdown collapse">
								...
								<li>
									<a href="https://<? echo $_SERVER['SERVER_NAME']?>/yn/list.php?type=1&id=<?php echo $neck_sql_result['subcat_id']; ?>"
										title="">
				...
				<li class="hasMemoDropdown">
					<a href="#" title="" class="memoBtnDropdown collapsed" data-toggle="collapse" data-target="#memoDropdown113">Earrings  »</a>
					...
					<ul id="memoDropdown113" class="memoDropdown collapse">
						...
						<li>
							<a href="https://<? echo $_SERVER['SERVER_NAME']?>/yn/list.php?type=1&id=<?php echo $ear_sql_result['subcat_id']; ?>"
								title="">
			...
			<li class="hasMemoDropdown">
				<a href="#" title="" class="memoBtnDropdown collapsed" data-toggle="collapse" data-target="#memoDropdown12">Apparels »</a>
				<ul id="memoDropdown12" class="memoDropdown collapse">
					<li class="hasMemoDropdown">
						...
						<h5 class="collTitle"><a
								href="https://<? echo $_SERVER['SERVER_NAME']?>/yn/list.php?type=2&id=<?php echo $rowjew['garment_id']; ?>"
								title="Womens">
	...
	<script>
		$(document).ready(function () {
			...
			$.ajax({
				type: "POST",
				url: '<? $_SERVER["DOCUMENT_ROOT"] ?>/yn/cartdrawer.php',
				data: 'count=' + 1,
			...
			$(".btnAddToCart").on('click', function () {
				...
				$.ajax({
					type: "POST",
					url: '<? $_SERVER["DOCUMENT_ROOT"] ?>/yn/cartcount.php',
					data: 'count=' + 1,
					success: function (msg) {
					    console.warn('call')
						$("#CartCount").html(msg);
