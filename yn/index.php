<?php include($_SERVER['DOCUMENT_ROOT'].'/yn/header.php');
	...
	<main class="mainContent" role="main">
		...
		<div id="shopify-section-1551027504217" class="shopify-section velaFramework">
						...
						<div data-section-id="1551027504217" data-section-type="velaSlideshowSection">
							<div class="velaSlideshowWrapper">
								...
								<div id="velaSlideshows1551027504217" class="vela--slideshow velaSliderLoading"
									data-autoplay="true" data-speed="5000" data-navigation="true"
            ...
            while ($ban_sql_result = mysqli_fetch_assoc($ban_sql)) {
                $description = $ban_sql_result['description'];
        ?>
												...
												<div class="p-relative">
													<div class="product-card__image"
														...
														<img class="product-card__img lazyload"
															src="AdminPanel/<?php echo $ban_sql_result['image']; ?>"
															data-aspectratio="2.8656716417910446"
															data-ratio="2.8656716417910446" data-sizes="auto" alt="<?= $description ; ?>"
												...
												<div class="velassCaptionContent text-left align-middle">
													<div class="velassCaptionInner text-left ">
														...
														<a class="btn btnVelaSlider leftright-5"
															href="<?php echo $ban_sql_result['link']; ?>"
															style="border-color: #1a1a1a;  background-color: #1a1a1a; color: #ffffff; padding: 14px 25px; ">
															Start Shopping <i class="icons icon-arrow-right"></i> </a>
													</div>
												</div>
											</div>
										</div>
		...
		<style>
			...
			.tm-product-direction-nav,
			.tm-product-control-paging {
				display: none;
			}
		</style>
		<div class="container">
...
$description = $rowimg['description'] ; 

?>
					<li class="slider_li">

						<a href="<?php echo $rowimg['url_link']; ?>">
							<img class="slider_img" src="<?php echo $rowimg['img']; ?>" loading="lazy" alt="<?= $description; ?>"></a>
						<p><a href="<?php echo $rowimg['url_link']; ?>">
		...
		<div class="shopify-section velaFramework" id="shopify-section-1586583951335">
			<div class="velaFiveCollection style_default mbBlockGutter"
				style="background-color: rgba(0,0,0,0);padding:20px 0 0; ">
				<div class="container">
								...
								<div class="velaContent">
									<div class="rowFlex rowFlexMargin">
										<div class="col-xs-12 col-sm-6 col-md-4" style="margin-top: 0;padding: 0;">
											<div class="velaCollectionItem mbItemGutter">
												<div class="effectFour">
													<a href="https://yosshitaneha.com/list.php?type=1&id=66"
														title="Bangles">
														<div class="p-relative">
															<div class="product-card__image"
																...
																<img alt="Bangles"
																	...
																	loading="lazy" data-aspectratio="1.4761904761904763"
																	data-ratio="1.4761904761904763" data-sizes="auto"
																	data-srcset="https://srishringarr.com/asset/c/com/com_Bangles.jpg"
																	data-widths="" sizes="783px"
																	srcset="https://srishringarr.com/asset/com_Bangles.jpg">
																</img>
															</div>
															<div class="placeholder-background placeholder-background--animation"
										...
										<div class="col-xs-12 col-sm-6 col-md-4" style="margin-top: 0;padding: 0;">
											<div class="velaCollectionItem mbItemGutter">
												<div class="effectFour">
													<a href="https://yosshitaneha.com/list.php?type=1&id=53"
														title="Borla">
														<div class="p-relative">
															<div class="product-card__image"
																style="padding-top:67.74193548387096%;">
																<img alt="Borla"
																	...
																	loading="lazy" data-aspectratio="1.4761904761904763"
																	data-ratio="1.4761904761904763" data-sizes="auto"
																	data-srcset="https://srishringarr.com/asset/c/com/com_Borla.jpg"
																	data-widths="" sizes="783px"
																	srcset="https://srishringarr.com/asset/com_Borla.jpg">
																</img>
															</div>
															<div class="placeholder-background placeholder-background--animation"
																data-image-placeholder="">
										...
										<div class="col-xs-12 col-sm-6 col-md-4" style="margin-top: 0;padding: 0;">
											<div class="velaCollectionItem mbItemGutter">
												<div class="effectFour">
													<a href="https://yosshitaneha.com/list.php?type=1&id=77"
														title="Earring">
														<div class="p-relative">
															<div class="product-card__image"
																style="padding-top:67.74193548387096%;">
																<img alt="Earring"
																	...
																	loading="lazy" data-aspectratio="1.4761904761904763"
																	data-ratio="1.4761904761904763" data-sizes="auto"
																	src="https://srishringarr.com/asset/Earrings_Kundan.jpg"
																	data-widths="" sizes="783px">
																</img>
															</div>
															<div class="placeholder-background placeholder-background--animation"
										...
										<div class="col-xs-12 col-sm-6 col-md-4" style="margin-top: 0;padding: 0;">
											<div class="velaCollectionItem mbItemGutter">
												<div class="effectFour">
													<a href="https://yosshitaneha.com/list.php?type=1&id=69"
														title="Hath Phool">
														<div class="p-relative">
															<div class="product-card__image"
																style="padding-top:67.74193548387096%;">
																<img alt="Hath Phool"
																	...
																	loading="lazy" data-aspectratio="1.4761904761904763"
																	data-ratio="1.4761904761904763" data-sizes="auto"
																	data-srcset="https://srishringarr.com/asset/c/com/com_Hathphool.jpg"
																	data-widths="" sizes="783px"
										...
										<div class="col-xs-12 col-sm-6 col-md-4" style="margin-top: 0;padding: 0;">
											<div class="velaCollectionItem mbItemGutter">
												<div class="effectFour">
													<a href="https://yosshitaneha.com/list.php?type=2&id=10"
														title="Lehenga Choli">
														<div class="p-relative">
															<div class="product-card__image"
																style="padding-top:67.74193548387096%;">
																<img alt="Lehenga Choli"
																	class="product-card__img lazyautosizes lazyloaded"
																	loading="lazy" data-aspectratio="1.4761904761904763"
																	data-ratio="1.4761904761904763" data-sizes="auto"
																	data-srcset="https://srishringarr.com/asset/c/com/com_Lehenga_Choli.jpg"
																	data-widths="" sizes="783px"
										...
										<div class="col-xs-12 col-sm-6 col-md-4" style="margin-top: 0;padding: 0;">
											<div class="velaCollectionItem mbItemGutter">
												<div class="effectFour">
													<a href="https://yosshitaneha.com/list.php?type=1&id=3"
														title="Kundan Set">
														<div class="p-relative">
															<div class="product-card__image"
																style="padding-top:67.74193548387096%;">
																<img alt="Kundan Set"
																	...
																	loading="lazy" data-aspectratio="1.4761904761904763"
																	data-ratio="1.4761904761904763" data-sizes="auto"
																	data-srcset="https://srishringarr.com/asset/c/com/com_Necklace_Set_Kundan.jpg"
																	data-widths="" sizes="783px"
										...
										<div class="col-xs-12 col-sm-6 col-md-4" style="margin-top: 0;padding: 0;">
											<div class="velaCollectionItem mbItemGutter">
												<div class="effectFour">
													<a href="https://yosshitaneha.com/list.php?type=1&id=63"
														title="Mang Tikkas">
														<div class="p-relative">
															<div class="product-card__image"
																style="padding-top:67.74193548387096%;">
																<img alt="Mang Tikkas"
																	...
																	loading="lazy" data-aspectratio="1.4761904761904763"
																	data-ratio="1.4761904761904763" data-sizes="auto"
																	data-srcset="https://srishringarr.com/asset/c/com/com_Tikkas.jpg"
																	data-widths="" sizes="783px"
																	srcset="https://srishringarr.com/asset/com_Tikkas.jpg">
																</img>
															</div>
															<div class="placeholder-background placeholder-background--animation"
																data-image-placeholder="">
										...
										<div class="col-xs-12 col-sm-6 col-md-4" style="margin-top: 0;padding: 0;">
											<div class="velaCollectionItem mbItemGutter">
												<div class="effectFour">
													<a href="https://yosshitaneha.com/list.php?type=2&id=29"
														title="Trail Gown">
														<div class="p-relative">
															<div class="product-card__image"
																style="padding-top:67.74193548387096%;">
																<img alt="Trail Gown"
																	...
																	loading="lazy" data-aspectratio="1.4761904761904763"
																	data-ratio="1.4761904761904763" data-sizes="auto"
																	data-srcset="https://srishringarr.com/asset/c/com/com_Trail_Gown.jpg"
																	data-widths="" sizes="783px"
			...
			<style>
				.velaFourCollection .velaCollectionWrap,
