                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="boxAccount accountInfo">
                                ...
                                <div class="accountContent">
                                    <h5 class="customerName"><? echo name(); ?></h5>
                                    <div class="customerEmail"><? echo email(); ?></div>
                                    <div class="formAccountRecover">
                                        <form method="post" action="/account/recover" accept-charset="UTF-8"><input type="hidden" name="form_type" value="recover_customer_password" /><input type="hidden" name="utf8" value="✓" />
                                            <div class="formContent"><input type="hidden" name="email" value="<? echo email(); ?>">
...
<div class="a-column a-span2">
    <div class="a-row a-size-mini">
        <span class="a-color-secondary label"> Quantity </span>
    </div>

    <div class="a-row a-size-base">
        <span class="a-color-secondary value">
            <span style="text-decoration: inherit; white-space: nowrap;"><span class="currencyINR">&nbsp;&nbsp;</span><span class="currencyINRFallback" style="display:none">Rs. </span><? echo $qty; ?></span>
        </span>
    </div>
</div>
...
<span class="a-color-secondary value">
    <span style="text-decoration: inherit; white-space: nowrap;"><span class="currencyINR">&nbsp;&nbsp;</span><span class="currencyINRFallback" style="display:none">Rs. </span><? echo $product_amt; ?></span>
</span>
...
<span class="a-color-secondary value">
    <span style="text-decoration: inherit; white-space: nowrap;"><span class="currencyINR">&nbsp;&nbsp;</span><span class="currencyINRFallback" style="display:none">Rs. </span><? echo $total_amount; ?></span>
</span>
    ...
    <a class="a-link-normal" href="/gp/product/B095YZB3MS/ref=ppx_yo_dt_b_asin_image_o03_s00?ie=UTF8&amp;psc=1">
            <img alt="" src="<? echo $image ; ?>" aria-hidden="true" class="" height="90" width="81" >
                        ...
                        <div class="a-fixed-left-grid-col a-col-right" style="padding-left:1.5%;float:left;">
                            <div class="a-row">
                                <a class="a-link-normal" href="../detail.php?id=<? echo$product_id;?>&type=<? echo $product_type?>">
                                    <? echo $sku ; ?>
                                </a>
                            </div>
                            <div class="a-row">
                                <span class="a-color-secondary a-text-bold"></span> 
