<? session_start();  include($_SERVER['DOCUMENT_ROOT'].'/header.php'); ?>
                ...
                <article id="post-9" class="post-9 page type-page status-publish hentry">
			        <div class="entry-content">
			            <div class="row">
                            ...
                            $sql=mysqli_query($con,"select * from Registration where registration_id='".$_SESSION['gid']."'");
        	                                     ...
        	                                     <label for="billing_state" class="">State&nbsp;<abbr class="required" title="required">*</abbr> </label>
    	                                            <select name="state_code" id="state_code" class="state_select form-control">
                                                        ...
                                                        while($sql_result1=mysqli_fetch_assoc($sql)){ ?>
                                                            <option id="<?php echo $sql_result1['state_code']?>" value="<? echo $sql_result1['state_code']?>"><? echo trim($sql_result1['state_name']); ?></option>
                                                        <?php } ?>
        	                                        </select>
                                        ...
                                        <div class="form-group"> 
                                        	<label for="billing_state" class="">City&nbsp;<abbr class="required" title="required">*</abbr>
                                                ...
                                                if($city_id){ ?>
                                                    ...
                                                    <?php $sql=mysqli_query($con,"select * from cities where state_code='".$state."'"); 
                                                    
                                                    while($sql_result1=mysqli_fetch_assoc($sql)){ ?>
                                                        <option value="<? echo $sql_result1['code']; ?>" id="<? echo $sql_result1['code']; ?>">
                                                            <? echo $sql_result1['name']?>
                                                        </option>
                                                    <?php } ?>
                                                <?php }
