...
if($type=="2"){
    ...
    $data[] = ['1'=>$source_img,'com_image'=>$destination_img, 'pid'=>$row[0],'symbol'=>$currency_symbol, 'product_name'=>$product_name,'cur_sym'=>$cur_sym,
...
if($type==2){
 $sqlimg="SELECT img_name FROM `product_images_new` WHERE `gproduct_id`='$row[0]' order by rank";
