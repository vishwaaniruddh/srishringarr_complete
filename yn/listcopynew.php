...
<select class="form-control" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);" style="width: auto;">
   ...
   <option>Select</option>
    <option value="list.php?id=<?php echo $product_id;?>&type=<?php echo $product_type; if(isset($_GET['pricefilter']) && $_GET['pricefilter']==1){ echo 'selected'; } ?>&pricefilter=1">Higher To Lower</option>
        <option value="list.php?id=<?php echo $product_id;?>&type=<?php echo $product_type; if(isset($_GET['pricefilter']) && $_GET['pricefilter']==2){ echo 'selected'; } ?>&pricefilter=2"> Lower To Higher </option>
    </option>
</select>
</div>
