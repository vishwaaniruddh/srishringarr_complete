...
<head>
<link rel="stylesheet" href="https://<? echo $_SERVER['SERVER_NAME']?>/style.css">
	<meta charset="utf-8">
	...
	<link rel="shortcut icon" href="https://<? echo $_SERVER['SERVER_NAME']?>/assets/logo.jpg" type="image/icon">
...
?>
	...
	<link rel="preload" href="https://<? echo $_SERVER['SERVER_NAME']?>/css/vela-fonts.css" as="style"
		onload="this.onload=null;this.rel='stylesheet'">
	<noscript>
	    <link rel="stylesheet" href="https://<? echo $_SERVER['SERVER_NAME']?>/css/vela-fonts.css">
	</noscript>

	<!--<link href="css/plugin.css" rel="stylesheet" type="text/css" media="all">-->
	<link rel="preload" href="https://<? echo $_SERVER['SERVER_NAME']?>/css/plugin.css" as="style"
		onload="this.onload=null;this.rel='stylesheet'">
	<noscript>
	...
	<link rel="preload" href="https://<? echo $_SERVER['SERVER_NAME']?>/css/vela-site.scss.css" as="style"
		onload="this.onload=null;this.rel='stylesheet'">
	<noscript>
		<link rel="stylesheet" href="https://<? echo $_SERVER['SERVER_NAME']?>/css/vela-site.scss.css">
	</noscript>
	...
	<script src="https://<? echo $_SERVER['SERVER_NAME']?>/js/jquery-3.5.0.min.js"></script>
	<script " async="" src="https://<? echo $_SERVER['SERVER_NAME']?>/js/1.js"></script>
	<script " async="" src="https://<? echo $_SERVER['SERVER_NAME']?>/js/2.js"></script>
	...
	<script src="https://<? echo $_SERVER['SERVER_NAME']?>/requiredfunction.php"></script>
...
.menuMobileContainer .memoNav li a{
	...
	<?php include($_SERVER['DOCUMENT_ROOT'].'/header1.php'); ?>
	<?php include($_SERVER['DOCUMENT_ROOT'].'/url_header2.php'); ?>
		...
		<div class="menuMobileWrapper">
			...
			<div class="memoHeader">
				<div class="product-card__image" style="padding-top:18.461538461538463%;">
					<a href="https://yosshitaneha.com/"><img style="width: 135px; height:100%;"
							class="product-card__img lazyautosizes ls-is-cached lazyloaded" sizes="90px"
							srcset="https://<? echo $_SERVER['SERVER_NAME']?>/assets/logo.jpg"></a>
				</div>
				<br>
				<span>Menu</span>
			...
			<li class="hasMemoDropdown">
					...
					<ul id="memoDropdown11" class="memoDropdown collapse">
						<li class="hasMemoDropdown active">
							...
							<ul id="memoDropdown111" class="memoDropdown collapse">
								...
								<li>
									<a
										href="https://<? echo $_SERVER['SERVER_NAME']?>/list.php?type=1&id=<?php echo $rowjew1[0]; ?>">
						...
						<li class="hasMemoDropdown active">
							...
							<ul id="memoDropdown112" class="memoDropdown collapse">
								...
								<li>
									<a href="https://<? echo $_SERVER['SERVER_NAME']?>/list.php?type=1&id=<?php echo $neck_sql_result['subcat_id']; ?>"
										title="">
				...
				<li class="hasMemoDropdown">
					...
					<ul id="memoDropdown113" class="memoDropdown collapse">
						...
						<li>
							<a href="https://<? echo $_SERVER['SERVER_NAME']?>/list.php?type=1&id=<?php echo $ear_sql_result['subcat_id']; ?>"
								title="">
				...
				<ul id="memoDropdown12" class="memoDropdown collapse">
					<li class="hasMemoDropdown">
						...
						<h5 class="collTitle"><a
								href="https://<? echo $_SERVER['SERVER_NAME']?>/list.php?type=2&id=<?php echo $rowjew['garment_id']; ?>"
								title="Womens">
	...
	<script>
		$(document).ready(function () {
			...
			$.ajax({
				type: "POST",
				url: '<? $_SERVER["DOCUMENT_ROOT"] ?>/cartdrawer.php',
				data: 'count=' + 1,
			...
			$(".btnAddToCart").on('click', function () {
				...
				$.ajax({
					type: "POST",
					url: '<? $_SERVER["DOCUMENT_ROOT"] ?>/cartcount.php',
					data: 'count=' + 1,
					success: function (msg) {
					    console.warn('call')
						$("#CartCount").html(msg);
