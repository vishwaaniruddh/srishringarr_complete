                    ...
                    <div class="table-wrapper" style="padding:5%; ">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-md-4">
                                    <a href="index.php">
                                        <img src="http://srishringarr.com/yosshitaneha/assets/logo.jpg">
                                    </a>
                                </div>
        			...
        			<div class="main">
                    	...
                    	<form action="#" id="payment_form">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="fname" name="fname" placeholder="First Name" value="Yosshita Neha Guest Purchase"  />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="amount" class="col-sm-2 col-form-label">Email:</label>
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="email" name="email" placeholder="Email ID" value="yosshita.neha@gmail.com" readonly/>
                                </div>
                            </div>
                            <div class="form-group row">
