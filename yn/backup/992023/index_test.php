...
while ($rowimg = mysqli_fetch_array($qryimg)) {
    $url_link = $rowimg['url_link'];
    // echo $url_link; die;
?> 
        <li class="slider_li">

            <a href="<?php echo $rowimg['url_link']; ?>">
                <!--<img class="lazyload slider_img"   src="//images.weserv.nl/?url='https://yosshitaneha.com/newarrivals/.$img" alt="">-->
                <img class="slider_img" src="<?php echo $rowimg['img']; ?>" alt="">
            </a>
