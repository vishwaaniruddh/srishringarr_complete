...
//echo "qtybooked1".$qtybooked1."<br>";
//echo "qtybooked2".$qtybooked2."<br>";
...
if($custom_qtyavailable>0 || $is_customized==1) {
    ...
    if($check_sql_result){
        ...
        echo ' ins '.$custom_quantity;
        $sql="INSERT INTO `cart`( `user_id`, `product_id`, `qty`, `product_amt`,`total_amt`,`ac_typ`,`product_type`,is_customized) VALUES ('".$usrid."','".$itemidmain."','".$custom_quantity."','".$pprice."','".$pprice."',2,'".$typ."','".$is_customized."')";
