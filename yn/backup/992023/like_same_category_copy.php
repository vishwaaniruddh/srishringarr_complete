...
<div class="container-fluid" style="background: white;">
  <!--<h4 class="like_h4">From Suggestion </h4>-->
  <?php
          ...
          <div class="row rowFlexMargin wrapper slides">
            ...
            ?>
              ...
              <li class="product_col">
                <div class="product">
                  <a href="<?php echo $value['link']; ?>" class="img-prod">
                    <img src="<?php echo $image_url ; ?>">
                  </a>
                  <div class="text py-3 px-3">
                    <div class="subpart">
                      <p style="display:block;">MRP
                        <?php echo $value['cur_sym']. ' ' . $value['selling_price']; ?>
                      </p>
                      <h6 style="color:red;    font-size: 13px; text-decoration: underline;font-weight: 700;">SKU : <a href="<?php echo $value['link']; ?>"><?php echo $value['sku']; ?></a></h6>
