        ...
        $splimit=$rero[1]*0.8;
                 ...
                 if($type=="1")
                        ...
                        $source_img = trim("yn/uploads".$rowimg[0]);
                            ...
                            $imgframe = '<img class="lazyload img-fluid product_img"  style="width: 100%; object-fit: contain; user-select: auto;" data-src="//images.weserv.nl/?url='.$destination_img.'&w=400&h=300">';
                        ...
                        // End Final Amount With Discount
