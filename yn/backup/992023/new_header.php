...
?>
	...
	<script src="https://<? echo $_SERVER['SERVER_NAME']?>/js/jquery-3.5.0.min.js" type="text/javascript"></script>
	<script type="text/javascript" async="" src="https://<? echo $_SERVER['SERVER_NAME']?>/js/1.js"></script>
	<script type="text/javascript" async="" src="https://<? echo $_SERVER['SERVER_NAME']?>/js/2.js"></script>
...
<body id="products" class="template-collection ">
	...
	<?php include($_SERVER['DOCUMENT_ROOT'].'/new_header1.php'); ?>
	<?php include($_SERVER['DOCUMENT_ROOT'].'/new_header2.php'); ?>
		...
		<div class="menuMobileWrapper">
			...
			<ul class="nav memoNav">
				...
				<li class="hasMemoDropdown">
					<a href="https://<? echo $_SERVER['SERVER_NAME']?>/category.php?page=2" title="">Jewellery</a>
					...
					<ul id="memoDropdown11" class="memoDropdown collapse">
						<li class="hasMemoDropdown active">
							...
							<span class="memoBtnDropdown collapsed" data-toggle="collapse"
								data-target="#memoDropdown111"><i class="fa fa-angle-down"></i></span>
						...
						<li class="hasMemoDropdown active">
							...
							<span class="memoBtnDropdown collapsed" data-toggle="collapse"
								data-target="#memoDropdown112"><i class="fa fa-angle-down"></i></span>
				...
				<li class="hasMemoDropdown">
					...
					<span class="memoBtnDropdown collapsed" data-toggle="collapse" data-target="#memoDropdown113"><i
							class="fa fa-angle-down"></i></span>
			...
			<li class="hasMemoDropdown active">
				<a href="https://<? echo $_SERVER['SERVER_NAME']?>/category.php?page=1" title="">Apparels</a>
