            ...
            $splimit=$rero[1]*0.8;
                 ...
                 if($type=="1")
                        ...
                        $source_img = trim("yn/uploads".$rowimg[0]);
                            ...
                            $imgframe = '<img class="lazyload img-fluid product_img"  style="width: 100%; object-fit: cover; user-select: auto;border: 1px solid gray;border-radius: 10px;padding: 15px;" data-src="//images.weserv.nl/?url='.$destination_img.'&w=400&h=300">';
