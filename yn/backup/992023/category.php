            ...
            <div id="shopify-section-vela-template-collections" class="shopify-section">
                <div class="rowFlex rowFlexMargin">
            		...
            		<div class="col-md-12 product-model-sec" id="show">
                     ...
                     } else if (isset($_REQUEST)& $_REQUEST['page'] == 2 & !isset($_REQUEST['cid'])) {
             ...
             ?>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-xl-3">
                    ...
                    } else if(isset($_REQUEST['page']) & $_REQUEST['page'] == 2 & !isset($_REQUEST['cid'])) {
                        $id = $rowjew['subcat_id'];
    			...
    			<?php } else if (isset($_REQUEST['page'])& $_REQUEST['page'] == 2) {


                     if ($cnt > 1) {
                         $cid = $_REQUEST['cid'];
                         $isSub = true; ?>
			        <a href="category.php?page=2&cid=<?php echo $id; ?>">
			   <?php } else {
                         $isSub = false;
               ?>
