        ...
        $splimit=$rero[1]*0.8;
                 ...
                 if($type=="1")
                        ...
                        if($youtube){
                                ...
                                $ytcode=$ytendarray[0];
                                $imgframe =  "<iframe title=\"\" width=\"100%\" height=\"315\" src=\"https://www.youtube.com/embed/<? echo $ytcode ; ?>\" autoplay=\"0\"  frameborder=\"0\" allowfullscreen></iframe>";
...
$data[] = ['1'=>$source_img,'com_image'=>$destination_img, 'pid'=>$row[0],'symbol'=>$currency_symbol, 'product_name'=>$product_name,'cur_sym'=>$cur_sym,'selling_price'=>$selling_price,'rent_price'=>$rentprice,'image'=>$path,'sku'=>$prcode,'deposite'=>$final_deposit,'discount'=>$discount,'link'=>$link,'statement'=>$statement,'cur_sql'=>$cur_sql,'imageframe'=>$imgframe];
    }
}
