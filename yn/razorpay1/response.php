...
// POS TABLE 
     ...
     echo "insert into phppos_rent(cust_id,bill_date,rent_amount,	amount,status, pick, delivery, pstatus,pick_date, delivery_date,delivery_status,booking_status,order_id) 
            values('".$userid."','".$date."','".$product_amt."','".$rental_date[3]."','A','Customer','Customer Return','Paid','".$rental_date[0]."','".$rental_date[1]."','Paid','Booked','".$order."')"; 
            
        mysqli_query($con3,"insert into phppos_rent(cust_id,bill_date,rent_amount,	amount,status, pick, delivery, pstatus,pick_date, delivery_date,delivery_status,booking_status,order_id) 
            values('".$userid."','".$date."','".$product_amt."','".$rental_date[3]."','A','Customer','Customer Return','Paid','".$rental_date[0]."','".$rental_date[1]."','Paid','Booked','".$order."')");
