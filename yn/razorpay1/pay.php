...
$_SESSION['rp_fname'] =  $_COOKIE['yn_fname'] .' '. $_COOKIE['yn_lname'];
$_SESSION['rp_email'] = $_COOKIE['yn_email'];
$_SESSION['rp_mobile'] = $_COOKIE['yn_mobile'];


$order_ent = mysqli_query($con,"insert into Order_ent(user_id,acc_type) values('".$userid."',2)");
...
$data = [
    ...
    'yn_orderid'        => $orderid,
    "image"             => "http://yosshitaneha.com/assets/logo.jpg",
    "prefill"           => [
    "name"              => $name,
    "email"             => $email,
    "contact"           => $mobile,
...
<html>
    <head>
        ...
        <title>Yosshitaneha Fashion Studio</title>
        <link rel="" href="logo/Untitled-2 copy.jpg"/><link rel="icon" href="http://yosshitaneha.com/assets/logo.jpg" type="image/x-icon" />
        			...
        			<div class="main">
                        ...
                        <div> </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="fname" name="fname" placeholder="First Name" value="<? echo $_COOKIE['yn_fname'] .' '. $_COOKIE['yn_lname']; ?>" readonly />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="email" name="email" placeholder="Email ID" value="<?php echo $_COOKIE['yn_email']; ?>" readonly />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="amount" class="col-sm-2 col-form-label">Mobile/Cell Number:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Mobile/Cell Number" value="<? echo $_COOKIE['yn_mobile']; ?>" readonly/>
                                </div>
                            </div>
