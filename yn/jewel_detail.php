...
if($productName){
    ...
    $getsql = mysqli_query($con,"select * from product where yn_productName='".$productName."'");
...
$product_id = $prid = $id;
  ...
  $sql="SELECT * FROM `product` WHERE `product_id`='".$prid."'";
   ...
   if($youtube){
            ...
            $imgframe = '<img class="lazyload img-fluid product_img" alt="'.$productName.'" style="width: 100%; object-fit: contain; user-select: auto;" data-src="' . $destination_img . '">';
