        			...
        			<div class="flex-w flex-sb" >
        				<div class="w-size13 p-t-0 respon5">
                            ...
                            <div class="app-figure" id="zoom-fig">
                                ...
                                >
                                    <img class="product_image" loading="lazy" src="<?php echo $path; ?>" srcset="<?php echo $path; ?>?h=800 2x" style="width:100%;"/>
                                </a>
...
<div class="selectors">
  <section id="gallery">
    <div class="container">
      <div id="flexslider-container_selectors" class="flexslider">
        <ul class="slides">
          <?php
            $sqlimg = "SELECT img_name FROM `product_images_new` WHERE `gproduct_id`='$prid' ORDER BY rank";
            $qryimg = mysqli_query($con, $sqlimg);
            ...
            while ($rowimg23 = mysqli_fetch_array($qryimg)) {
              ...
              $html .= '<a href="' . $zoom_img . '" class="zoom-image"><img src="' . $zoom_img . '" class="img-responsive"></a>';
...
<div id="flexslider-container" class="flexslider row"></div>
<script>
$(document).ready(function() {
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      // Step 3: Append the HTML to the container element
