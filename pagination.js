                    ...
                    generateHTML: function (a) {
                        ...
                        if ((I && ((c = e.replaceVariables(I, { currentPage: f, totalPage: g, totalNumber: j })), (A += c)), l || n || m)) {
                            if (
                                ...
                                l &&
                                    (f <= 1
                                        ? G || (A += '<li class="' + w + "-prev " + y + '"><a class="page_num">' + s + "</a></li>")
                                ...
                                if (h <= 3)
                                    for (d = 1; d < h; d++)
                                        A +=
                                            d == f
                                                ? '<li class="' + w + "-page J-paginationjs-page " + x + '" data-num="' + d + '"><a class="page_num">' + d + "</a></li>"
                                    ...
                                    k.showFirstOnEllipsisShow && (A += '<li class="' + w + "-page " + w + '-first J-paginationjs-page" data-num="1"><a href="' + r + '">1</a></li>'),
                                        (A += '<li class="' + w + "-ellipsis " + y + '"><a class="page_num">' + u + "</a></li>");
                                for (d = h; d <= i; d++)
                                    A +=
                                        d == f
                                            ? '<li class="' + w + "-page J-paginationjs-page " + x + '" data-num="' + d + '"><a class="page_num">' + d + "</a></li>"
                            ...
                            m &&
                                (f >= g
                                    ? H || (A += '<li class="' + w + "-next " + y + '"><a class="page_num">' + t + "</a></li>")
