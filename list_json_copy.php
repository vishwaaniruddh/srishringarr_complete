...
$rentprice = round($rentprice,2);
    ...
    $data[] = ['1'=>$source_img,'com_image'=>$destination_img,'snno'=>$i,'cur_sym'=>$cur_sym,'product_name'=>$product_name,'selling_price'=>$selling_price,'rent_price'=>$rentprice,'image'=>$path,'sku'=>$prcode,'deposite'=>$final_deposit,'discount'=>$discount,'link'=>$link,'statement'=>'1', 'booking'=>$booking_date,'imageframe'=>$imgframe,'newsp'=>$newsp];
