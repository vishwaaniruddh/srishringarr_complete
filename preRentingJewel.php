...
<div class="container">
    ...
    <div style="float:right;">
        <select class="form-control" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);" style="width: auto;">
            ...
            <option value="jewel.php?id=<?php echo $product_id; ?>&type=2&pricefilter=1"<?php if (isset($_GET['pricefilter']) && $_GET['pricefilter'] == 1) {
                                                                                            echo 'selected';
                                                                                        } ?>>Higher To Lower</option>
            <option value="jewel.php?id=<?php echo $product_id; ?>&type=2&pricefilter=2"<?php if (isset($_GET['pricefilter']) && $_GET['pricefilter'] == 2) {
                                                                                            echo 'selected';
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: "jewel1.php?id=<?php echo $product_id; ?>&type=2&pricefilter=<? echo $pricefilter; ?>",
            dataType: 'json',
            success: function(response) {
                ...
                function displayItems(page) {
                    ...
                    for (var i = startIndex; i < endIndex && i < totalItems; i++) {
                        ...
                        html += '<br>';
                        html += '<span class="mr-2 price-dc">Sell @ ₹ <strong>' + product.sellPrice + '</strong></span>';
                        html += '<br>';
