...
/*$_POST['retdt'] =$todaysdt;
$_POST['retdt'] = $todaysdt; 
*/
$usrid=$_SESSION['gid'];

$custom_quantity = $_POST['qty'];
...
if($transtyp=="1")
{
    $dt=date("Y-m-d",strtotime(str_replace("/","-",$rent_date)));

    $returndate=date("Y-m-d",strtotime(str_replace("/","-",$return_date)));
