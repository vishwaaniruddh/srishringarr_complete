...
$sql1=mysqli_query($con,"select * from customer_social_login where email='".$email."' AND site='SN'");
if(mysqli_num_rows($sql1)>0){
    ...
    $insert_sql = "INSERT INTO `customer_social_login`( `login_id`, `email`, `full_name`, `site`) VALUES ('".$login_id."','".$email."','".$full_name."','SN') ";
   // echo $insert_sql;die;
   ...
   // echo $insert_sql;die;
    ...
    if(mysqli_query($con,$insertreg_sql)){ 
        ...
        $pwd = "Google321@#";
        $insertlogin_sql = "INSERT INTO `customer_login`( `login_id`, `email`, `password`, `site`) VALUES ('".$reg_id."','".$email."','".$pwd."','SN') ";
