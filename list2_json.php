...
elseif($round_num > 50 && $round_num != 00 && $round_num!=50){
    ...
    $data[] = ['1'=>$source_img,'2'=>$destination_img,'snno'=>$i,'product_name'=>$product_name,'selling_price'=>$rero[0],'rent_price'=>$rentprice,'image'=>$path,'sku'=>$prcode,'deposite'=>$final_deposit,'discount'=>$discount,'link'=>$link,'statement'=>'1', 'booking'=>$booking_date,'imageframe'=>$imgframe,'newsp'=>$newsp];                        
