...
<script src="/js/script.js?version=<?= $datetime; ?>"></script>
		...
		<div class="flex-w p-b-90">
			<div class="w-size6 p-t-30 p-l-15 p-r-15 respon3">
				...
				<div>
					<div class="flex-m p-t-30">
						<a href="https://www.facebook.com/srishringarr/" target="_blank" class=" p-r-20 fa fa-facebook"></a>
						<a href="https://www.instagram.com/srishringarr/" target="_blank" class=" p-r-20 fa fa-instagram"></a>
						<!-- <a href="https://plus.google.com/u/1/113103807414319162517" target="_blank" class=" p-r-20 fa social_googleplus"></a> -->
						<a href="https://twitter.com/SriShringarr" target="_blank" class=" p-r-20 fa social_twitter"></a>
						<a href="https://in.pinterest.com/srishringarr/?eq=sri&etslf=5839" target="_blank" class=" p-r-20 fa social_pinterest"></a>
			...
			<div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
				...
				<ul>
                    ...
                    <li class="p-b-8">
                        <a href="/blogs.php" class="s-text7">Blogs</a> 
                    </li>
					<!-- <li class="p-b-9">
...
<!--===============================================================================================-->
	<script defer type="text/javascript" src="/static/css/vendor/select2/select2.min.js"></script>
	...
	<script defer type="text/javascript" src="/static/css/vendor/sweetalert/sweetalert.min.js"></script>
