...
<?php     
    ...
    // echo "NOD:".$nod."<br>";
     ...
     while($row=mysql_fetch_row($result))
     {
      ...
      if($my=='NOVEMBER 2020'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2020-11-01' and '2020-11-30'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2020-11-01' and '2020-11-30'");      
       $nod=23;
       $tnod=30;
      }
      if($my=='OCTOBER 2020'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2020-11-01' and '2020-11-30'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2020-10-01' and '2020-10-31'");      
       $nod=25;
       $tnod=31;
      }
      if($my=='SEPTEMBER 2020'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2020-09-01' and '2020-09-30'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2020-09-01' and '2020-09-30'");      
       $nod=26;
       $tnod=30;
      }
      if($my=='AUGUST 2020'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2020-08-01' and '2020-08-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2020-08-01' and '2020-08-31'");      
       $nod=26;
       $tnod=31;
      }
      if($my=='MARCH 2020'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2020-03-01' and '2020-03-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2020-03-01' and '2020-03-31'");      
       $nod=25;
       $tnod=31;
      }
      if($my=='FEBRUARY 2020'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2020-02-01' and '2020-02-29'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2020-02-01' and '2020-02-29'");      
       $nod=25;
       $tnod=29;
      }
      if($my=='JANUARY 2020'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2020-01-01' and '2020-01-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2020-01-01' and '2020-01-31'");      
       $nod=26;
       $tnod=31;
      }
      if($my=='DECEMBER 2019'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2019-12-01' and '2019-12-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2019-12-01' and '2019-12-31'");      
       $nod=26;
       $tnod=31;
      }
      if($my=='NOVEMBER 2019'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2019-11-01' and '2019-11-30'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2019-11-01' and '2019-11-30'");      
       $nod=26;
       $tnod=30;
      }
      if($my=='OCTOBER 2019'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2019-10-01' and '2019-10-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2019-10-01' and '2019-10-31'");      
       $nod=26;
       $tnod=31;
      }
      if($my=='SEPTEMBER 2019'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2019-09-01' and '2019-09-30'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2019-09-01' and '2019-09-30'");      
       $nod=25;
       $tnod=30;
      }
      if($my=='AUGUST 2019'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2019-08-01' and '2019-08-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2019-08-01' and '2019-08-31'");      
       $nod=26;
       $tnod=31;
      }
      if($my=='july 2019'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2019-07-01' and '2019-07-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2019-07-01' and '2019-07-31'");      
       $nod=27;
       $tnod=31;
      }
      if($my=='june 2019'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2019-06-01' and '2019-06-30'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2019-06-01' and '2019-06-30'");      
       $nod=25;
       $tnod=30;
      }
       if($my=='MAY 2019'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2019-05-01' and '2019-05-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2019-05-01' and '2019-05-31'");      
       $nod=27;
       $tnod=31;
      }
      if($my=='APRIL 2019'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2019-04-01' and '2019-04-30'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2019-04-01' and '2019-04-30'");      
       $nod=26;
       $tnod=30;
      }
      if($my=='MARCH 2019'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2019-03-01' and '2019-03-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2019-03-01' and '2019-03-31'");      
       $nod=25;
       $tnod=31;
      }
      if($my=='FEBRUARY 2019'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2019-02-01' and '2019-02-28'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2019-02-01' and '2019-02-28'");      
       $nod=24;
       $tnod=28;
      }
      if($my=='JANUARY 2019'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2019-01-01' and '2019-01-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2019-01-01' and '2019-01-31'");      
       $nod=26;
       $tnod=31;
      }
      if($my=='DECEMBER 2018'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2018-12-01' and '2018-12-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2018-12-01' and '2018-12-31'");      
       $nod=26;
       $tnod=31;
      }
      if($my=='NOVEMBER 2018'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2018-11-01' and '2018-11-30'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2018-11-01' and '2018-11-30'");      
       $nod=24;
       $tnod=30;
      }
      if($my=='OCTOBER 2018'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2018-10-01' and '2018-10-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2018-10-01' and '2018-10-31'");      
       $nod=27;
       $tnod=31;
      }
      if($my=='SEPTEMBER 2018'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2018-09-01' and '2018-09-30'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2018-09-01' and '2018-09-30'");      
       $nod=25;
       $tnod=30;
      }
      if($my=='AUGUST 2018'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2018-08-01' and '2018-08-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2018-08-01' and '2018-08-31'");      
       $nod=27;
       $tnod=31;
      }
      if($my=='july 2018'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2018-07-01' and '2018-07-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2018-07-01' and '2018-07-31'");      
       $nod=26;
       $tnod=31;
      }
      if($my=='june 2018'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2018-06-01' and '2018-06-30'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2018-06-01' and '2018-06-30'");      
       $nod=26;
       $tnod=30;
      }
      if($my=='may 2018'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2018-05-01' and '2018-05-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2018-05-01' and '2018-05-31'");      
       $nod=27;
       $tnod=31;
      }
      if($my=='APRIL 2018'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2018-04-01' and '2018-04-30'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2018-04-01' and '2018-04-30'");      
       $nod=25;
       $tnod=30;
      }
      if($my=='MARCH 2018'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2018-03-01' and '2018-03-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2018-03-01' and '2018-03-31'");      
       $nod=26;
       $tnod=31;
      }
      if($my=='FEBRUARY 2018'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2018-02-01' and '2018-02-28'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2018-02-01' and '2018-02-28'");      
       $nod=24;
       $tnod=28;
      }
      if($my=='JANUARY 2018'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2018-01-01' and '2018-01-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2018-01-01' and '2018-01-31'");      
       $nod=26;
       $tnod=31;
      }
      if($my=='DECEMBER 2017'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2017-12-01' and '2017-12-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2017-12-01' and '2017-12-31'");      
       $nod=26;
       $tnod=31;
      }
      if($my=='NOVEMBER 2017'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2017-11-01' and '2017-11-30'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2017-11-01' and '2017-11-30'");      
       $nod=25;
       $tnod=30;
       }
       if($my=='OCTOBER 2017'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2017-10-01' and '2017-10-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2017-10-01' and '2017-10-31'");      
       $nod=24;
       $tnod=31;
       }
      if($my=='SEPTEMBER 2017'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2017-09-01' and '2017-09-30'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2017-09-01' and '2017-09-30'");      
       $nod=26;
       $tnod=30;
       }
      if($my=='AUGUST 2017'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2017-08-01' and '2017-08-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2017-08-01' and '2017-08-31'");      
       $nod=26;
       $tnod=31;
       }
      if($my=='JULY 2017'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2017-07-01' and '2017-07-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2017-07-01' and '2017-07-31'");      
       $nod=26;
       $tnod=31;
       }
      if($my=='JUNE 2017'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2017-06-01' and '2017-06-30'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2017-06-01' and '2017-06-30'");      
       $nod=26;
       $tnod=30;
       }
      if($my=='MAY 2017'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2017-05-01' and '2017-05-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2017-05-01' and '2017-05-31'");      
       $nod=27;
       $tnod=31;
       }
      if($my=='APRIL 2017'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2017-04-01' and '2017-04-30'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2017-04-01' and '2017-04-30'");      
       $nod=25;
       $tnod=30;
       }
      if($my=='MARCH 2017'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2017-03-01' and '2017-03-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2017-03-01' and '2017-03-31'");      
       $nod=26;
       $tnod=31;
       }
      if($my=='FEBRUARY 2017'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2017-02-01' and '2017-02-28'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2017-01-01' and '2017-01-31'");      
       $nod=24;
       $tnod=28;
       } 
      if($my=='JANUARY 2017'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2017-01-01' and '2017-01-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2017-01-01' and '2017-01-31'");      
       $nod=26;
       $tnod=31;
       }
      if($my=='DECEMBER 2016'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2016-12-01' and '2016-12-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2016-12-01' and '2016-12-31'");      
       $nod=27;
       $tnod=31;
       }
      if($my=='NOVEMBER 2016'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2016-11-01' and '2016-11-30'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2016-11-01' and '2016-11-30'");      
       $nod=26;
       $tnod=30;
       }
      if($my=='OCTOBER 2016'){
      ...
      $yes=date('Y-m-d',(strtotime ( '-1 day' , strtotime ($rowy[0]) ) ));
       ...
       $ss=mysql_query("select * from holiday where hdate='".$yes."'");
       $ss1=mysql_query("select * from holiday where hdate='".$tom."'");
       if(mysql_num_rows($ss)==0 and mysql_num_rows($ss1)==0)
       {
    ...
    //   echo $sal_hr.'--'.$sal_min.'-'.$row[10].'='.$sal.'-'.$sal_day.'<br>';
      ...
      $resulthol=mysql_query("select hdate from holiday where hdate between '2020-11-01' and '2020-11-30'");      
       ...
       $tnod=30;
          ...
          if($my=='OCTOBER 2020'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2020-10-01' and '2020-10-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2020-10-01' and '2020-10-31'");      
       $nod=27;
       $tnod=31;
          }
      ...
      $resulthol=mysql_query("select hdate from holiday where hdate between '2019-04-01' and '2019-04-30'");      
       ...
       $tnod=30;
          ...
          if($my=='MARCH 2019'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2019-03-01' and '2019-02-31'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2019-03-01' and '2019-03-31'");      
       $nod=25;
       $tnod=31;
          }
      ...
      $resulthol=mysql_query("select hdate from holiday where hdate between '2017-05-01' and '2017-05-31'");      
       ...
       $tnod=31;
        ...
        if($my=='APRIL 2017'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2017-04-01' and '2017-04-30'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2017-04-01' and '2017-03-30'");      
       $nod=25;
       $tnod=30;
      }  
       if($my=='MARCH 2017'){
      ...
      if($my=='FEBRUARY 2017'){
      $resultx=mysql_query("select * from attendance where ID=".$row[10]." and pdate between '2017-02-01' and '2017-02-28'");
      $resulthol=mysql_query("select hdate from holiday where hdate between '2017-02-01' and '2017-02-28'");      
       $nod=24;
       $tnod=28;
      }
      if($my=='JANUARY 2017'){
