...
class pageTasks {
    ...
    static taskAdd(taskContent) {
        ...
        taskList.prepend(`
            <div class="js-task block block-rounded block-fx-pop block-fx-pop mb-2 animated fadeIn" data-task-id="${taskIdNext}" data-task-completed="false" data-task-starred="false">
