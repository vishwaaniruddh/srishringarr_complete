...
urlpatterns = [
    ...
    url(r'^cart/$', is_login(views.CartView.as_view()), name='cart'),
    ...
    url(r'^Shipping,Cancellation&Returns/$', views.ShipReturnCancel.as_view(), name='Shipping,Cancellation&Returns'),
...
#     url(r'^detail/(?P<product_slug>[-\w]+)/$', views.ProducDetailView.as_view(), name='productdetail'),
    ...
    url(r'^placeOrderdepo/$', views.placeOrderdepo, name='placeOrderdepo'),
    url(r'^razorpay-payment_successdepo/$', views.razorpaypayment_successdepo, name='razorpaypayment_successdepo'),
]
