...
class Order(models.Model):
    ...
    depis_paid= models.BooleanField(default=False)

    txnid_deposit_paid = models.CharField(max_length=100, blank=True, null=True)

    deposite_collect_amount= models.IntegerField(max_length=250, unique=False, blank=True, default=0)
    balance_deposit= models.CharField(max_length=250, unique=False, blank=True, null=True)
    return_deposit= models.CharField(max_length=250, unique=False, blank=True, null=True)
    # vikrant 130920
    # end
