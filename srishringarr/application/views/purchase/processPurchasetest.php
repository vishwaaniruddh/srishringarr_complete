...
/*
echo "INSERT INTO `phppos_items`(`name`, `category`, `supplier_id`, `item_number`, `description`, `cost_price`, `unit_price`, `quantity`) VALUES ('".$myitemid[$i]."','".$item_cat[$i]."', '".$supp_id."','".$item_no[$i]."' ,'".$bill_date."', '".$cprice[$i]."', '".$uprice[$i]."', '".$qty[$i]."')";*/

   $qryitm=mysql_query("INSERT INTO `phppos_items`(`name`, `category`, `supplier_id`, `item_number`, `description`, `cost_price`, `unit_price`, `quantity`) VALUES ('".$myitemid[$i]."','".$item_cat[$i]."', '".$supp_id."','".$item_no[$i]."' ,'".$bill_date."', '".$cprice[$i]."', '".$uprice[$i]."', '".$qty[$i]."')");
 ...
 $errors++;
	...
	mysql_query("COMMIT;");
	echo " <center>Entries Done Successfully.<br> <<==<a href='purchase_entrytest.php'>GO BACK <<==</a> <a href='../../../index.php/purchase'>HOME <<==</a> <a href=''>BACK PURCHASE</a> </center>";
	if(!$det){
		$err=mysql_error();
		//header('Location:addlead.php?err='.$err);
			...
			echo "Error in Insering  ".mysql_error()."<a href='purchase_entrytest.php'>GO BACK <<==</a>";
			}
