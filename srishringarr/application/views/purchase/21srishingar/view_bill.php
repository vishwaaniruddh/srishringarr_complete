...
<td width="1308"  valign="top"><center>
    ...
    <hr>
     ...
     <tr>
     <td align="center"><?php echo $i++;?></td><td align="justify"><?php $itemqry=mysql_query("SELECT `name` from `phppos_items` where `item_id`='$resfetch[2]'"); $item=mysql_fetch_row($itemqry);
