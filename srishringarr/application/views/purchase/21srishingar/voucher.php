...
<!--<div align='center' style='background-color:#987564'><br /><br /> <a href='view_payments.php'><input type='button' value='BACK'></a> &nbsp <a href='../../../index.php/purchase'> <input type='button' value='HOME'></a><br /></div>-->
...
$qrysuppayment=mysql_query("select * from `phppos_purchase_payments` where `bill_no`='$pur_id'");
$paymentsupp=mysql_fetch_row($qrysuppayment);
           ...
           <tr>          
            <td colspan="" width="100" height="33">
               ...
               <td colspan="" width="100" height="33">                         
                              ...
                              <p>  <strong>Date:</strong>    <?php echo $paymentsupp[4];?> </p></td>  
