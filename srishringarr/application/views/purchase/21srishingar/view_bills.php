...
xmlhttp.open("GET","getbills.php?supp_id="+supp_id+"&frmdate="+frmdate+"&todate="+todate+'&type='+type,true);
xmlhttp.send();
...
<td width="1308"  valign="top"><center>
     ...
     <hr>
     <?php $qryitem=mysql_query("select *  from `phppos_suppliers`  order by company_name ASC ");
	 	//$items=array();
   ...
   <tr><td width="103">Phone Number:</td> <td colspan="2"> <input type="text" name="phoneNo" id="phoneNo" value="" /> <a href="#" onClick="loadPhoneNo();">Find</a></td></tr>
		 ...
		 <?php  while($row=mysql_fetch_row($qryitem))
		 {
