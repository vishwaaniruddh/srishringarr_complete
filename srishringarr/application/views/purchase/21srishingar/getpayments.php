...
{
	$qrys=mysql_query("select `company_name` from `phppos_suppliers` where `person_id`=(select supp_id from phppos_purchase where pur_id ='$restrans[1]')");    
	  $res=mysql_fetch_row($qrys);
?>
    <tr>
