...
<tr>
  <td width="438" height="46"><b>Approval Return Paid Amount Detail's</b></td></tr>
<tr>
  <td valign="top"><table width="100%" border="1" cellpadding="4" cellspacing="0">
    ...
    $sum=0;
		...
		////echo $rw[0]."<br/>";
			$ql1=mysql_query("SELECT * FROM  `paid_amount` where bill_id='$cid'");
			$num=mysql_num_rows($ql1);
			
			if($num==0)
			{ 
			$ql2=mysql_query("SELECT paid_amount FROM  `approval` where cust_id='$cid'");
			while($rw2=mysql_fetch_row($ql2)){
