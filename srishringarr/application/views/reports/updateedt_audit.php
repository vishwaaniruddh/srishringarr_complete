...
?>
<center>
<a href="#" onclick='PrintDiv();'>Print</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://sarmicrosystems.in/shringaar/application/views/reports/app_return.php">Back</a><br><br>
<div id="bill">
...
{
	$sum=$org_qty[$i]-$qty[$i];
//$result = mysql_query("insert into `audit` (item_id,barcode,qty,org_qty,audit_date) values ('$design[$i]','$barc[$i]','$qty[$i]','$org_qty[$i]',STR_TO_DATE('".$bill_date."','%d/%m/%Y'))");
//echo "update audit set qty='".$qty[$i]."',org_qty='".$org_qty[$i]."' where id='".$_POST[auid][$i]."'";
$result=mysql_query("update audit set qty='".$qty[$i]."',org_qty='".$org_qty[$i]."' where id='".$_POST[auid][$i]."'");
?>
<tr>
