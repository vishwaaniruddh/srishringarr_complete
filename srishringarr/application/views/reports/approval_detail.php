...
$cardperc="0";
	...
	if($myflag){
	$t1=mysql_query("insert into `approval`(cust_id,bill_date,status,paid_amount,discount_status,discount_wise,discount_per,bill_by,pay_by,note,card_perc,card_amt) values('$cid',STR_TO_DATE('".$odate."','%d/%m/%Y'),'$bs','$amt','$dis_st','$wise','$disper','$by','$pay_by','$note','".$cardperc."','".$_POST['cardpercamt']."')");
...
$t4=mysql_query("insert into approval_detail(bill_id,item_id,qty,discount,dis_amount,amount,item_per,final_amount) values('$rowordno[0]','$design[$i]','$prz[$i]','$ds','$p','$sum','$itemper','$sum')");
 ...
 <td align="center"><?php echo round($p/$prz[$i]); ?></td>
  ...
  <?php $total+=$sum;  } ?>
  <tr>
  <td colspan="3" align="right"><font size="2" ><b>Total Qty : <?php echo $qty1; ?></b></font></td>
    <td colspan="3" align="right"><font size="2" ><b>Gross Total: <?php echo "Rs.". $s2; ?> </b></font></td>
  <td colspan="" align="right"><font size="2" ><b><?php if($_POST['cardpercamt']>0)
  {
  echo "Total"; }else{ echo "Net Payable"; }  ?>:
  </td>
  
  <td align="right">
  <?php echo "Rs.". $total; ?> </b></font>
  </td>
  ...
  <td colspan="6" align="right"><font size="2" ></font></td>
    <td colspan="" align="right"><font size="2" ><b>Card 2%</b></font></td>
  ...
  <?php } ?>
   ...
   <tr>
    ...
    // echo $aa;
    ?>
     <td colspan="4" align="center"><font size="2" ><b>Balance : <?php echo "Rs.".$aa; ?> </b></font></td></tr>
     <tr><td colspan="8"> <font size="2" ><b>Payment By : <?php echo $pay_by; ?></b></font></td></tr>
	 <tr><td colspan="8"><font size="2" ><b>Note : <?php echo $note; ?></b></font></td></tr>
</table></font>
...
<center><a href="#" onclick='PrintDiv();'>Print</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://sarmicrosystems.in/srishringarr/application/views/reports/approval.php">Back</a></center>
