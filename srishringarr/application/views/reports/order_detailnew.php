...
$fmatgst=$famt+$gstamt+$cgstamt+$igstamt;
    ...
    $t4=mysql_query("update `phppos_rent`  set amount='".$famt."',rent_amount='".$total1."',total_comm='".$p."',final_amtgst='".$_POST["gstamt"]."',gstperc='".$gstrate."',sgstpeerc='".$sgstrate."',sgstamt='".$gstamt."',cgstperc='".$cgstrate."',cgstamt='".$cgstamt."',igstperc='".$igstrate."',igstamt='".$igstamt."',statetyp='".$_POST['statetyp']."',entrytyp='1' where bill_id='".$rowordno[0]."'");
?>
...
<td width="820" height="42">
 ...
 $gtfrtuds=mysql_query("select * from order_detail where bill_id='".$rowordno[0]."'");
 $tot2=0;
 $qty2=0;
while($rtt=mysql_fetch_array($gtfrtuds))
{
...
$row1=mysql_fetch_row($res2);
 ...
 $gtfrtuds=mysql_query("select * from phppos_rent where bill_id='".$rowordno[0]."'");
 $rttfr=mysql_fetch_array($gtfrtuds);
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../../../application/views/reports/rentnew.php">Back</a></center>
