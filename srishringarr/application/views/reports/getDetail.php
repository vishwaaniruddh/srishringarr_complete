...
<table width="795"><tr><td width="281"><a href="app_detail1.php?id=<?php echo $id; ?>"><font style="font-size:18px;"><B>Approval Return</B></font></a></td>
...
<!--<td width="103"><?php ///echo $pd; ?></td>-->
<td width="136"><?php $app_amont=$batotal-$rnttotal; echo $app_amont; ?></td>
<?php ///echo $s."/".$a."/".$row2[0]."<br/>"; ?>
 <td  align="left" width="135"></td><td  align="left" width="135"></td>
     </tr>
      <tr>
...
<!--<td width="103"><?php ///echo $pd; ?></td>-->
<td width="136"><?php /*echo $salesamount." ".$app_amont." ";*/$net=$salesamount + $app_amont; echo $net; ?></td>
<?php ///echo $s."/".$a."/".$row2[0]."<br/>"; ?>
 <td  align="left" width="135"></td><td  align="left" width="135"></td>
     </tr>
      <tr>
...
<td width="136"><?php /* if($num411==0 || $num411=="" ) {  $pd11=$row42[0]; }else{
