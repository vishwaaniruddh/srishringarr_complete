...
<head>
	...
	<title><?php echo $this->config->item('company').' -- '.$this->lang->line('common_powered_by').' Point Of Sale' ?></title>
	...
	<!--date picker
	<link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url();?>js/date_css.css" />-->
<script type="text/javascript" src="<?php echo base_url();?>js/datepick_js.js"></script>
<!-->
<style type="text/css">
html {
    overflow: auto;
...
<div id="menubar">
	<div id="menubar_container">
		...
		<span style='font-size:8pt;'><?php echo $this->lang->line('common_powered_by').' Point Of Sale'; ?></span>
	</div>
