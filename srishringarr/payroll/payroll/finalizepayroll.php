...
?>       	
  ...
  <?          
              ...
              WHILE ($k < $numberd)
              {
                ...
                printpayslip($empid,$startdate,$enddate,'d');
             ...
             echo "<h3><a href=\"$siteaddress/admin/approveallhours.php?deptid=$deptid&startdate=$startdate&enddate=$enddate\">Approve ALL Hours for All Employees on this page</a></h3>";
