  ...
  <tr> 
    ...
    <td align="center" valign="top" width="300" height="180"> 
      ...
      <table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr> 
          <td> 
            <div align="center"><a href="http://www.acm.cs.olemiss.edu/payroll/viewemppic.php?empid=13"><img src="http://www.acm.cs.olemiss.edu/payroll/viewemppic.php?empid=13" alt="" width="150" height="150" border="1"></a></div>
          </td>
        </tr>
      </table>
    </td>
    ...
    <td> 
      ...
      <table width="90%" border="1" cellspacing="0" cellpadding="0" align="center" bgcolor="#F4F4F4" bordercolorlight="#CCCCCC" bordercolordark="#CCCCCC">
        ...
        <tr> 
          ...
          <td width="66%" height="30"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><a href="comp.html"><? echo $deptname; ?></a></font></td>
        </tr>
        <tr> 
          <td width="34%"> 
          ...
          <td width="66%" height="30"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><a href="ron.html">??</a></font></td>
        </tr>
        <tr> 
          <td width="34%"> 
      ...
      <table width="67%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="60%" height="14"> 
            <div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">Number 
              of Checkins :</font></div>
          </td>
          <td width="40%" height="25"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1"><b>344</b></font></td>
        </tr>
        <tr> 
          <td width="60%"> 
            <div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">Total 
              Number of Hours Worked :</font></div>
          </td>
          <td width="40%" height="25"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1"><b>300</b></font></td>
        </tr>
        <tr> 
          <td width="60%"> 
            <div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">Last 
              Date Checked in :</font></div>
          </td>
          <td width="40%" height="25"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1"><b>2001/10/15</b></font></td>
        </tr>
        <tr> 
          <td width="60%"> 
            <div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">Number 
              of Projects Worked on :</font></div>
          </td>
          <td width="40%" height="25"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1"><b>3</b></font></td>
        </tr>
        <tr> 
          <td width="60%"> 
            <div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">Number 
              of Days Worked :</font></div>
          </td>
          <td width="40%" height="25"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1"><b>545</b></font></td>
        </tr>
      </table>
    </td>
  </tr>
