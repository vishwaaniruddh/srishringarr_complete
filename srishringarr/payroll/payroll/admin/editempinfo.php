...
?>
<form action="editempinfo1.php" method="post" >
    ...
    <td height="180" valign="top"> 
      ...
      <table width="90%" border="1" cellspacing="0" cellpadding="0" align="center" bordercolordark="#CCCCCC" bordercolorlight="#CCCCCC" bgcolor="#F2F2F2">
        ...
        <tr bgcolor="#F4F4F4"> 
          ...
          <td height="30" width="74%" bgcolor="#F4F4F4"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1"><b><font color="#000066"><input type="text" name="job" value="<? echo $jobtitle; ?>" /></font></b></font></td>
        </tr>
      </table>
      <p>&nbsp;</p>
    </td>
