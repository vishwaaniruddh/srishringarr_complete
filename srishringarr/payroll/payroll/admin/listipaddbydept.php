...
<?
   ...
   else
   {
       ...
       echo "<h3>List All IPADDRESS Restrictions for $deptname</h3>";
        
        
       // Query to get list of departments
       $query="select * from iptable where linkid='$deptid' and type='d' order by ipaddress";
       ...
       {  
              ...
              echo "<h3>No IP Address Restriction for this Department yet</h3>";
              
              echo "<a href=\"enteripaddress.php?linkid=$deptid&type=d&deptid=$deptid\">Add a New IP address restriction for the department of $deptname</a><br>";
