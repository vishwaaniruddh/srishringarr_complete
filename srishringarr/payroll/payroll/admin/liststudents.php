...
<?
       ...
       $query="select * from student order by active,lastname,firstname";
       ...
       if ($number == 0)
       {  
              echo "<error>No Students  yet !</error>";
              echo "<ul>";
       ...
       elseif ($number > 0) 
       {
            ...
            echo "<tr><td height=30><font color=\"#003399\"><b>Last Name</b></font></td><td><font color=\"#003399\"><b>First name</b></font></td><td><font color=\"#003399\"><b>Email</b></font></td><td><font color=\"#003399\"><b>Department</b></font></td><td><font color=\"#003399\"></font></td></tr>";
              ...
              WHILE ($i < $number)
              {
                  ...
                  $jobid=mysql_result($result,$i,"fees");
                  ...
                  echo "<td><b><a href=\"viewstuinfo.php?stid=$stid\">View Details</a></b></td>";
                  echo "</tr>";
