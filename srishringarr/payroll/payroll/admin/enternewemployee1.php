...
// end hiding --></Script> 
 ...
 <form method="post" action="enternewemployee2.php">
  <p><b>Add New Employee</b></p>
  <blockquote>Please choose the department that you want to add an employee for. 
    Every employee need to be part of a department. If you do not have any department 
    yet, please<a href="enternewdepartment.php"> add a new department</a>, before 
    adding any new employees. </blockquote>
