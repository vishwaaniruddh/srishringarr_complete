...
<h2><font face="Verdana, Arial, Helvetica, sans-serif" color="#000066">Student 
  Record</font></h2>
      ...
      <table width="90%" border="1" cellspacing="0" cellpadding="0" align="center" bordercolordark="#CCCCCC" bordercolorlight="#CCCCCC" bgcolor="#F2F2F2">
        <tr bgcolor="#F4F4F4"> 
          <td height="30" width="26%"> 
            <div align="right"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">STUDENTID 
              :</font></div>
          </td>
