...
<?
   ...
   else
   {
       ...
       echo "<h3>Employee hours in $deptname from $startdate to $enddate</h3>";
       ...
       elseif ($number > 0) 
       {
            ...
            echo "<tr height=30 bgcolor=#EBEBEB><td> Employee Name</td><td>Active</td><td>Email</td><td>Hours Worke</td></tr>";
              ...
              WHILE ($i < $number)
              {
                  ...
                  $hoursworked=findtotalhours($empid);
