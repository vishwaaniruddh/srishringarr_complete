...
<?
   ...
   else
   {
       ...
       elseif ($number > 0) 
       {
            ...
            echo "<tr height=30 bgcolor=#EBEBEB><td>Project Name</td><td>Active</td><td>Project Hours</td><td>Choose</td></tr>";
              ...
              WHILE ($i < $number)
              {
                  ...
                  echo "<td><a href=\"$scriptname2?projectid=$projectid\">Choose</a></td>";
                  echo "</tr>";
