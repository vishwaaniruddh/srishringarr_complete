...
<?
       ...
       $query = "select * from student where stid='$stid'";
       ...
       { 
          ...
          echo "<h3>This student does not exist. </h3>"; 
       }
       else if ($number>0)
       {

           $empid=mysql_result($result,0,"stid"); 
...
?>
<form action="editstuinfo1.php" method="post" >
...
<table width="640" border="0" cellspacing="0" cellpadding="0">
  <tr> 
      ...
      <table width="90%" border="1" cellspacing="0" cellpadding="0" align="center" bordercolordark="#CCCCCC" bordercolorlight="#CCCCCC" bgcolor="#F2F2F2">
        <tr bgcolor="#F4F4F4"> 
          <td height="30" width="26%"> 
            <div align="right"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">STUDENT ID 
              :</font></div>
          </td>
          <td height="30" width="74%"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><b><input type="text" name="eid" value="<? echo $empid; ?>" /></b></font></td>
        </tr>
        <tr bgcolor="#F4F4F4"> 
          <td height="30" width="26%"> 
          ...
          <td height="30" width="74%"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><b><input type="text" name="ssn" value="<? echo $ssn; ?>" /></b></font></td>
        </tr>
        <tr bgcolor="#F4F4F4"> 
          <td height="30" width="26%"> 
          ...
          <td height="30" width="74%"> <input type="text" name="sal" value="<? echo $salutation; ?>" /><input type="text" name="firname" value="<? echo $firstname; ?>" /><input type="text" name="miname" value="<? echo $minit; ?>" /><input type="text" name="lname" value="<? echo $lastname; ?>" />
        ...
        <tr bgcolor="#F4F4F4"> 
          ...
          <td height="30" width="74%"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><b><input type="text" name="dept" value="<? echo $deptname; ?>" /></a></b></font></td>
        </tr>
    ...
    <td align="center" valign="top" width="300" height="180"> 
      <div align="right"> 
        <p><font color="#990000" size="-1" face="Verdana, Arial, Helvetica, sans-serif"><b>Student 
          Picture</b></font> </p>
      </div>
    ...
    <td height="30"> 
      ...
      <table width="90%" border="1" cellspacing="0" cellpadding="0" align="center" bgcolor="#F4F4F4" bordercolorlight="#CCCCCC" bordercolordark="#CCCCCC">
        <tr> 
          ...
          <td width="66%" height="30"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><input type="text" name="email" value="<? echo $email; ?>" /></font></td>
        </tr>
        <tr> 
          <td width="34%"> 
          ...
          <td width="66%" height="30"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><input type="text" name="webpage" value="<? echo $webpage; ?>" /></font></td>
        </tr>
      </table>
      ...
      <table width="90%" border="1" cellspacing="0" cellpadding="0" align="center" bgcolor="#F4F4F4" bordercolorlight="#CCCCCC" bordercolordark="#CCCCCC">
        <tr> 
          ...
          <td width="66%" height="30"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><input type="text" name="hphone" value="<? echo $homephone; ?>" /></font></td>
        </tr>
        <tr> 
          <td width="34%"> 
          ...
          <td width="66%" height="30"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><input type="text" name="cphone" value="<? echo $cellphone; ?>" /></font></td>
        </tr>
        <tr> 
          <td width="34%"> 
          ...
          <td width="66%" height="30"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><input type="text" name="office" value="<? echo $officephone; ?>" /></font></td>
        </tr>
      </table>
      ...
      <table width="90%" border="1" cellspacing="0" cellpadding="0" align="center" bgcolor="#F4F4F4" bordercolorlight="#CCCCCC" bordercolordark="#CCCCCC">
        <tr valign="top"> 
          ...
          <input type="text" name="add1" value="<? echo $address1; ?>" /><input type="text" name="add2" value="<? echo $address2; ?>" /><input type="text" name="city" value="<? echo $city; ?>" />
          <input type="text" name="state" value="<? echo $state; ?>" /><input type="text" name="country" value="<? echo $country; ?>" />
    ...
    <td> 
      ...
      <table width="90%" border="1" cellspacing="0" cellpadding="0" align="center" bgcolor="#F4F4F4" bordercolorlight="#CCCCCC" bordercolordark="#CCCCCC">
        <tr> 
          ...
          <td width="66%" height="30"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><input type="text" name="etype" value="<? echo $emptype; ?>" /></font></td>
        </tr>
        <tr> 
          <td width="34%"> 
          ...
          <td width="66%" height="30"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><input type="text" name="ecat" value="<? echo $empcat; ?>" /></font></td>
        </tr>
        <tr> 
          <td width="34%"> 
            <div align="right"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">Dept 
          ...
          <td width="66%" height="30"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><input type="text" name="deptname" value="<? echo $deptname; ?>" /></font></td>
        </tr>
        <tr> 
          <td width="34%"> 
          ...
          <td width="66%" height="30"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><input type="text" name="man" value="<? echo $managername; ?>" /></font></td>
        </tr>
        <tr> 
          <td width="34%"> 
          ...
          <td width="66%" height="30"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><input type="text" name="hrs" value="<? echo $regularhours; ?>" />   Hours</font></td>
        </tr>
      </table>
      ...
      <table width="90%" border="1" cellspacing="0" cellpadding="0" align="center" bgcolor="#F4F4F4" bordercolorlight="#CCCCCC" bordercolordark="#CCCCCC">
        <tr> 
          ...
          <td width="60%" height="30"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><input type="text" name="race" value="<? echo $race; ?>" /></font></td>
        </tr>
        <tr> 
          <td width="40%"> 
          ...
          <td width="60%" height="30"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><input type="text" name="mstat" value="<? echo $marital; ?>" /></font></td>
        </tr>
        <tr> 
          <td width="40%"> 
          ...
          <td width="60%" height="30"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><input type="text" name="gen" value="<? echo $gender; ?>" /></font></td>
        </tr>
        <tr> 
          <td width="40%"> 
            <div align="right"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">Date of Birth :</font></div>
          </td>
          <td width="60%" height="30"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1" color="#000066"><input type="text" name="dob" value="<? echo $dob; ?>" /></font></td>
        </tr>
      </table>
    </td>
  </tr>
