...
$qryqty=mysqli_query($con,"select cart_id,qty,deposit_amt from cart where user_id='".$userid."' and product_id='".$pid."' and product_type='".$type."' and ac_typ='".$actyp."' and status=0");
...
if($fetchqty1 > 0){
    ...
    $insertsql = "INSERT INTO `cart`( `user_id`, `product_id`, `qty`, `product_amt`, `total_amt`, `date`,product_type,ac_typ,rent_dt,return_dt,deposit_amt,image,deposite_date,sku) 
    VALUES ('".$userid."','".$pid."','".$qty."','".$price."','".$sales_price."','".$date."','".$type."','".$actyp."','".$rent_date."','".$return_date."','".$deposit."','".$image."','".$deposite_date."','".$sku."')"; 
