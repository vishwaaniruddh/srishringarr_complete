				    ...
				    <li class="col-xs-6 col-md-4 col-lg-3">
				       <a class="hov-img-zoom" href="list.php?id=66&type=1"><span>Bangles</span> <img alt="" src="asset/Bangles.jpg"></a>

				    </li>
				    <li  class="col-xs-6 col-md-4 col-lg-3">
				        <a class="hov-img-zoom" href="list.php?id=53&type=1"><span>Borla</span> <img alt="" src="asset/Borla.jpg"></a>
				        
				    </li>
				    <li  class="col-xs-6 col-md-4 col-lg-3">
				        <a class="hov-img-zoom" href="sub_category.php?cid=17&type=1"> <span>Earring</span> <img alt="" src="asset/ear.jpg"></a>   
				    </li>
				    <li  class="col-xs-6 col-md-4 col-lg-3">
				        <a class="hov-img-zoom" href="list.php?id=69&type=1"><span>Hath Phool</span> <img alt="" src="asset/Hathphool.jpg"></a>       
				    </li>
				    <li  class="col-xs-6 col-md-4 col-lg-3">
				        <a class="hov-img-zoom" href="list.php?id=10&type=2"><span>Lehenga Choli</span>  <img alt="" src="asset/Lehenga_Choli.jpg"></a>        
				    </li>
				    <li  class="col-xs-6 col-md-4 col-lg-3">
				        <a class="hov-img-zoom" href="list.php?id=3&type=1"> <span>Kundan Set</span>  <img alt="" src="asset/Necklace_Set_Kundan.jpg"></a>        
				    </li>
				    <li  class="col-xs-6 col-md-4 col-lg-3">
				        <a class="hov-img-zoom" href="list.php?id=63&type=1"><span>Mang Tikkas</span> <img alt="" src="asset/Tikkas.jpg"></a>        
				        
				    </li>
				    <li  class="col-xs-6 col-md-4 col-lg-3">
				        <a class="hov-img-zoom" href="list.php?id=29&type=2"><span>Trail Gown</span>  <img alt="" src="asset/Trail_Gown.jpg"></a>        
				    </li>
