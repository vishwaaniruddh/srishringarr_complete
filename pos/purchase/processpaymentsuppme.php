...
{	//echo $j;
	if(!$qry[$j] and !$qrybill[$j])
	{
			...
			?>
            <div align='center' style='background-color:#987564'> <br/><br/><br/><br/>Transaction aborted. Please Try Again<br/><br/> <a href='/pos/home_dashboard.php'><input type='button' value='BACK'></a>&nbsp<a href='/pos/home_dashboard.php'> <input type='button' value='EXIT'></a><br><br></div>
            <?php
			 $flag=1;
			 break;	
	}	
...
if($flag!=1)
{
 ...
 ?>
<div align='center' style='background-color:#987564'> <br/><br/><br/><br/>Transaction Completed.<br/><br/> <a href='/pos/home_dashboard.php'><input type='button' value='BACK'></a>&nbsp<a href='/pos/home_dashboard.php'><input type='button' value='EXIT'></a> &nbsp <button type='button' onclick="printDiv('bill');">Print</button><br/></div>
