...
$res=mysqli_query($con,"select * from phppos_items_test where is_deleted = 0 ");          
                            ...
                            while($row = mysqli_fetch_row($res)) 
                             {
                                ...
                                $supp_detail = mysqli_query($con,"select * phppos_suppliers_test  where person_id = '".$suppid."'   "); 
