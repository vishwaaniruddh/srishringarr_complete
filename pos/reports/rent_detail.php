...
$cid=$_GET['id'];
$qty1=0;
$result1 = mysqli_query($con,"SELECT * FROM  `phppos_rent`  where bill_id='$cid'");
...
<B><U> RENT RETURN</U></B></font>
  ...
  <tr>
  <td><strong>Throught Name:</strong> <?php echo $row2[0]." ".$row2[1]; ?><br/><strong>Throught Contact No:</strong> <?php echo $row2['phone_number']; ?></td>
  <!--<td>Person Name.: &nbsp;&nbsp;&nbsp; <b><?php echo $rowordno[15]; ?></b><br/>Contact No.:<?php echo $rowordno[16]; ?></td>-->
  </tr>
...
<?php CloseCon($con);?>
<center>
<a href="#" onclick='PrintDiv();'>Print</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="rent_return.php">Back</a></center>
