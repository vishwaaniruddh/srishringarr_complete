...
<form method="post" action="custEdit_process.php">
<table>
<tr>
...
?>
<tr>
<td height="34">DOB :</td><td><input type="text" name="dob" id="dob"  value="<?php echo $date;  ?>" class="form-control" placeholder="dd/mm/yyyy"/></td>
</tr>
