...
<?php if($company_name == 'SAKAR TRADE LINK'){ ?>
        <div style="font-size:10px;">SAKAR TRADE LINK</div>
              ...
              <div style="font-size:11px;">Bank name: CANERA BANK</div>
...
?>
 ...
 <td colspan="3" align="center"> <b>Total Rent &nbsp; :&nbsp;</b><b><?php echo $total1+$_POST['cardpercamt']; ?></b></td>
              ...
              <?php if($company_name == 'SAKAR TRADE LINK'){ ?>
                    <tr>
                        <td colspan="3"><b>CGST : </b> <?php echo ($total1+$_POST['cardpercamt']) * 0.9 ;  ?> </td>
                        <td colspan="3"><b>SGST : </b> <?php echo ($total1+$_POST['cardpercamt']) * 0.9 ;  ?> </td>
                        <td colspan="3"><b>Total : </b> <?php echo ($total1+$_POST['cardpercamt']) * 1.8 ;  ?> </td>
                    </tr>
