                        ...
                        <div class="content-wrapper">
                				...
                				<div class="card">
                        			...
                        			<!--				</div>-->
                						     <!--    </div>-->
                						         ...
                						         <div class="col-md-4">
                						             <label for="">Search Customer <b style="color:red">(For "B" use "B name")</b></label>
            			    ...
            			    <?php  
                                ...
                                if (isset($_POST['submit'])) {
                                    ...
                                    $testqry = "SELECT * FROM `phppos_people` WHERE `person_id` not in (SELECT `person_id` FROM `phppos_suppliers`) and person_id = '95'  ";
            									  ...
            									  <tbody>
        										    <?php 
        										        ...
        										        if(mysqli_num_rows($res)>0) { 
                                                            ...
                                                            echo $qry1.'<br>'.'-'  ;
                                                            //$qry1="SELECT * FROM `approval` where cust_id='238874' ";
