...
?>
<center>
<a href="#" onclick='PrintDiv();'>Print</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/pos/home_dashboard.php">Back</a><br><br>
<div id="bill">
...
{
	$sum=$org_qty[$i]-$qty[$i];
$result = mysqli_query($con,"insert into `audit` (item_id,barcode,qty,org_qty,audit_date) values ('$design[$i]','$barc[$i]','$qty[$i]','$org_qty[$i]','".$bill_date."')");
?>
<tr>
