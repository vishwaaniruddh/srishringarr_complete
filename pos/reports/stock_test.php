...
function getDate(){
    $("#detail").html('');
var cid = escape(document.getElementById('date').value);
echo cid;
     $.ajax({
                type: "POST",
                url: "getstock_test.php",
...
function dis1(){
	...
	var a5=document.getElementById('date');
...
<td> <input type="date" name="date" id="date" /> <a href="#" onClick="getDate();">Find</a>&nbsp;&nbsp;&nbsp;</td>
