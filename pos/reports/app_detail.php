...
// echo "SELECT * FROM  `approval` where bill_id='$cid'" ; 
...
<img src="bill.PNG" width="408" height="165"/><br/><br/>
  ...
  <tr>
    <td height="21"><p><font size="+1" >M/s.&nbsp;:&nbsp;&nbsp;<?PHP echo $row[0] . " ".$row[1]; ?></font></p></td>
    </tr>
...
<tr style="display:none;"><td colspan="8" align="center">
