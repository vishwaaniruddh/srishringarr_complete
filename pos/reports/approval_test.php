...
<form  action="approval_detail_test.php" id="frm1" name="listForm" method="POST">
<table width="863">
    
<tr>
    
   
    <td width="103">Phone Number:</td> <td> <input type="text" name="phoneNo" id="phoneNo" value=""  /> <a href="#" onClick="loadPhoneNo();">Find</a></td> </tr>
