...
$dt= date("Y-m-d");
     $res=mysqli_query($con,"SELECT * FROM  `approval` where  bill_date='".$dt."' AND status='A'");
         $num=mysqli_num_rows($res);
echo "SELECT * FROM  `approval` where  bill_date='".$dt."' AND status='A'";
...
//{
$qry10="SELECT *  FROM `approval_detail` WHERE bill_id ='$row[0]'";
