        ...
        <tr>
            <div class="col-md-3">
                <td>
                    ...
                    <div style="height:30px;"><b> 2nd Person Name : </b>&nbsp;&nbsp;&nbsp; <?php echo $rowordno[15]; ?></div>
                    <div style="height:30px;"><b> 2nd Contact No.: </b>&nbsp;&nbsp;&nbsp; <?php echo $rowordno[16]; ?></div>
               </td>
            </div>
            ...
            <div class="col-md-9">
                <td><br/><br/><br/><br/>
               <div style="width: 220px;height:30px;"><b> Through Name: </b><?php echo $row2[0]." ".$row2[1]; ?></b></div><br/>
               <div><b> Through Contact No:</b> <?php echo $rowordno[18]; ?></div><br/>
...
?>
      ...
      &amp; ALL KINDS OF ACCESSORIES.</font></b>
        ...
        <?php echo $row2[0] . " ".$row2[1]; ?></b></td>
												<td width="216">Through Name: <b><?php echo $row2[0]." ".$row2[1]; ?></b>
													<br/> Through Contact No: <b><?php echo $rowordno[14]; ?></b></td>
