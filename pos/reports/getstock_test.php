...
<td width="87">
    ...
    $totalItemPurchased = $totalItemPurchased + $showthisQty ;  ?>
</td>
...
<td align="left" width="58"><?php echo abs($apqt2-$showthisQty); ?></td>
...
<td align="left"><?php echo "Rs.".$ttl1."h"; ?></td>
</tr>
...
// 			$showthisQty
            ...
            <td align="left" width="58"><?php echo abs($sumap1-$totalItemPurchased) ; ?></td>
            <td>
                <?php echo $sumap2; ?>
            </td>
            <td><?php echo $sum2; ?></td>
