  ...
  <?php } ?>
     ...
     <td colspan="3" align="left"><font size="2" ><b>Date: 
       <?php  if(isset($rowordno[2]) and $rowordno[2]!='0000-00-00') echo date('d/m/Y',strtotime($rowordno[2])); ?></b></font>
           <td colspan="3" align="left"><font size="2" ><b>Amount Paid : <?php echo "Rs.". $total; ?> </b></font></td>
     <?php $aa=$total-$rowordno[4];

    ?>
     <td colspan="2" align="center"><font size="2" ><b>Balance : <?php echo "Rs. 0.00 " ; ?> </b></font></td></tr>
	 <tr>
