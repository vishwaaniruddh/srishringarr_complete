...
xmlhttp.onreadystatechange=function()
  ...
  //if(str=='')
xmlhttp.open("GET","getdetailsitems_rent.php?item_id="+item_id+"&frmdate="+frmdate+"&todate="+todate+"&status="+status,true);
xmlhttp.send();
...
<td width="1308"  valign="top"><center>
     ...
     <?php /*?><!--<tr>
	  ...
	  $result = mysqli_query($con,"SELECT * FROM  phppos_items ");
