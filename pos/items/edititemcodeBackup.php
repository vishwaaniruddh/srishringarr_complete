				...
				<td align="center">
					<?php
                        ...
                        if($_POST['submit']){    
                            ...
                            $updatesql = mysqli_query($con,"update phppos_items_test set name='".$name."', category='".$category."', supplier_id= '".$supp_id."', cost_price = '".$cost_price."', unit_price = '".$unit_price."', quantity = '".$quantity."', description= '".$description."' where item_id = '".$itemid."' ");
                            // var_dump($updatesql);
                            if($updatesql)
                            { ?>
                                <script>
					...
					<center>
						<form  action="<?php echo $_SERVER["PHP_SELF"] ?>" method="post" enctype="multipart/form-data">
						   <?php 
						    ...
						    $fetchdata = mysqli_query($con,"select * from phppos_items_test  where item_id = '".$id."' ");
