		                ...
		                <tr>
		                    ...
		                    <tbody>
		                        ...
		                        if($_POST['submit']){
		                            ...
		                            $fetchdata = mysqli_query($con,"select * from phppos_items where name='".$_POST['itemcode']."' ");
		                            ...
		                            $fetchtaxes = mysqli_query($con,"select * from phppos_items_taxes where item_id='".$itemid."' ");
