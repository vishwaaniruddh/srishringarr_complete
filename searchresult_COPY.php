...
//     // mysqli_query($con,"update product set visitcount= '".$visitcount."' where product_id='".$product_id."'");
...
//     // $visitcount = $sql_result['visitcount'];
//     // $visitcount = $visitcount+1;
//     // mysqli_query($con,"update garment_product set visitcount= '".$visitcount."' where gproduct_id='".$product_id."'");
                          ...
                          <? }elseif($product_id == '71' && $product_type=='1'){ ?>
                            ...
                            <? }?>
                              ...
                              <? 
                                  ...
                                  $api =  str_replace('searchresult','search_json',$url) ; 
                                  $curl = curl_init();
                                  ...
                                  <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-12 p-b-50 p-r">
                                      <div class="flex-sb-m flex-w p-b-35">
                                        <!--<div class="flex-w"> 
                                          <a href="sub_category_COPY.php?type=1">Jewellery</a>&nbsp;/ Kundan
                                        </div> -->
                                        ...
                                        <ol class="breadcrumb" style="display:inline-flex">
                                          <?php
                                            ...
                                            {
                                                ?>
                                            <a href="sub_category_COPY.php?type=1">
                                              <li class="">
                                                <?php echo "Jewellery";?>&nbsp; / &nbsp;</li>
                                            </a>
                                            <?php
                                            }else if($product_type=="2")
                                            {
                                              ?>
                                              <a href="sub_category_COPY.php?type=2">
                                                <li class="">
                                                  <?php echo "Apparels";?>&nbsp; / &nbsp;</li>
                                              </a>
                                              <?php  
                                                }
                                              if($product_type=="1")
                                              {
                                                //   $gtmctnm=mysqli_query($con,"select name,maincat_id from subcat1 where subcat_id='".$rws[6]."'");
                                                //   $grmrws=mysqli_fetch_array($gtmctnm);
                                                  
                                                //   $gtmctnm2=mysqli_query($con,"select categories_name from jewel_subcat where categories_name='".$query."' AND subcat_id='".$grmrws[1]."'");
                                                //   $grmrws2=mysqli_fetch_array($gtmctnm2);
                                                
                                                $jwel = "select gproduct_name from garment_product where gproduct_name like %'".$query."'%";
                                                  $jwelview = mysqli_query($jwel);

                                                  echo $jwelview; die;
                                                ?>
                                                <?php if(strtolower($grmrws2[0]) != strtolower($grmrws[0])){ ?>
                                                  <li class="">
                                                    <a href="javascript:void(0);" onclick='brdcrumbfunc("<?php echo $grmrws[1];?>","<?php echo $subcatid;?>","<?php echo $typ;?>","1");'>
                                                      <?php echo ucfirst(strtolower($grmrws2[0]));?>
                                                    </a>
                                                  </li>
                                                  <?php } ?>

                                                    <li class="">
                                                      <a href="javascript:void(0);" onclick='brdcrumbfunc("<?php echo $grmrws[1];?>","<?php echo $rws[8];?>","<?php echo $typ;?>");'>
                                                        <?php echo ucfirst(strtolower($grmrws[0]));?>
                                                      </a>
                                                    </li>
                                                    <?php }
                                                      else  if($product_type=="2"){ 
                                                    ...
                                                    ?>
                                                      <li class="">
                                                        <a href="javascript:void(0);" onclick='brdcrumbfunc("<?php echo $rws[' product_for'];?>","<?php echo "0";?>","<?php echo $typ;?>");'>
                                                          <?php echo ucfirst(strtolower($grmrws[0]));?>
                                                        </a>
                                                      </li>
                                                      <?php } ?>
